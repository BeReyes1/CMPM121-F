...
function Tp(i, e) {
  ...
  function s() {
    ...
    return {
      ...
      setOp: function (Ye, jt, Ht) {
        (Z !== Ye || fe !== jt || Ce !== Ht) &&
          (i.stencilOp(Ye, jt, Ht), (Z = Ye), (fe = jt), (Ce = Ht));
      },
  ...
  function st(w, le, ie, se, J, Z, fe, Ce, nt, Ye) {
    if (w === fn) {
      M === !0 && (de(i.BLEND), (M = !1));
      return;
    }
        ...
        for (let Tt = 0; Tt < ue; Tt++)
          (ot
            ...
            U !== 0
              ...
              : Et
                ? A.copyTexSubImage3D(at, Q, Ve, Ze, lt + Tt, Te, we, ce, pe)
...
function dl() {
  (Ss && (Ss.textContent = Ke.getText("start_button")),
    Cs && (Cs.textContent = Ke.getText("language_button")),
    ws && (ws.textContent = Ke.getText("end_text")),
    Rs && (Rs.textContent = Ke.getText("restart_button")),
    bs && (bs.textContent = Ke.getText("level_button")),
    Lo && (Lo.textContent = Ke.getText("level_select_title")),
    ys && (ys.textContent = Ke.getText("level1_button")),
    Es && (Es.textContent = Ke.getText("level2_button")),
    Ts && (Ts.textContent = Ke.getText("level3_button")),
