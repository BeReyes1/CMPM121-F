...
function rl() {
  const i = {
      ...
      getTransfer: function (r) {
        return r === yn ? mr : this.spaces[r].transfer;
      },
...
class Oi {
  ...
  intersectsTriangle(e) {
    ...
    (this.getCenter(Ei),
      ...
      Kn.subVectors(e.a, Ei),
      Zn.subVectors(e.b, Ei),
    ...
    return !Fr(t, Kn, Zn, jn, Hi) ||
      ((t = [1, 0, 0, 0, 1, 0, 0, 0, 1]), !Fr(t, Kn, Zn, jn, Hi))
      ? !1
      : (Wi.crossVectors(_n, gn),
        (t = [Wi.x, Wi.y, Wi.z]),
        Fr(t, Kn, Zn, jn, Hi));
  }
  clampPoint(e, t) {
...
class ca {
  ...
  intersectTriangle(e, t, n, r, s) {
    ...
    const l = o * this.direction.dot(Yi.crossVectors(vn, Yi));
    if (l < 0) return null;
    const c = o * this.direction.dot(zr.cross(vn));
...
class ut {
  ...
  lookAt(e, t, n) {
    ...
    return (
      ...
      Dt.normalize(),
      Mn.crossVectors(n, Dt),
      Mn.lengthSq() === 0 &&
        (Math.abs(n.z) === 1 ? (Dt.x += 1e-4) : (Dt.z += 1e-4),
        Dt.normalize(),
        Mn.crossVectors(n, Dt)),
      Mn.normalize(),
      qi.crossVectors(Dt, Mn),
      (r[0] = Mn.x),
      (r[4] = qi.x),
      (r[8] = Dt.x),
      (r[1] = Mn.y),
...
class Yt {
  ...
  closestPointToPoint(e, t) {
    const n = this.a,
      ...
      s = this.c;
    let a, o;
    (ei.subVectors(r, n), ti.subVectors(s, n), Hr.subVectors(e, n));
    const l = ei.dot(Hr),
      c = ti.dot(Hr);
...
class je {
  ...
  lerpHSL(e, t) {
    (this.getHSL(Sn), e.getHSL(Zi));
    const n = Dr(Sn.h, Zi.h, t),
      r = Dr(Sn.s, Zi.s, t),
      s = Dr(Sn.l, Zi.l, t);
...
class Er extends Wn {
  ...
  toJSON(e) {
    ...
    ((n.uuid = this.uuid),
      ...
      this.depthFunc !== di && (n.depthFunc = this.depthFunc),
...
class Rt extends It {
  ...
  raycast(e, t) {
    ...
    r !== void 0 &&
      ...
      !(
        $i.containsPoint(Un.origin) === !1 &&
        (Un.intersectSphere($i, Ga) === null ||
          Un.origin.distanceToSquared(Ga) > (e.far - e.near) ** 2)
      ) &&
        (Va.copy(s).invert(),
        Un.copy(e.ray).applyMatrix4(Va),
...
class Tl extends It {
  constructor(e, t, n) {
    ...
    const r = new Bt(ii, ri, e, t);
    ((r.layers = this.layers), this.add(r));
    const s = new Bt(ii, ri, e, t);
    ((s.layers = this.layers), this.add(s));
    const a = new Bt(ii, ri, e, t);
    ((a.layers = this.layers), this.add(a));
    const o = new Bt(ii, ri, e, t);
    ((o.layers = this.layers), this.add(o));
    const l = new Bt(ii, ri, e, t);
    ((l.layers = this.layers), this.add(l));
    const c = new Bt(ii, ri, e, t);
...
class Xo extends St {
  constructor(e = [], t = fi, n, r, s, a, o, l, c, u) {
...
class Cl extends St {
  constructor(e = null, t = 1, n = 1, r, s, a, o, l, c = Ut, u = Ut, d, f) {
...
class qo extends St {
  constructor(e, t, n = Gn, r, s, a, o = Ut, l = Ut, c, u = Li, d = 1) {
    if (u !== Li && u !== Ui)
      throw new Error(
      ...
      ? (u === void 0 &&
          ((u = new Rt(
            ...
            new mn({
              ...
              uniforms: xi($t.backgroundCube.uniforms),
        ...
        (c === void 0 &&
          ((c = new Rt(
            ...
            new mn({
              ...
              uniforms: xi($t.background.uniforms),
...
function wd(i) {
  let e = new WeakMap();
  function t(a, o) {
    return (o === xs ? (a.mapping = fi) : o === _s && (a.mapping = pi), a);
  }
  function n(a) {
    if (a && a.isTexture) {
      const o = a.mapping;
...
class $a {
  ...
  _textureToCubeUV(e, t) {
    ...
    (si(t, 0, 0, 3 * l, 2 * l), n.setRenderTarget(t), n.render(a, wi));
  }
  _applyPMREM(e) {
  ...
  _halfBlur(e, t, n, r, s, a, o) {
    ...
    (si(t, D, y, 3 * R, 2 * R), l.setRenderTarget(t), l.render(d, wi));
  }
}
function Pd(i) {
  const e = [],
...
`)),
      (h = [
        ...
        t.toneMapping !== An ? Ff("toneMapping", t.toneMapping) : "",
  ...
  this.render = function (y, P, z) {
    ...
    for (let K = 0, Y = y.length; K < Y; K++) {
      ...
      if (
        ...
        const Se = this.type !== on ? { minFilter: Ut, magFilter: Ut } : {};
...
function xp(i, e, t, n, r, s, a) {
  ...
  function D(b, x) {
    return p(b) === !0 ||
      (b.isFramebufferTexture && b.minFilter !== Ut && b.minFilter !== zt)
  ...
  const te = { [gs]: i.REPEAT, [ln]: i.CLAMP_TO_EDGE, [vs]: i.MIRRORED_REPEAT },
    se = {
      [Ut]: i.NEAREST,
...
class Mp {
  ...
  getMesh(e) {
    if (this.texture !== null && this.mesh === null) {
      ...
      this.mesh = new Rt(new yr(20, 20), n);
    }
    return this.mesh;
  }
  reset() {
  ...
  function s(p, h) {
    ...
    (E &&
      ...
      E.isCubeTexture &&
        ...
        ((Fn.y *= -1), (Fn.z *= -1)),
      p.envMapRotation.value.setFromMatrix4(bp.makeRotationFromEuler(Fn)),
      (p.flipEnvMap.value =
...
class wp {
  constructor(e = {}) {
      ...
      if (U.isBatchedMesh)
        if (U._multiDrawInstances !== null)
          ...
          for (let Pt = 0; Pt < He; Pt++)
            (Xn.setValue(A, "_gl_DrawID", Pt), $e.render(Ee[Pt] / Ct, rt[Pt]));
        }
    ...
    const Cn = new Zo();
    (Cn.setAnimationLoop(sc),
      typeof self < "u" && Cn.setContext(self),
      (this.setAnimationLoop = function (_) {
        ((kt = _), re.setAnimationLoop(_), _ === null ? Cn.stop() : Cn.start());
      }),
    ...
    function ac(_, L, N, O, U) {
      ...
      const st = Ct.getUniforms(),
        bt = Ee.uniforms;
      if (
        (me.useProgram(Ct.program) && ((Xn = !0), (Pt = !0), (Si = !0)),
        O.id !== C && ((C = O.id), (Pt = !0)),
        Xn || B !== _)
      ) {
        ...
        const Et = st.map.cameraPosition;
        (Et !== void 0 &&
          Et.setValue(A, ge.setFromMatrixPosition(_.matrixWorld)),
      ...
      if (U.isSkinnedMesh) {
        ...
        vt &&
          ...
          st.setValue(A, "boneTexture", vt.boneTexture, Pe));
      }
      U.isBatchedMesh &&
      ...
      if (
        ...
        bt.dfgLUT !== void 0 && (bt.dfgLUT.value = Ap()),
        Pt &&
          (st.setValue(A, "toneMappingExposure", y.toneMappingExposure),
          Ee.needsLights && oc(bt, Si),
          Q && O.fog === !0 && _e.refreshFogUniforms(bt, Q),
          ...
          pr.upload(A, ga(Ee), bt, Pe)),
        O.isShaderMaterial &&
          O.uniformsNeedUpdate === !0 &&
          (pr.upload(A, ga(Ee), bt, Pe), (O.uniformsNeedUpdate = !1)),
    ...
    ((this.copyTextureToTexture = function (
      ...
      if (N !== null)
        ...
        ((le = Math.floor(ot.width * Nt)),
          (pe = Math.floor(ot.height * Nt)),
          _.isDataArrayTexture
            ? (ue = ot.depth)
            : _.isData3DTexture
              ? (ue = Math.floor(ot.depth * Nt))
              : (ue = 1),
          (Te = 0),
          (we = 0),
          (ve = 0));
      ...
      if (_.isDepthTexture) {
        const Nt = Me.get(_),
          vt = Me.get(L),
          Et = Me.get(Nt.__renderTarget),
          Cr = Me.get(vt.__renderTarget);
        (me.bindFramebuffer(A.READ_FRAMEBUFFER, Et.__webglFramebuffer),
        ...
        for (let Et = 0; Et < ue; Et++)
          (st
            ...
            U !== 0
              ...
              : bt
                ? A.copyTexSubImage3D(rt, Q, Ge, qe, at + Et, Te, we, le, pe)
...
class Cp extends zl {
  ...
  update(e = null) {
    ...
    (isFinite(n) &&
      isFinite(r) &&
      (n < -Math.PI ? (n += Tt) : n > Math.PI && (n -= Tt),
      r < -Math.PI ? (r += Tt) : r > Math.PI && (r -= Tt),
      n <= r
  ...
  _getAutoRotationAngle(e) {
    return e !== null
      ? (Tt / 60) * this.autoRotateSpeed * e
      : (Tt / 60 / 60) * this.autoRotateSpeed;
  }
  _getZoomScale(e) {
  ...
  _handleMouseMoveRotate(e) {
    ...
    (this._rotateLeft((Tt * this._rotateDelta.x) / t.clientHeight),
    ...
    switch (e.code) {
      case this.keys.UP:
        (e.ctrlKey || e.metaKey || e.shiftKey
          ? this.enableRotate &&
            this._rotateUp(
              (Tt * this.keyRotateSpeed) / this.domElement.clientHeight,
            )
...
const bo = {
  ground_Material: {
    light: new Vt({ color: 15658734 }),
    dark: new Vt({ color: 3552822 }),
  },
  barrier_Material: {
    light: new Vt({ color: 14540253 }),
    dark: new Vt({ color: 1776411 }),
  },
  appTheme: {
    light: {
...
class Xp {
  ...
  makeBarrier(e, t, n) {
    const r = { x: 1, y: 0.5, z: 1 },
      ...
      o = ui(this.AmmoLib, s, a, 0);
    this.physicsWorld.addRigidBody(o.body);
    const l = new Kt(r.x, r.y, r.z),
      c = new Rt(l, _i.getAsset("barrier_Material"));
...
class ua {
  ...
  goalMesh;
  bodies = [];
  barrierMaterial = _i.getAsset("barrier_Material");
  boxParams = [
    {
      posX: 0,
      posY: 1,
  ...
  async init(e) {
    ...
    const n = 20,
      r = new Kt(n, 1, n),
      s = _i.getAsset("ground_Material"),
      a = new Rt(r, s);
    (a.position.set(0, 0, 0), (a.receiveShadow = !0), e.add(a));
    const o = new this.AmmoLib.btVector3(n / 2, 0.5, n / 2),
      l = new this.AmmoLib.btVector3(0, 0, 0),
      c = ui(this.AmmoLib, o, l, 0);
    (this.physicsWorld.addRigidBody(c.body),
      this.bodies.push({ mesh: a, body: c.body }),
      this.createPlayer(),
      this.boxParams.forEach((u) => {
        this.makeBox(u);
      }),
      this.makeGoal());
  }
  ...
  makeBox(e) {
    const t = new this.AmmoLib.btVector3(e.sizeX / 2, e.sizeY / 2, e.sizeZ / 2),
      ...
      r = new Kt(e.sizeX, e.sizeY, e.sizeZ),
      s = ui(this.AmmoLib, t, n, 0);
    e.collide && this.physicsWorld.addRigidBody(s.body);
    const a = new Rt(r, e.color);
    return (
      a.position.set(e.posX, e.posY, e.posZ),
      this.scene.add(a),
      this.bodies.push({ mesh: a, body: s.body }),
      a
    );
  }
  goalParams = {
...
async function da(i) {
  for (gr = !0; oi.children.length; ) oi.remove(oi.children[0]);
  (At && (At.onExit(), (At.onSceneLeave = void 0), (At.onSaveGame = void 0)),
    (At = i),
    await At.init(oi),
    (At.onSceneLeave = (e) => da(e)),
    (At.onSaveGame = () => $s()),
    (At.onGameComplete = () => {
...
const wr = new Bt(75, window.innerWidth / window.innerHeight, 0.1, 1e3),
  qp = 15;
wr.position.y = qp;
const Bi = new wp();
...
window.addEventListener("keydown", (i) => {
  i.code === "KeyI" && (xn.addItem("test_item", 1), $s());
});
window.addEventListener("keydown", (i) => {
  let e = !1;
  (i.code === "KeyB"
...
window.addEventListener("click", (i) => {
  ...
  const e = Eo.intersectObjects(oi.children);
...
function rc() {
  ...
  const i = Zp.getDelta();
  (Kp.update(), At && !gr && At.update(i), Bi.render(oi, wr));
}
rc();
function $s() {
