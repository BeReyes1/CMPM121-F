...
class pa {
  ...
  expandByPoint(e) {
    ...
    if (t > this.radius * this.radius) {
      const n = Math.sqrt(t),
        s = (n - this.radius) * 0.5;
      (this.center.addScaledVector(Ci, s / n), (this.radius += s));
    }
    return this;
  }
  union(e) {
      ...
      : this.isEmpty()
        ...
        : (this.center.equals(e.center) === !0
            ...
            : (Xs.subVectors(e.center, this.center).setLength(e.radius),
              this.expandByPoint(Ci.copy(e.center).add(Xs)),
              this.expandByPoint(Ci.copy(e.center).sub(Xs))),
          this);
  }
  equals(e) {
...
class Ot extends Kn {
  ...
  lookAt(e, t, n) {
    ...
    (this.updateWorldMatrix(!0, !1),
      ...
      this.isCamera || this.isLight
        ? rn.lookAt(Ri, $i, this.up)
        : rn.lookAt($i, Ri, this.up),
  ...
  getWorldQuaternion(e) {
    return (
      this.updateWorldMatrix(!0, !1),
      this.matrixWorld.decompose(Ri, e, Ec),
      e
    );
  }
  getWorldScale(e) {
    return (
      this.updateWorldMatrix(!0, !1),
      this.matrixWorld.decompose(Ri, Tc, e),
      e
    );
  }
  getWorldDirection(e) {
      ...
      if ((Nt.setFromBufferAttribute(e), t))
        for (let r = 0, a = t.length; r < a; r++) {
          ...
          (Pi.setFromBufferAttribute(o),
            this.morphTargetsRelative
              ? (_t.addVectors(Nt.min, Pi.min),
                Nt.expandByPoint(_t),
                _t.addVectors(Nt.max, Pi.max),
                Nt.expandByPoint(_t))
              : (Nt.expandByPoint(Pi.min), Nt.expandByPoint(Pi.max)));
        }
      Nt.getCenter(n);
      let s = 0;
...
class el {
  ...
  setFromProjectionMatrix(e, t = Qt, n = !1) {
    ...
    if (
      ...
      s[5].setComponents(l + c, m + f, h + p, D + C).normalize();
    else if (t === vs) s[5].setComponents(c, f, p, C).normalize();
    else
      throw new Error(
...
transformedNormal = normalMatrix * transformedNormal;
  ...
  Rh = `vec4 LinearTransferOETF( in vec4 value ) {
	return value;
}
...
function Ld(i, e, t, n, s, r, a) {
  ...
  function h(y, C) {
    (y.getRGB(cs, $o(i)), n.buffers.color.setClear(cs.r, cs.g, cs.b, C, a));
  }
  function T() {
...
class so {
  ...
  _halfBlur(e, t, n, s, r, a, o) {
    ...
    (hi(t, D, E, 3 * C, 2 * C), c.setRenderTarget(t), c.render(d, Di));
  }
}
function kd(i) {
  const e = [],
...
`)),
      (h = [
        ...
        t.toneMapping !== Cn ? Yf("toneMapping", t.toneMapping) : "",
...
function up(i, e, t, n, s, r, a) {
  ...
  function D(S, v) {
    ...
    return (R === void 0 && ((R = new op(i, v, S, r)), u.push(R)), R);
  }
  function E(S) {
    if (--S.usedTimes === 0) {
      const v = u.indexOf(S);
...
function Tp(i, e) {
  ...
  function s() {
    ...
    return {
      ...
      setOp: function (Ze, jt, Ht) {
        (Z !== Ze || fe !== jt || Re !== Ht) &&
          (i.stencilOp(Ze, jt, Ht), (Z = Ze), (fe = jt), (Re = Ht));
      },
  ...
  function st(w, le, ie, se, J, Z, fe, Re, nt, Ze) {
    if (w === fn) {
      M === !0 && (de(i.BLEND), (M = !1));
      return;
    }
  ...
  constructor(e = {}) {
    ...
    function xl(_, L, N, O, U) {
      ...
      const ot = Lt.getUniforms(),
        Et = ye.uniforms;
      if (
        (me.useProgram(Lt.program) && ((jn = !0), (Ut = !0), (Ti = !0)),
        O.id !== R && ((R = O.id), (Ut = !0)),
        jn || B !== _)
      ) {
...
class cl {
  ...
  handleBarrierEvent() {
    ...
    (Rt.getGameStateInventory().Coin?.quantity ?? 0) >= this.coinCount
      ? this.openBarrier()
  ...
  openBarrier() {
    ...
    ((this.barrierMeshes = []),
      (this.barrierBodies = []),
      Rt.removeItem("Coin", this.coinCount),
      this.onSaveGame?.());
  }
  makeFalseChests() {
  ...
  onCollect(e) {
    if (
      (e.userData.type == "Key" && this.pickupKey(e), e.userData.type == "Coin")
    ) {
      const t = 0.1 * Math.floor(Math.random() * 10);
      (Rt.addItem("Coin", t), this.scene.remove(e), this.onSaveGame?.());
    }
  }
}
class hl {
...
function dl() {
  (Ss && (Ss.textContent = Xe.getText("start_button")),
    Rs && (Rs.textContent = Xe.getText("language_button")),
    ws && (ws.textContent = Xe.getText("end_text")),
    Cs && (Cs.textContent = Xe.getText("restart_button")),
...
function pl() {
  ...
  const i = nm.getDelta();
  (fl.update(), Ct && !Zn && Ct.update(i), Vi.render(fi, Ns));
}
pl();
function Io() {
  const i = { inventory: Rt.getGameStateInventory() };
...
function im() {
  ...
  Rt.setGameStateInventory(e.inventory);
}
function sm() {
  (localStorage.removeItem("gameSave"),
    Rt.setGameStateInventory({}),
