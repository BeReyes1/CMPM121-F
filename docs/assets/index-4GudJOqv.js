...
function rl() {
  const i = {
      ...
      getTransfer: function (r) {
        return r === Tn ? mr : this.spaces[r].transfer;
      },
...
class bt extends Yn {
  ...
  get width() {
    return this.source.getSize(Nr).x;
  }
  get height() {
    return this.source.getSize(Nr).y;
  }
  get depth() {
    return this.source.getSize(Nr).z;
  }
  get image() {
...
class cl extends Yn {
  ...
  copy(e) {
    ...
    for (let t = 0, n = e.textures.length; t < n; t++) {
      ...
      this.textures[t].source = new aa(r);
    }
    return (
...
class Oi {
      ...
      if (t === !0 && s !== void 0 && e.isInstancedMesh !== !0)
        ...
        (e.boundingBox !== void 0
          ? (e.boundingBox === null && e.computeBoundingBox(),
            ki.copy(e.boundingBox))
          : (n.boundingBox === null && n.computeBoundingBox(),
            ki.copy(n.boundingBox)),
  ...
  intersectsTriangle(e) {
    ...
    (this.getCenter(Ei),
      Hi.subVectors(this.max, Ei),
      jn.subVectors(e.a, Ei),
      $n.subVectors(e.b, Ei),
      Jn.subVectors(e.c, Ei),
      gn.subVectors($n, jn),
      vn.subVectors(Jn, $n),
      Ln.subVectors(jn, Jn));
    let t = [
    ...
    return !Fr(t, jn, $n, Jn, Hi) ||
      ((t = [1, 0, 0, 0, 1, 0, 0, 0, 1]), !Fr(t, jn, $n, Jn, Hi))
      ? !1
      : (Wi.crossVectors(gn, vn),
        (t = [Wi.x, Wi.y, Wi.z]),
        Fr(t, jn, $n, Jn, Hi));
  }
  clampPoint(e, t) {
      ...
      : this.isEmpty()
        ...
        : (this.center.equals(e.center) === !0
            ...
            : (Or.subVectors(e.center, this.center).setLength(e.radius),
              this.expandByPoint(yi.copy(e.center).add(Or)),
              this.expandByPoint(yi.copy(e.center).sub(Or))),
          this);
  }
  equals(e) {
...
class ca {
  ...
  distanceSqToSegment(e, t, n, r) {
    (Br.copy(e).add(t).multiplyScalar(0.5),
      Xi.copy(t).sub(e).normalize(),
      Mn.copy(this.origin).sub(Br));
    ...
    return (
      ...
      r && r.copy(Br).addScaledVector(Xi, f),
      m
    );
  }
  intersectSphere(e, t) {
  ...
  intersectTriangle(e, t, n, r, s) {
    (zr.subVectors(t, e), Yi.subVectors(n, e), Vr.crossVectors(zr, Yi));
    ...
    const l = o * this.direction.dot(Yi.crossVectors(Mn, Yi));
    if (l < 0) return null;
    const c = o * this.direction.dot(zr.cross(Mn));
...
class ut {
  ...
  lookAt(e, t, n) {
    ...
    return (
      ...
      Dt.normalize(),
      Sn.crossVectors(n, Dt),
      Sn.lengthSq() === 0 &&
        (Math.abs(n.z) === 1 ? (Dt.x += 1e-4) : (Dt.z += 1e-4),
        Dt.normalize(),
        Sn.crossVectors(n, Dt)),
      Sn.normalize(),
      qi.crossVectors(Dt, Sn),
      (r[0] = Sn.x),
      (r[4] = qi.x),
      (r[8] = Dt.x),
      (r[1] = Sn.y),
...
class mn {
  ...
  setFromQuaternion(e, t, n) {
    return (
      La.makeRotationFromQuaternion(e),
      this.setFromRotationMatrix(La, t, n)
    );
  }
...
class Nt extends Yn {
  ...
  lookAt(e, t, n) {
    ...
    (this.updateWorldMatrix(!0, !1),
      ...
      this.isCamera || this.isLight
        ? nn.lookAt(Ti, Ki, this.up)
        : nn.lookAt(Ki, Ti, this.up),
  ...
  getWorldQuaternion(e) {
    return (
      this.updateWorldMatrix(!0, !1),
      this.matrixWorld.decompose(Ti, e, pl),
      e
    );
  }
  getWorldScale(e) {
    return (
      this.updateWorldMatrix(!0, !1),
      this.matrixWorld.decompose(Ti, ml, e),
      e
    );
  }
  getWorldDirection(e) {
...
class Yt {
  ...
  static getBarycoord(e, t, n, r, s) {
    (Xt.subVectors(r, t), rn.subVectors(n, t), kr.subVectors(e, t));
    const a = Xt.dot(Xt),
      o = Xt.dot(rn),
      l = Xt.dot(kr),
      c = rn.dot(rn),
  ...
  static getInterpolatedAttribute(e, t, n, r, s, a) {
    return (
      ...
      qr.fromBufferAttribute(e, n),
      Kr.fromBufferAttribute(e, r),
      a.setScalar(0),
      a.addScaledVector(Yr, s.x),
      a.addScaledVector(qr, s.y),
      a.addScaledVector(Kr, s.z),
      a
    );
  }
  static isFrontFacing(e, t, n, r) {
    return (Xt.subVectors(n, t), rn.subVectors(e, t), Xt.cross(rn).dot(r) < 0);
  }
  set(e, t, n) {
  ...
  closestPointToPoint(e, t) {
    const n = this.a,
      ...
      s = this.c;
    let a, o;
    (ni.subVectors(r, n), ii.subVectors(s, n), Hr.subVectors(e, n));
    const l = ni.dot(Hr),
      c = ii.dot(Hr);
...
class je {
  ...
  setHSL(e, t, n, r = We.workingColorSpace) {
    if (((e = nl(e, 1)), (t = Oe(t, 0, 1)), (n = Oe(n, 0, 1)), t === 0))
  ...
  lerpHSL(e, t) {
    (this.getHSL(bn), e.getHSL(Zi));
    const n = Dr(bn.h, Zi.h, t),
      r = Dr(bn.s, Zi.s, t),
      s = Dr(bn.l, Zi.l, t);
...
class Er extends Yn {
  ...
  toJSON(e) {
    ...
    ((n.uuid = this.uuid),
      ...
      this.blendDst !== cs && (n.blendDst = this.blendDst),
      this.blendEquation !== Bn && (n.blendEquation = this.blendEquation),
...
class Cn extends Yn {
  ...
  setFromPoints(e) {
    ...
    if (t === void 0) {
      ...
      this.setAttribute("position", new kn(n, 3));
    } else {
        ...
        for (let n = 0, r = t.length; n < r; n++) {
          ...
          (Lt.setFromBufferAttribute(s),
            this.morphTargetsRelative
              ? (mt.addVectors(this.boundingBox.min, Lt.min),
                this.boundingBox.expandByPoint(mt),
                mt.addVectors(this.boundingBox.max, Lt.max),
                this.boundingBox.expandByPoint(mt))
      ...
      if ((Lt.setFromBufferAttribute(e), t))
        for (let s = 0, a = t.length; s < a; s++) {
          ...
          (Ai.setFromBufferAttribute(o),
            this.morphTargetsRelative
              ? (mt.addVectors(Lt.min, Ai.min),
                Lt.expandByPoint(mt),
                mt.addVectors(Lt.max, Ai.max),
                Lt.expandByPoint(mt))
              : (Lt.expandByPoint(Ai.min), Lt.expandByPoint(Ai.max)));
        }
      Lt.getCenter(n);
      let r = 0;
...
class vt extends Nt {
    ...
    if (s && o) {
      ...
      for (let l = 0, c = s.length; l < c; l++) {
        const u = o[l],
          d = s[l];
        u !== 0 &&
          ($r.fromBufferAttribute(d, e),
          a ? tr.addScaledVector($r, u) : tr.addScaledVector($r.sub(t), u));
      }
      t.add(tr);
    }
    return t;
  ...
  raycast(e, t) {
    ...
    r !== void 0 &&
      ...
      $i.applyMatrix4(s),
      In.copy(e.ray).recast(e.near),
      !(
        $i.containsPoint(In.origin) === !1 &&
        (In.intersectSphere($i, Ga) === null ||
          In.origin.distanceToSquared(Ga) > (e.far - e.near) ** 2)
      ) &&
        (Va.copy(s).invert(),
        In.copy(e.ray).applyMatrix4(Va),
        !(n.boundingBox !== null && In.intersectsBox(n.boundingBox) === !1) &&
          this._computeIntersections(e, t, In)));
  }
...
function Ml(i, e, t, n, r, s, a, o) {
  ...
  if (
    (e.side === Rt
      ...
      : (l = n.intersectTriangle(r, s, a, e.side === Rn, o)),
    l === null)
  )
    return null;
...
function ir(i, e, t, n, r, s, a, o, l, c) {
  ...
  const u = Ml(i, e, t, n, Ji, Qi, er, ka);
  if (u) {
    const d = new F();
    (Yt.getBarycoord(ka, Ji, Qi, er, d),
    ...
    (Yt.getNormal(Ji, Qi, er, f.normal), (u.face = f), (u.barycoord = d));
  }
  return u;
}
class Ut extends Cn {
  constructor(e = 1, t = 1, n = 1, r = 1, s = 1, a = 1) {
    ...
    (g("z", "y", "x", -1, -1, n, t, e, a, s, 0),
      ...
      this.setAttribute("uv", new kn(d, 2)));
...
class xn extends Er {
  constructor(e) {
    (super(),
      ...
      (this.uniforms = {}),
      (this.uniformsGroups = []),
      (this.vertexShader = El),
      (this.fragmentShader = yl),
      (this.linewidth = 1),
      (this.wireframe = !1),
      (this.wireframeLinewidth = 1),
      (this.fog = !1),
  ...
  copy(e) {
    return (
      ...
      (this.uniformsGroups = Sl(e.uniformsGroups)),
...
class zt extends Wo {
  ...
  getEffectiveFOV() {
    return Ks * 2 * Math.atan(Math.tan(fr * 0.5 * this.fov) / this.zoom);
  }
  getFilmWidth() {
  ...
  getViewSize(e, t) {
    return (this.getViewBounds(e, Ha, Wa), t.subVectors(Wa, Ha));
  }
...
class Tl extends Nt {
  constructor(e, t, n) {
    ...
    const r = new zt(si, ai, e, t);
    ((r.layers = this.layers), this.add(r));
    const s = new zt(si, ai, e, t);
    ((s.layers = this.layers), this.add(s));
    const a = new zt(si, ai, e, t);
    ((a.layers = this.layers), this.add(a));
    const o = new zt(si, ai, e, t);
    ((o.layers = this.layers), this.add(o));
    const l = new zt(si, ai, e, t);
    ((l.layers = this.layers), this.add(l));
    const c = new zt(si, ai, e, t);
...
class yn {
  ...
  setFromCoplanarPoints(e, t, n) {
    const r = Qr.subVectors(n, t).cross(Pl.subVectors(e, t)).normalize();
...
class Yo {
  ...
  setFromProjectionMatrix(e, t = Jt, n = !1) {
    ...
    if (
      ...
      r[5].setComponents(c + l, m + f, h + p, D + R).normalize();
    else if (t === xr) r[5].setComponents(l, f, p, R).normalize();
    else
      throw new Error(
  ...
  intersectsObject(e) {
    if (e.boundingSphere !== void 0)
      (e.boundingSphere === null && e.computeBoundingSphere(),
        Nn.copy(e.boundingSphere).applyMatrix4(e.matrixWorld));
    else {
      const t = e.geometry;
  ...
  intersectsSprite(e) {
    Nn.center.set(0, 0, 0);
    const t = Ll.distanceTo(e.center);
    return (
      (Nn.radius = 0.7071067811865476 + t),
      Nn.applyMatrix4(e.matrixWorld),
      this.intersectsSphere(Nn)
    );
  }
  intersectsSphere(e) {
    const t = this.planes,
...
class qo extends bt {
  constructor(e, t, n = Hn, r, s, a, o = It, l = It, c, u = Li, d = 1) {
    if (u !== Li && u !== Ui)
      throw new Error(
  ...
  copy(e) {
    return (
      super.copy(e),
      (this.source = new aa(Object.assign({}, e.image))),
...
class Bl {
  ...
  setFromXRController(e) {
    return (
      Xa.identity().extractRotation(e.matrixWorld),
      this.ray.origin.setFromMatrixPosition(e.matrixWorld),
      this.ray.direction.set(0, 0, -1).applyMatrix4(Xa),
      this
    );
  }
...
#endif`,
  Jl = `vec3 transformed = vec3( position );
#ifdef USE_ALPHAHASH
	vPosition = vec3( position );
#endif`,
  Ql = `vec3 objectNormal = vec3( normal );
#ifdef USE_TANGENT
...
#endif`,
  _h = `#ifdef USE_EMISSIVEMAP
	uniform sampler2D emissiveMap;
#endif`,
  gh = "gl_FragColor = linearToOutputTexel( gl_FragColor );",
  vh = `vec4 LinearTransferOETF( in vec4 value ) {
	return value;
}
...
#endif`,
  Dh = `LambertMaterial material;
material.diffuseColor = diffuseColor.rgb;
material.specularStrength = specularStrength;`,
  Lh = `varying vec3 vViewPosition;
...
#define RE_IndirectDiffuse		RE_IndirectDiffuse_Toon`,
  Oh = `BlinnPhongMaterial material;
material.diffuseColor = diffuseColor.rgb;
...
#endif`,
  Wh = `#if defined( USE_LOGARITHMIC_DEPTH_BUFFER )
	gl_FragDepth = vIsPerspective == 0.0 ? gl_FragCoord.z : log2( vFragDepth ) * logDepthBufFC * 0.5;
#endif`,
  Xh = `#if defined( USE_LOGARITHMIC_DEPTH_BUFFER )
	uniform float logDepthBufFC;
	varying float vFragDepth;
	varying float vIsPerspective;
#endif`,
  Yh = `#ifdef USE_LOGARITHMIC_DEPTH_BUFFER
	varying float vFragDepth;
	varying float vIsPerspective;
#endif`,
  qh = `#ifdef USE_LOGARITHMIC_DEPTH_BUFFER
...
#endif`,
  su = `float faceDirection = gl_FrontFacing ? 1.0 : - 1.0;
#ifdef FLAT_SHADED
...
#endif`,
  gu = `vec4 mvPosition = vec4( transformed, 1.0 );
#ifdef USE_BATCHING
...
#endif`,
  Su = `float roughnessFactor = roughness;
...
#endif`,
  Ou = `#if defined( USE_UV ) || defined( USE_ANISOTROPY )
	varying vec2 vUv;
#endif
#ifdef USE_MAP
	varying vec2 vMapUv;
...
#endif`,
  Vu = `#if defined( USE_ENVMAP ) || defined( DISTANCE ) || defined ( USE_SHADOWMAP ) || defined ( USE_TRANSMISSION ) || NUM_SPOT_LIGHT_COORDS > 0
...
void main() {
  ...
  Ne = {
    alphahash_fragment: kl,
    alphahash_pars_fragment: Hl,
    ...
    displacementmap_pars_vertex: ph,
    ...
    fog_pars_vertex: Ah,
    fog_fragment: wh,
    fog_pars_fragment: Rh,
    gradientmap_pars_fragment: Ch,
    lightmap_pars_fragment: Ph,
    lights_lambert_fragment: Dh,
    lights_lambert_pars_fragment: Lh,
...
function bd(i, e, t, n, r, s, a) {
  ...
  function p(E, R) {
    const D = g(R);
    D && (D.isCubeTexture || D.mapping === br)
      ? (u === void 0 &&
          ((u = new vt(
            new Ut(1, 1, 1),
            new xn({
  ...
  function h(E, R) {
    (E.getRGB(ar, Ho(i)), n.buffers.color.setClear(ar.r, ar.g, ar.b, R, a));
  }
  function T() {
...
function Ed(i, e) {
  ...
  function m(v, C, B, G) {
    ...
    return s.attributesNum !== Y || s.index !== G;
  }
  function g(v, C, B, G) {
    const H = {},
      K = C.attributes;
    ...
    ((s.attributes = H), (s.attributesNum = Y), (s.index = G));
  }
  function M() {
      ...
      if (k.location >= 0) {
        ...
        if (
          ...
          const Xe = ke.buffer,
            ...
            X = Je === i.INT || Je === i.UNSIGNED_INT || te.gpuType === Qs;
          if (te.isInterleavedBufferAttribute) {
            ...
            if (j.isInstancedInterleavedBuffer) {
              for (let ge = 0; ge < k.locationSize; ge++)
                h(k.location + ge, j.meshPerAttribute);
              v.isInstancedMesh !== !0 &&
                G._maxInstanceCount === void 0 &&
                (G._maxInstanceCount = j.meshPerAttribute * j.count);
            } else
            ...
            if (te.isInstancedBufferAttribute) {
              for (let j = 0; j < k.locationSize; j++)
                h(k.location + j, te.meshPerAttribute);
              v.isInstancedMesh !== !0 &&
                G._maxInstanceCount === void 0 &&
...
function wd(i) {
  let e = new WeakMap();
  function t(a, o) {
    return (o === xs ? (a.mapping = pi) : o === _s && (a.mapping = mi), a);
  }
  function n(a) {
    if (a && a.isTexture) {
      const o = a.mapping;
...
class $a {
  ...
  fromScene(e, t = 0, n = 0.1, r = 100, s = {}) {
    const { size: a = 256, position: o = Cd } = s;
  ...
  compileCubemapShader() {
    this._cubemapMaterial === null &&
      ((this._cubemapMaterial = eo()),
      this._compileMaterial(this._cubemapMaterial));
  }
  compileEquirectangularShader() {
    this._equirectMaterial === null &&
      ((this._equirectMaterial = Qa()),
  ...
  _allocateTargets() {
    ...
    if (
      ...
      (this._pingPongRenderTarget !== null && this._dispose(),
        (this._pingPongRenderTarget = Ja(e, t, n)));
  ...
  _textureToCubeUV(e, t) {
    ...
    r
      ? (this._cubemapMaterial === null && (this._cubemapMaterial = eo()),
        (this._cubemapMaterial.uniforms.flipEnvMap.value =
          e.isRenderTargetTexture === !1 ? -1 : 1))
      : this._equirectMaterial === null && (this._equirectMaterial = Qa());
    ...
    (oi(t, 0, 0, 3 * l, 2 * l), n.setRenderTarget(t), n.render(a, wi));
  }
  _applyPMREM(e) {
  ...
  _applyGGXFilter(e, t, n) {
    ...
    if (this._ggxMaterial === null) {
      const T = 3 * Math.max(this._cubeSize, 16),
        E = 4 * this._cubeSize;
      this._ggxMaterial = Dd(this._lodMax, T, E);
    }
  ...
  _halfBlur(e, t, n, r, s, a, o) {
    ...
    const f = c.uniforms,
      ...
      g = isFinite(s) ? Math.PI / (2 * m) : (2 * Math.PI) / (2 * zn - 1),
      M = s / g,
      p = isFinite(s) ? 1 + Math.floor(u * M) : zn;
    p > zn &&
      De(
        `sigmaRadians, ${s}, is too large and will clip, as it requested ${p} samples when the maximum is set to ${zn}`,
      );
    const h = [];
    let T = 0;
    for (let P = 0; P < zn; ++P) {
    ...
    const R = this._sizeLods[r],
      D = 3 * R * (r > E - An ? r - E + An : 0),
      y = 4 * (this._cubeSize - R);
    (oi(t, D, y, 3 * R, 2 * R), l.setRenderTarget(t), l.render(d, wi));
  }
}
function Pd(i) {
  const e = [],
    ...
    n = [];
  let r = i;
  const s = i - An + 1 + Za.length;
  for (let a = 0; a < s; a++) {
    const o = Math.pow(2, r);
    e.push(o);
    let l = 1 / o;
    (a > i - An ? (l = Za[a - i + An - 1]) : a === 0 && (l = 0), t.push(l));
    const c = 1 / (o - 2),
      u = -c,
      d = 1 + c,
...
function Id(i) {
  ...
  return {
    ...
    get: function (n) {
      const r = t(n);
      return (
        r === null && Ii("WebGLRenderer: " + n + " extension not supported."),
        r
      );
    },
  };
...
function Ar(i, e) {
  let t = io[e];
  t === void 0 && ((t = new Int32Array(e)), (io[e] = t));
...
function Wd(i, e) {
  ...
  if (n === void 0) {
    ...
    if (ft(t, n)) return;
    (ao.set(n), i.uniformMatrix2fv(this.addr, !1, ao), pt(t, n));
  }
}
function Xd(i, e) {
  const t = this.cache,
...
function Yd(i, e) {
  ...
  if (n === void 0) {
    ...
    if (ft(t, n)) return;
    (ro.set(n), i.uniformMatrix4fv(this.addr, !1, ro), pt(t, n));
  }
}
function qd(i, e) {
  const t = this.cache;
...
function nf(i, e, t) {
  const n = this.cache,
    r = t.allocateTextureUnit();
  (n[0] !== r && (i.uniform1i(this.addr, r), (n[0] = r)),
    t.setTexture3D(e || Jo, r));
}
function rf(i, e, t) {
  const n = this.cache,
    r = t.allocateTextureUnit();
  (n[0] !== r && (i.uniform1i(this.addr, r), (n[0] = r)),
    t.setTextureCube(e || Qo, r));
}
function sf(i, e, t) {
  const n = this.cache,
    r = t.allocateTextureUnit();
  (n[0] !== r && (i.uniform1i(this.addr, r), (n[0] = r)),
    t.setTexture2DArray(e || $o, r));
}
function af(i) {
  switch (i) {
    case 5126:
...
function bf(i, e, t) {
  ...
  for (let a = 0; a !== r; ++a) t.setTexture2D(e[a] || jo, s[a]);
}
function Ef(i, e, t) {
  const n = this.cache,
    r = e.length,
    s = Ar(t, r);
  ft(n, s) || (i.uniform1iv(this.addr, s), pt(n, s));
  for (let a = 0; a !== r; ++a) t.setTexture3D(e[a] || Jo, s[a]);
}
function yf(i, e, t) {
  const n = this.cache,
    r = e.length,
    s = Ar(t, r);
  ft(n, s) || (i.uniform1iv(this.addr, s), pt(n, s));
  for (let a = 0; a !== r; ++a) t.setTextureCube(e[a] || Qo, s[a]);
}
function Tf(i, e, t) {
  const n = this.cache,
    r = e.length,
    s = Ar(t, r);
  ft(n, s) || (i.uniform1iv(this.addr, s), pt(n, s));
  for (let a = 0; a !== r; ++a) t.setTexture2DArray(e[a] || $o, s[a]);
}
function Af(i) {
  switch (i) {
    case 5126:
...
function Pf(i, e, t) {
  ...
  for (rs.lastIndex = 0; ; ) {
    ...
    if ((l && (o = o | 0), c === void 0 || (c === "[" && a + 2 === r))) {
      oo(t, c === void 0 ? new wf(o, i, e) : new Rf(o, i, e));
      break;
    } else {
      let d = t.map[o];
      (d === void 0 && ((d = new Cf(o)), oo(t, d)), (t = d));
    }
  }
}
class pr {
...
const lo = new Ue();
function If(i) {
  We._getMatrix(lo, We.workingColorSpace, i);
...
`)),
      (h = [
        ...
        t.toneMapping !== wn ? Ne.tonemapping_pars_fragment : "",
        t.toneMapping !== wn ? Ff("toneMapping", t.toneMapping) : "",
...
` +
  ...
  const E = T + p + a,
    R = T + h + o,
    D = co(r, r.VERTEX_SHADER, E),
    y = co(r, r.FRAGMENT_SHADER, R);
  (r.attachShader(M, D),
    r.attachShader(M, y),
...
` +
    ...
    (r.deleteShader(D), r.deleteShader(y), (z = new pr(r, M)), (S = Vf(r, M)));
  }
  let z;
  ...
  return (
    (this.isReady = function () {
      return (v === !1 && (v = r.getProgramParameter(M, Df)), v);
    }),
...
function tp(i, e, t, n, r, s, a) {
  ...
  function p(S, v, C, B, G) {
    const H = B.fog,
      ...
      k = ne && ne.mapping === br ? ne.image.height : null,
      te = g[S.type];
    S.precision !== null &&
    ...
    if (te) {
      const Ye = $t[te];
      ((Xe = Ye.vertexShader), (Je = Ye.fragmentShader));
    } else
      ((Xe = S.vertexShader),
        (Je = S.fragmentShader),
        l.update(S),
    ...
    const tt = {
      ...
      emissiveMap: me,
      normalMapObjectSpace: Ve && S.normalMapType === Yc,
      normalMapTangentSpace: Ve && S.normalMapType === Xc,
      metalnessMap: it,
      roughnessMap: Me,
      anisotropy: Pe,
      anisotropyMap: V,
  ...
  function D(S, v) {
    ...
    return (C === void 0 && ((C = new $f(i, v, S, s)), u.push(C)), C);
  }
  function y(S) {
    if (--S.usedTimes === 0) {
      const v = u.indexOf(S);
...
function _o() {
  ...
  function c(d, f) {
    (t.length > 1 && t.sort(d || ip),
      n.length > 1 && n.sort(f || xo),
      r.length > 1 && r.sort(f || xo));
  }
  function u() {
  ...
  function o(c) {
    ...
    for (let S = 0, v = c.length; S < v; S++) {
      ...
      if (C.isAmbientLight) ((u += B.r * G), (d += B.g * G), (f += B.b * G));
        ...
        for (let Y = 0; Y < 9; Y++)
          n.probe[Y].addScaledVector(C.sh.coefficients[Y], G);
        P++;
        ...
        const Y = e.get(C);
        (Y.position.setFromMatrixPosition(C.matrixWorld),
          Y.color.copy(B).multiplyScalar(G),
          (Y.distance = H),
          (Y.coneCos = Math.cos(C.angle)),
          (Y.penumbraCos = Math.cos(C.angle * (1 - C.penumbra))),
          (Y.decay = C.decay),
          (n.spot[M] = Y));
        const ne = C.shadow;
        if (
        ...
        const Y = e.get(C);
        (Y.color.copy(B).multiplyScalar(G),
          Y.halfWidth.set(C.width * 0.5, 0, 0),
          Y.halfHeight.set(0, C.height * 0.5, 0),
          (n.rectArea[p] = Y),
          p++);
      } else if (C.isPointLight) {
        const Y = e.get(C);
        if (
          (Y.color.copy(C.color).multiplyScalar(C.intensity),
          (Y.distance = C.distance),
          (Y.decay = C.decay),
          C.castShadow)
        ) {
          const ne = C.shadow,
        ...
        const Y = e.get(C);
        (Y.skyColor.copy(C.color).multiplyScalar(G),
          Y.groundColor.copy(C.groundColor).multiplyScalar(G),
          (n.hemi[h] = Y),
          h++);
      }
    }
...
function mp(i, e) {
  function t() {
    ...
    return {
      ...
      setClear: function (J, q, fe, Ce, tt) {
        (tt === !0 && ((J *= Ce), (q *= Ce), (fe *= Ce)),
          ce.set(J, q, fe, Ce),
          re.equals(ce) === !1 && (i.clearColor(J, q, fe, Ce), re.copy(ce)));
      },
      reset: function () {
  ...
  function n() {
    ...
    return {
      ...
      setClear: function (q) {
        J !== q && (ce && (q = 1 - q), i.clearDepth(q), (J = q));
      },
      reset: function () {
  ...
  function r() {
    ...
    return {
      ...
      setMask: function (Ye) {
        ce !== Ye && !w && (i.stencilMask(Ye), (ce = Ye));
      },
      setFunc: function (Ye, Zt, kt) {
        (ie !== Ye || re !== Zt || J !== kt) &&
          (i.stencilFunc(Ye, Zt, kt), (ie = Ye), (re = Zt), (J = kt));
      },
      setOp: function (Ye, Zt, kt) {
        (q !== Ye || fe !== Zt || Ce !== kt) &&
          (i.stencilOp(Ye, Zt, kt), (q = Ye), (fe = Zt), (Ce = kt));
      },
  ...
  k.indexOf("WebGL") !== -1
    ? ((ne = parseFloat(/^WebGL (\d)/.exec(k)[1])), (Y = ne >= 1))
    : k.indexOf("OpenGL ES") !== -1 &&
      ((ne = parseFloat(/^OpenGL ES (\d)/.exec(k)[1])), (Y = ne >= 2));
  let te = null,
    se = {};
  ...
  function ge(w, ce) {
    ...
    if (w) {
      ...
      if (ie.length !== J.length || ie[0] !== i.COLOR_ATTACHMENT0) {
        for (let q = 0, fe = J.length; q < fe; q++)
  ...
  const xt = {
    [Bn]: i.FUNC_ADD,
    [xc]: i.FUNC_SUBTRACT,
    [_c]: i.FUNC_REVERSE_SUBTRACT,
  };
  ((xt[gc] = i.MIN), (xt[vc] = i.MAX));
  const Fe = {
    [Mc]: i.ZERO,
    [Sc]: i.ONE,
    [bc]: i.SRC_COLOR,
  ...
  function nt(w, ce, ie, re, J, q, fe, Ce, tt, Ye) {
    if (w === dn) {
      M === !0 && (de(i.BLEND), (M = !1));
      return;
    }
    if ((M === !1 && (j(i.BLEND), (M = !0)), w !== mc)) {
      if (w !== p || Ye !== S) {
        if (
          ((h !== Bn || R !== Bn) &&
            (i.blendEquation(i.FUNC_ADD), (h = Bn), (R = Bn)),
          Ye)
        )
          switch (w) {
            case ui:
    ...
    ((J = J || ce),
      ...
      (ie !== T || re !== E || q !== D || fe !== y) &&
        (i.blendFuncSeparate(Fe[ie], Fe[re], Fe[q], Fe[fe]),
        (T = ie),
        (E = re),
        (D = q),
        (y = fe)),
  ...
  function A(w, ce) {
    w.side === cn ? de(i.CULL_FACE) : j(i.CULL_FACE);
    let ie = w.side === Rt;
    (ce && (ie = !ie),
      ze(ie),
...
function xp(i, e, t, n, r, s, a) {
  ...
  function g(b, x) {
    return m ? new OffscreenCanvas(b, x) : _r("canvas");
  }
  function M(b, x, I) {
    let W = 1;
    const Z = Pe(b);
    if (
      ((Z.width > I || Z.height > I) && (W = I / Math.max(Z.width, Z.height)),
      W < 1)
    )
      if (
        ...
        const V = Math.floor(W * Z.width),
          _e = Math.floor(W * Z.height);
        d === void 0 && (d = g(V, _e));
        const oe = x ? g(V, _e) : d;
        return (
          (oe.width = V),
  ...
  function E(b, x, I, W, Z = !1) {
    ...
    if (
      ...
      const _e = Z ? mr : We.getTransfer(W);
    ...
    if (
      ...
      for (let W = 0; W < 6; W++) {
        if (Array.isArray(x.__webglFramebuffer[W]))
          for (let Z = 0; Z < x.__webglFramebuffer[W].length; Z++)
            i.deleteFramebuffer(x.__webglFramebuffer[W][Z]);
  ...
  const te = { [gs]: i.REPEAT, [hn]: i.CLAMP_TO_EDGE, [vs]: i.MIRRORED_REPEAT },
    se = {
      [It]: i.NEAREST,
      [kc]: i.NEAREST_MIPMAP_NEAREST,
  ...
  function ke(b, x) {
    if (
      ...
      if (
        x.magFilter === It ||
        (x.minFilter !== Gi && x.minFilter !== Vn) ||
        (x.type === un && e.has("OES_texture_float_linear") === !1)
      )
        return;
  ...
  function Xe(b, x) {
    ...
    if (V !== b.__cacheKey) {
      (Z[V] === void 0 &&
        ((Z[V] = { texture: i.createTexture(), usedTimes: 0 }),
        a.memory.textures++,
        (I = !0)),
        Z[V].usedTimes++);
      const _e = Z[b.__cacheKey];
      (_e !== void 0 &&
        (Z[b.__cacheKey].usedTimes--, _e.usedTimes === 0 && S(x)),
        (b.__cacheKey = V),
        (b.__webglTexture = Z[V].texture));
    }
    return I;
  }
  function Je(b, x, I) {
  ...
  function X(b, x, I) {
    ...
    const _e = n.get(V);
    if (V.version !== _e.__version || Z === !0) {
      t.activeTexture(i.TEXTURE0 + I);
      const oe = We.getPrimaries(We.workingColorSpace),
        be = x.colorSpace === Tn ? null : We.getPrimaries(x.colorSpace),
        xe =
          x.colorSpace === Tn || oe === be ? i.NONE : i.BROWSER_DEFAULT_WEBGL;
      ...
      const Re = x.mipmaps,
        ...
        ce = _e.__version === void 0 || Z === !0,
        ie = V.dataReady,
        re = D(x, $);
      if (x.isDepthTexture)
        ((ye = R(x.format === Ui, x.type)),
          ce &&
            (w
        ...
        if (x.isCompressedArrayTexture) {
          ...
          for (let J = 0, q = Re.length; J < q; J++)
            if (((he = Re[J]), x.format !== qt))
              if (ee !== null)
                if (w) {
                  if (ie)
                    if (x.layerUpdates.size > 0) {
                      const fe = Ka(he.width, he.height, x.format, x.type);
        ...
        if (w) {
          if (
            ...
            if (x.layerUpdates.size > 0) {
              const J = Ka($.width, $.height, x.format, x.type);
        ...
        if (ce)
          if (w) t.texStorage2D(i.TEXTURE_2D, re, ye, $.width, $.height);
            ...
            for (let fe = 0; fe < re; fe++)
              (t.texImage2D(i.TEXTURE_2D, fe, ye, J, q, 0, ee, Ae, null),
                (J >>= 1),
                (q >>= 1));
          }
      } else if (Re.length > 0) {
  ...
  function j(b, x, I) {
    ...
    const V = n.get(Z);
    if (Z.version !== V.__version || W === !0) {
      t.activeTexture(i.TEXTURE0 + I);
      const _e = We.getPrimaries(We.workingColorSpace),
        oe = x.colorSpace === Tn ? null : We.getPrimaries(x.colorSpace),
        be =
          x.colorSpace === Tn || _e === oe ? i.NONE : i.BROWSER_DEFAULT_WEBGL;
      (i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL, x.flipY),
        i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL, x.premultiplyAlpha),
        i.pixelStorei(i.UNPACK_ALIGNMENT, x.unpackAlignment),
      ...
      for (let q = 0; q < 6; q++)
        (!xe && !$
          ? (ee[q] = M(x.image[q], !0, r.maxCubemapSize))
          : (ee[q] = $ ? x.image[q].image : x.image[q]),
          (ee[q] = Me(x, ee[q])));
      const Ae = ee[0],
      ...
      if (xe) {
        ...
        if (((J = x.mipmaps), w && ce)) {
          J.length > 0 && re++;
          const q = Pe(ee[0]);
          t.texStorage2D(i.TEXTURE_CUBE_MAP, re, Re, q.width, q.height);
        }
        for (let q = 0; q < 6; q++)
          if ($) {
            w
  ...
  function de(b, x, I, W, Z, V) {
    ...
    if ((($.__renderTarget = x), !xe.__hasExternalTextures)) {
      ...
      Z === i.TEXTURE_3D || Z === i.TEXTURE_2D_ARRAY
        ? t.texImage3D(Z, V, be, ee, Ae, x.depth, 0, _e, oe, null)
        : t.texImage2D(Z, V, be, ee, Ae, 0, _e, oe, null);
    }
    (t.bindFramebuffer(i.FRAMEBUFFER, b),
      me(x)
        ...
        : (Z === i.TEXTURE_2D ||
          ...
          i.framebufferTexture2D(i.FRAMEBUFFER, W, Z, $.__webglTexture, V),
      t.bindFramebuffer(i.FRAMEBUFFER, null));
  }
  function Le(b, x, I) {
    if ((i.bindRenderbuffer(i.RENDERBUFFER, b), x.depthBuffer)) {
      const W = x.depthTexture,
        Z = W && W.isDepthTexture ? W.type : null,
        V = R(x.stencilBuffer, Z),
      ...
      if ((x.__depthDisposeCallback && x.__depthDisposeCallback(), W)) {
        const Z = () => {
          (delete x.__boundDepthTexture,
            ...
            W.removeEventListener("dispose", Z));
        };
        (W.addEventListener("dispose", Z), (x.__depthDisposeCallback = Z));
      }
      ...
      for (let W = 0; W < 6; W++)
        if (
          ...
          (i.bindRenderbuffer(i.RENDERBUFFER, V),
            i.framebufferRenderbuffer(i.FRAMEBUFFER, Z, i.RENDERBUFFER, V));
        }
    } else {
      const W = b.texture.mipmaps;
      if (
        ...
        for (let xe = 0; xe < x.length; xe++) {
          if (
            (b.resolveDepthBuffer &&
              (b.depthBuffer && (Z |= i.DEPTH_BUFFER_BIT),
              b.stencilBuffer &&
          ...
          (i.blitFramebuffer(0, 0, I, W, 0, 0, I, W, Z, i.NEAREST),
            l === !0 &&
              ((A.length = 0),
              (ze.length = 0),
  ...
  function t(n, r = Tn) {
    ...
    if (n === Gs || n === ks || n === Hs)
      if (((s = e.get("EXT_texture_compression_bptc")), s !== null)) {
        ...
        if (n === Hs) return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT;
      } else return null;
    if (n === Ws || n === Xs || n === Ys || n === qs)
...
class Mp {
  ...
  getMesh(e) {
    if (this.texture !== null && this.mesh === null) {
      ...
      this.mesh = new vt(new yr(20, 20), n);
    }
    return this.mesh;
  }
  reset() {
  ...
  constructor(e, t) {
    ...
    ((this.cameraAutoUpdate = !0),
      ...
      (this.getController = function (X) {
        let j = D[X];
        return (
          j === void 0 && ((j = new Jr()), (D[X] = j)),
          j.getTargetRaySpace()
        );
      }),
      (this.getControllerGrip = function (X) {
        let j = D[X];
        return (j === void 0 && ((j = new Jr()), (D[X] = j)), j.getGripSpace());
      }),
      (this.getHand = function (X) {
        let j = D[X];
        return (j === void 0 && ((j = new Jr()), (D[X] = j)), j.getHandSpace());
      }));
    function K(X) {
        ...
        if (((r = X), r !== null)) {
          if (
            ...
            ((d = this.getBinding()),
              ...
              (R = new Xn(f.textureWidth, f.textureHeight, {
                format: qt,
                type: pn,
                depthTexture: new qo(
                  f.textureWidth,
            ...
            ((m = new XRWebGLLayer(r, t, de)),
              ...
              (R = new Xn(m.framebufferWidth, m.framebufferHeight, {
                format: qt,
                type: pn,
                colorSpace: e.outputColorSpace,
                stencilBuffer: T.stencil,
    ...
    function se(X, j, de) {
      ...
      if (
        ...
        const Pe = xt + it,
          ...
          W = ((nt * Fe) / b) * Pe,
          Z = ((A * Fe) / b) * Pe;
        (X.projectionMatrix.makePerspective(x, I, W, Z, Pe, b),
  ...
  function s(p, h) {
    ...
    (E &&
      ...
      E.isCubeTexture &&
        ...
        ((On.y *= -1), (On.z *= -1)),
      p.envMapRotation.value.setFromMatrix4(bp.makeRotationFromEuler(On)),
      (p.flipEnvMap.value =
    ...
    ((p.ior.value = h.ior),
      ...
      h.clearcoat > 0 &&
        ...
        h.clearcoatNormalMap &&
          ...
          h.side === Rt && p.clearcoatNormalScale.value.negate())),
        ...
        if (m(C, y, S, D) === !0) {
          ...
          for (let K = 0; K < G.length; K++) {
            ...
            typeof Y == "number" || typeof Y == "boolean"
              ...
              : Y.isMatrix3
                ? ((C.__data[0] = Y.elements[0]),
                  (C.__data[1] = Y.elements[1]),
                  (C.__data[2] = Y.elements[2]),
                  (C.__data[3] = 0),
                  (C.__data[4] = Y.elements[3]),
                  (C.__data[5] = Y.elements[4]),
                  (C.__data[6] = Y.elements[5]),
                  (C.__data[7] = 0),
                  (C.__data[8] = Y.elements[6]),
                  (C.__data[9] = Y.elements[7]),
                  (C.__data[10] = Y.elements[8]),
                  (C.__data[11] = 0))
                : (Y.toArray(C.__data, H),
...
class wp {
  constructor(e = {}) {
    ...
    const g = new Set([sa, ra, na]),
      M = new Set([pn, Hn, Pi, Di, ea, ta]),
      p = new Uint32Array(4),
      h = new Int32Array(4);
    let T = null,
      E = null;
    ...
    function ie() {
      ((Ve = new Id(A)),
        ...
        (Ae = new Bd(A, et, Pe)),
        (xe = new Ad(Me)),
        (V = new tp(y, b, x, Ve, et, w, xe)),
        (_e = new Ep(y, Me)),
        (oe = new rp()),
        (be = new hp(Ve)),
        (ee = new bd(y, b, x, me, Z, m, l)),
        ($ = new fp(y, Z, et)),
        (ce = new yp(A, it, et, me)),
        (ye = new yd(A, Ve, it)),
        (he = new Fd(A, Ve, it)),
    ...
    ((this.xr = re),
      ...
      (this.dispose = function () {
        (t.removeEventListener("webglcontextlost", J, !1),
          ...
          V.dispose(),
          re.dispose(),
          re.removeEventListener("sessionstart", fa),
          re.removeEventListener("sessionend", pa),
          Pn.stop());
      }));
    function J(_) {
      (_.preventDefault(), Ra("WebGLRenderer: Context Lost."), (P = !0));
    }
    function q() {
      (Ra("WebGLRenderer: Context Restored."), (P = !1));
    ...
    this.renderBufferDirect = function (_, L, N, O, U, Q) {
      ...
      let Ge = we.start * Te,
        qe = (we.start + we.count) * Te;
      (Q !== null &&
        ((Ge = Math.max(Ge, Q.start * Te)),
        (qe = Math.min(qe, (Q.start + Q.count) * Te))),
        ue !== null
          ? ((Ge = Math.max(Ge, 0)), (qe = Math.min(qe, ue.count)))
          : ve != null &&
            ((Ge = Math.max(Ge, 0)), (qe = Math.min(qe, ve.count))));
      const at = qe - Ge;
      ...
      if (U.isBatchedMesh)
        if (U._multiDrawInstances !== null)
          ...
          const Ee = U._multiDrawStarts,
            ...
            Ct = ue ? I.get(ue).bytesPerElement : 1,
            qn = Me.get(O).currentProgram.getUniforms();
          for (let Pt = 0; Pt < He; Pt++)
            (qn.setValue(A, "_gl_DrawID", Pt), $e.render(Ee[Pt] / Ct, rt[Pt]));
        }
    ...
    const Pn = new Zo();
    (Pn.setAnimationLoop(sc),
      typeof self < "u" && Pn.setContext(self),
      (this.setAnimationLoop = function (_) {
        ((kt = _), re.setAnimationLoop(_), _ === null ? Pn.stop() : Pn.start());
      }),
      re.addEventListener("sessionstart", fa),
      re.addEventListener("sessionend", pa),
      (this.render = function (_, L) {
        ...
        if (
          ...
          Q !== null && Rr(Q, L, -1 / 0, y.sortObjects);
        }
        (Rr(_, L, 0, y.sortObjects),
          T.finish(),
        ...
        if ((E.setupLights(), L.isArrayCamera)) {
          ...
          for (let le = 0, pe = Q.length; le < pe; le++) {
            const ue = Q[le];
            ma(T, _, ue, ue.viewport);
          }
        } else
          (U.length > 0 && xa(O, U, _, L), Fe && ee.render(_), ma(T, _, L));
        (v !== null &&
          S === 0 &&
          ...
          D.length > 0
            ? ((E = D[D.length - 1]),
              j === !0 && xe.setGlobalState(y.clippingPlanes, E.state.camera))
            : (E = null),
          R.pop(),
    ...
    function Rr(_, L, N, O) {
      ...
      const Q = _.children;
      for (let le = 0, pe = Q.length; le < pe; le++) Rr(Q[le], L, N, O);
    }
    function ma(_, L, N, O) {
      const { opaque: U, transmissive: Q, transparent: le } = _;
      (E.setupLightsView(N),
        j === !0 && xe.setGlobalState(y.clippingPlanes, N),
        O && me.viewport(G.copy(O)),
        U.length > 0 && zi(U, L, N),
        Q.length > 0 && zi(Q, L, N),
        le.length > 0 && zi(le, L, N),
    ...
    function xa(_, L, N, O) {
      ...
      E.state.transmissionRenderTarget[O.id] === void 0 &&
        (E.state.transmissionRenderTarget[O.id] = new Xn(1, 1, {
          generateMipmaps: !0,
          type:
      ...
      if (
        ...
        E.setupLightsView(O),
        j === !0 && xe.setGlobalState(y.clippingPlanes, O),
        zi(_, N, O),
        ...
        let Ge = !1;
        for (let qe = 0, at = L.length; qe < at; qe++) {
          const ot = L[qe],
    ...
    function zi(_, L, N) {
      ...
      for (let U = 0, Q = _.length; U < Q; U++) {
        ...
        (we.allowOverride === !0 && O !== null && (we = O),
          pe.layers.test(N.layers) && _a(pe, L, N, ue, we, Te));
      }
    }
    function _a(_, L, N, O, U, Q) {
    ...
    function ga(_) {
      if (_.uniformsList === null) {
        ...
        _.uniformsList = pr.seqWithValue(L.seq, _.uniforms);
      }
    ...
    function ac(_, L, N, O, U) {
      ...
      const st = Ct.getUniforms(),
        Et = Ee.uniforms;
      if (
        (me.useProgram(Ct.program) && ((qn = !0), (Pt = !0), (Si = !0)),
        O.id !== C && ((C = O.id), (Pt = !0)),
        qn || B !== _)
      ) {
      ...
      if (
        ((Ft.position !== void 0 ||
          ...
          Ft.color !== void 0) &&
          Ae.update(U, N, Ct),
        (Pt || Ee.receiveShadow !== U.receiveShadow) &&
        ...
        Et.dfgLUT !== void 0 && (Et.dfgLUT.value = Ap()),
        Pt &&
          (st.setValue(A, "toneMappingExposure", y.toneMappingExposure),
          Ee.needsLights && oc(Et, Si),
          ...
          pr.upload(A, ga(Ee), Et, Pe)),
        O.isShaderMaterial &&
          O.uniformsNeedUpdate === !0 &&
          (pr.upload(A, ga(Ee), Et, Pe), (O.uniformsNeedUpdate = !1)),
        ...
        for (let yt = 0, Cr = Mt.length; yt < Cr; yt++) {
          const Dn = Mt[yt];
          (ce.update(Dn, Ct), ce.bind(Dn, Ct));
        }
      }
      return Ct;
    }
      ...
      (this.readRenderTargetPixelsAsync = async function (
        ...
        if ((_.isWebGLCubeRenderTarget && le !== void 0 && (ue = ue[le]), ue))
          if (L >= 0 && L <= _.width - O && N >= 0 && N <= _.height - U) {
            ...
            const qe = v !== null ? Me.get(v).__webglFramebuffer : null;
    ...
    const hc = A.createFramebuffer(),
      uc = A.createFramebuffer();
    ((this.copyTextureToTexture = function (
      ...
      Q === null &&
        (U !== 0
          ? (Ii(
            ...
            (U = 0))
          : (Q = 0));
      let le, pe, ue, Te, we, ve, Ge, qe, at;
      ...
      const He = A.getParameter(A.UNPACK_ROW_LENGTH),
        ...
        qn = A.getParameter(A.UNPACK_SKIP_PIXELS),
      ...
      if (_.isDepthTexture) {
        const Ft = Me.get(_),
          ...
          Cr = Me.get(Mt.__renderTarget);
        (me.bindFramebuffer(A.READ_FRAMEBUFFER, yt.__webglFramebuffer),
          me.bindFramebuffer(A.DRAW_FRAMEBUFFER, Cr.__webglFramebuffer));
        ...
        const Ft = Me.get(_),
          Mt = Me.get(L);
        (me.bindFramebuffer(A.READ_FRAMEBUFFER, hc),
          me.bindFramebuffer(A.DRAW_FRAMEBUFFER, uc));
        for (let yt = 0; yt < ue; yt++)
          (st
            ...
            U !== 0
              ...
              : Et
                ? A.copyTexSubImage3D(rt, Q, Ge, qe, at + yt, Te, we, le, pe)
                : A.copyTexSubImage2D(rt, Q, Ge, qe, Te, we, le, pe));
        (me.bindFramebuffer(A.READ_FRAMEBUFFER, null),
          me.bindFramebuffer(A.DRAW_FRAMEBUFFER, null));
      } else
        Et
          ? _.isDataTexture || _.isData3DTexture
            ? A.texSubImage3D(rt, Q, Ge, qe, at, le, pe, ue, $e, Ee, ot.data)
            : L.isCompressedArrayTexture
              ...
              : A.texSubImage3D(rt, Q, Ge, qe, at, le, pe, ue, $e, Ee, ot)
          : _.isDataTexture
            ? A.texSubImage2D(A.TEXTURE_2D, Q, Ge, qe, le, pe, $e, Ee, ot.data)
            : _.isCompressedTexture
              ...
              : A.texSubImage2D(A.TEXTURE_2D, Q, Ge, qe, le, pe, $e, Ee, ot);
      (A.pixelStorei(A.UNPACK_ROW_LENGTH, He),
        A.pixelStorei(A.UNPACK_IMAGE_HEIGHT, Ct),
        A.pixelStorei(A.UNPACK_SKIP_PIXELS, qn),
...
class Cp extends zl {
  constructor(e, t = null) {
    (super(e, t),
      ...
      (this._lastQuaternion = new Wn()),
      (this._lastTargetPosition = new F()),
      (this._quat = new Wn().setFromUnitVectors(e.up, new F(0, 1, 0))),
      (this._quatInverse = this._quat.clone().invert()),
      (this._spherical = new qa()),
      (this._sphericalDelta = new qa()),
      (this._scale = 1),
      ...
      (this._onPointerUp = Lp.bind(this)),
      (this._onContextMenu = zp.bind(this)),
      (this._onMouseWheel = Np.bind(this)),
      (this._onKeyDown = Fp.bind(this)),
      (this._onTouchStart = Op.bind(this)),
      (this._onTouchMove = Bp.bind(this)),
      (this._onMouseDown = Up.bind(this)),
      (this._onMouseMove = Ip.bind(this)),
      (this._interceptControlDown = Vp.bind(this)),
  ...
  update(e = null) {
    ...
    if (
      ...
      a !== null &&
        (this.screenSpacePanning
          ...
          : (cr.origin.copy(this.object.position),
            cr.direction.set(0, 0, -1).transformDirection(this.object.matrix),
            Math.abs(this.object.up.dot(cr.direction)) < Rp
              ? this.object.lookAt(this.target)
              : (Mo.setFromNormalAndCoplanarPoint(this.object.up, this.target),
                cr.intersectPlane(Mo, this.target))));
    } else if (this.object.isOrthographicCamera) {
    ...
    return (
      ...
      (this._performCursorZoom = !1),
      s ||
      this._lastPosition.distanceToSquared(this.object.position) > ss ||
      8 * (1 - this._lastQuaternion.dot(this.object.quaternion)) > ss ||
      this._lastTargetPosition.distanceToSquared(this.target) > ss
        ? (this.dispatchEvent(vo),
...
function Up(i) {
  ...
  this.state !== Ze.NONE && this.dispatchEvent(ha);
}
function Ip(i) {
  switch (this.state) {
    case Ze.ROTATE:
...
async function tc() {
  const i = await Wp(() => import("./ammo-B9oaJM7s.js").then((t) => t.a), []),
    e = i.default ?? i;
...
const bo = {
  ground_Material: {
    light: new Kt({ color: 15658734 }),
    dark: new Kt({ color: 3552822 }),
  },
  barrier_Material: {
    light: new Kt({ color: 14540253 }),
    dark: new Kt({ color: 1776411 }),
  },
  appTheme: {
    light: {
...
class Xp {
  ...
  onSaveGame;
  async init(e) {
    this.AmmoLib = await tc();
    const { physicsWorld: t } = nc(this.AmmoLib);
  ...
  makeBarrier(e, t, n) {
    const r = { x: 1, y: 0.5, z: 1 },
      ...
      o = Gn(this.AmmoLib, s, a, 0);
    this.physicsWorld.addRigidBody(o.body);
    const l = new Ut(r.x, r.y, r.z),
      c = new vt(l, ln.getAsset("barrier_Material"));
  ...
  handleSceneLeave = async (e) => {
    switch (e.code) {
      case "KeyG":
        this.onSceneLeave?.(new ua());
        break;
    }
  };
  onEnter() {
    (console.log("Inventory: ", _n.getGameStateInventory()),
...
class ua {
  ...
  boxParams = [
    {
      ...
      sizeY: 1,
      sizeZ: 1,
      color: ln.getAsset("barrier_Material"),
      collide: !0,
    },
    {
      posX: 0,
  ...
  async init(e) {
    ...
    const n = 20,
      r = new Ut(n, 1, n),
      s = new vt(r, ln.getAsset("ground_Material"));
    (s.position.set(0, 0, 0), (s.receiveShadow = !0), e.add(s));
    const a = new this.AmmoLib.btVector3(n / 2, 0.5, n / 2),
      o = new this.AmmoLib.btVector3(0, 0, 0),
      l = Gn(this.AmmoLib, a, o, 0);
    (this.physicsWorld.addRigidBody(l.body),
      this.bodies.push({ mesh: s, body: l.body }),
      this.createPlayer(),
      this.boxParams.forEach((c) => {
        this.makeBox(c);
      }),
  ...
  makeBox(e) {
    const t = new this.AmmoLib.btVector3(e.sizeX, e.sizeY, e.sizeZ),
      n = new this.AmmoLib.btVector3(e.posX, e.posY, e.posZ),
      r = Gn(this.AmmoLib, t, n, 0);
    this.physicsWorld.addRigidBody(r.body);
    const s = new Ut(e.sizeX, e.sizeY, e.sizeZ),
      a = new vt(s, e.color);
    (a.position.set(e.posX, e.posY, e.posZ),
      this.scene.add(a),
      e.collide && this.bodies.push({ mesh: a, body: r.body }));
  }
  makeGoal(e, t, n) {
    const r = { x: 1, y: 1, z: 1 },
      s = new this.AmmoLib.btVector3(r.x / 2, r.y / 2, r.z / 2),
  ...
  spawnKey() {
    const e = new Ut(0.3, 0.5, 0.3),
      t = new Kt({ color: 16777044 });
    ((this.key = new vt(e, t)),
  ...
  onClick(e) {
    e.userData.type == "Key" &&
      (this.scene.remove(e), _n.addItem("Key", 1), this.onSaveGame?.());
  }
}
class Gt {
  static language = "en";
...
const Eo = new Bl();
let yo = new Ie(),
  Yp = Gt.getLocalizedString("start_button");
async function da(i) {
  for (gr = !0; li.children.length; ) li.remove(li.children[0]);
  (wt && (wt.onExit(), (wt.onSceneLeave = void 0), (wt.onSaveGame = void 0)),
    (wt = i),
    await wt.init(li),
    (wt.onSceneLeave = (e) => da(e)),
    (wt.onSaveGame = () => $s()),
    (wt.onGameComplete = () => {
      gi && gi.classList.add("visible");
    }),
    wt.onEnter(),
    (gr = !1),
    $s());
}
const wr = new zt(75, window.innerWidth / window.innerHeight, 0.1, 1e3),
  qp = 15;
wr.position.y = qp;
const Bi = new wp();
Bi.setSize(window.innerWidth, window.innerHeight);
document.body.appendChild(Bi.domElement);
const Ni = document.getElementById("start-screen"),
  vr = document.getElementById("start-button"),
  gi = document.getElementById("end-screen"),
  Mr = document.querySelector("#end-screen .end-text"),
  To = document.querySelector("#end-screen .end-gif"),
  Ao = document.getElementById("restart-button"),
  Sr = document.getElementById("language-button");
Ni && Ni.classList.add("visible");
gi && gi.classList.remove("visible");
const Ri = ln.getAsset("appTheme");
ln.subscribe((i) => {
  (document.documentElement.setAttribute("data-theme", i),
    Ni && (Ni.style.backgroundImage = `url(${Ri.startBgSrc})`),
    To && (To.src = Ri.endGifSrc),
    gi && (gi.style.backgroundColor = Ri.endBackground),
    Mr && (Mr.style.color = Ri.endTextColor),
    Bi.setClearColor(Ri.clearColor, 1));
});
function ic() {
  (vr && (vr.textContent = Gt.getText("start_button")),
    Sr && (Sr.textContent = Gt.getText("language_button")),
    Mr && (Mr.textContent = Gt.getText("end_text")),
    Ao && (Ao.textContent = Gt.getText("restart_button")));
}
const as = ["en", "jp", "ar"];
Sr &&
  Sr.addEventListener("click", () => {
    const i = Gt.getLanguage(),
      e = as.indexOf(i),
      t = as[(e + 1) % as.length];
    Gt.setLanguage(t);
  });
vr &&
  vr.addEventListener("click", async () => {
    gr || (Ni?.classList.remove("visible"), await da(new ua()));
  });
const Kp = new Cp(wr, Bi.domElement),
  Zp = new Ol();
window.addEventListener("keydown", (i) => {
  i.code === "KeyI" && (_n.addItem("test_item", 1), $s());
});
window.addEventListener("keydown", (i) => {
  let e = !1;
  (i.code === "KeyB"
    ? (Gt.setLanguage("en"), (e = !0))
    : i.code === "KeyN"
      ? (Gt.setLanguage("jp"), (e = !0))
      : i.code == "KeyM" && (Gt.setLanguage("ar"), (e = !0)),
    e && console.log("Language changed, new value: ", Yp()));
});
window.addEventListener("keydown", (i) => {
  i.code === "KeyL" && $p();
});
window.addEventListener("click", (i) => {
  ((yo = new Ie(
    ...
    Eo.setFromCamera(yo, wr));
  const e = Eo.intersectObjects(li.children);
...
function rc() {
  ...
  const i = Zp.getDelta();
  (Kp.update(), wt && !gr && wt.update(i), Bi.render(li, wr));
}
rc();
function $s() {
  const i = { inventory: _n.getGameStateInventory() };
  (localStorage.setItem("gameSave", JSON.stringify(i)),
    console.log("Game saved with inventory: ", _n.getGameStateInventory()));
}
function jp() {
  const i = localStorage.getItem("gameSave");
  if (!i) return;
  const e = JSON.parse(i);
  (_n.setGameStateInventory(e.inventory),
    console.log("Loaded game with inventory: ", _n.getGameStateInventory()));
}
function $p() {
  (localStorage.removeItem("gameSave"),
    _n.setGameStateInventory({}),
