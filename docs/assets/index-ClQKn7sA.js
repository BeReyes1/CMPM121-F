...
function Qc() {
  const i = {
        ...
        return (
          this.enabled === !1 ||
            ...
            (this.spaces[s].transfer === Ke &&
              ((r.r = un(r.r)), (r.g = un(r.g)), (r.b = un(r.b))),
            ...
            this.spaces[a].transfer === Ke &&
              ((r.r = hi(r.r)), (r.g = hi(r.g)), (r.b = hi(r.b)))),
          r
        );
      },
      ...
      getTransfer: function (r) {
        return r === En ? dr : this.spaces[r].transfer;
      },
...
class il extends Wn {
  ...
  copy(e) {
    ...
    for (let t = 0, n = e.textures.length; t < n; t++) {
      ...
      this.textures[t].source = new ta(r);
    }
    return (
...
class Ii {
  ...
  intersectsTriangle(e) {
    ...
    (this.getCenter(Si),
      Vi.subVectors(this.max, Si),
      Kn.subVectors(e.a, Si),
      jn.subVectors(e.b, Si),
      Zn.subVectors(e.c, Si),
      xn.subVectors(jn, Kn),
      _n.subVectors(Zn, jn),
      Pn.subVectors(Kn, Zn));
    let t = [
    ...
    return !Dr(t, Kn, jn, Zn, Vi) ||
      ((t = [1, 0, 0, 0, 1, 0, 0, 0, 1]), !Dr(t, Kn, jn, Zn, Vi))
      ? !1
      : (Gi.crossVectors(xn, _n),
        (t = [Gi.x, Gi.y, Gi.z]),
        Dr(t, Kn, jn, Zn, Vi));
  }
  clampPoint(e, t) {
...
function Dr(i, e, t, n, r) {
  for (let s = 0, a = i.length - 3; s <= a; s += 3) {
    Dn.fromArray(i, s);
    const o =
        r.x * Math.abs(Dn.x) + r.y * Math.abs(Dn.y) + r.z * Math.abs(Dn.z),
      l = e.dot(Dn),
      c = t.dot(Dn),
      u = n.dot(Dn);
      ...
      : this.isEmpty()
        ...
        : (this.center.equals(e.center) === !0
            ...
            : (Lr.subVectors(e.center, this.center).setLength(e.radius),
              this.expandByPoint(bi.copy(e.center).add(Lr)),
              this.expandByPoint(bi.copy(e.center).sub(Lr))),
          this);
  }
  equals(e) {
...
class ia {
  ...
  distanceSqToSegment(e, t, n, r) {
    ...
    return (
      ...
      r && r.copy(Ur).addScaledVector(ki, f),
      m
    );
  }
  intersectSphere(e, t) {
  ...
  intersectTriangle(e, t, n, r, s) {
    (Ir.subVectors(t, e), Hi.subVectors(n, e), Nr.crossVectors(Ir, Hi));
    ...
    const l = o * this.direction.dot(Hi.crossVectors(gn, Hi));
    if (l < 0) return null;
    const c = o * this.direction.dot(Ir.cross(gn));
...
class ut {
  ...
  extractRotation(e) {
    const t = this.elements,
      n = e.elements,
      r = 1 / $n.setFromMatrixColumn(e, 0).length(),
  ...
  lookAt(e, t, n) {
    ...
    return (
      ...
      Pt.normalize(),
      vn.crossVectors(n, Pt),
      vn.lengthSq() === 0 &&
        (Math.abs(n.z) === 1 ? (Pt.x += 1e-4) : (Pt.z += 1e-4),
        Pt.normalize(),
        vn.crossVectors(n, Pt)),
      vn.normalize(),
      Wi.crossVectors(Pt, vn),
      (r[0] = vn.x),
      (r[4] = Wi.x),
      (r[8] = Pt.x),
      (r[1] = vn.y),
  ...
  makePerspective(e, t, n, r, s, a, o = $t, l = !1) {
    ...
    else if (o === fr) ((g = -a / (a - s)), (M = (-a * s) / (a - s)));
    else
      throw new Error(
...
class fn {
  ...
  setFromQuaternion(e, t, n) {
    return (
      wa.makeRotationFromQuaternion(e),
      this.setFromRotationMatrix(wa, t, n)
    );
  }
...
const Ca = new F(),
  ...
  Fr = { type: "childremoved", child: null };
class Nt extends Wn {
  constructor() {
    (super(),
      (this.isObject3D = !0),
  ...
  lookAt(e, t, n) {
    ...
    (this.updateWorldMatrix(!0, !1),
      ...
      this.isCamera || this.isLight
        ? tn.lookAt(Ei, Xi, this.up)
        : tn.lookAt(Xi, Ei, this.up),
      this.quaternion.setFromRotationMatrix(tn),
      r &&
        (tn.extractRotation(r.matrixWorld),
        Jn.setFromRotationMatrix(tn),
  ...
  getWorldQuaternion(e) {
    return (
      this.updateWorldMatrix(!0, !1),
      this.matrixWorld.decompose(Ei, e, ll),
      e
    );
  }
  getWorldScale(e) {
    return (
      this.updateWorldMatrix(!0, !1),
      this.matrixWorld.decompose(Ei, hl, e),
      e
    );
  }
  getWorldDirection(e) {
...
class qt {
  ...
  static getBarycoord(e, t, n, r, s) {
    (Xt.subVectors(r, t), nn.subVectors(n, t), Or.subVectors(e, t));
    const a = Xt.dot(Xt),
      o = Xt.dot(nn),
      l = Xt.dot(Or),
      c = nn.dot(nn),
  ...
  static containsPoint(e, t, n, r) {
    return this.getBarycoord(e, t, n, r, rn) === null
      ? !1
  ...
  static getInterpolation(e, t, n, r, s, a, o, l) {
    return this.getBarycoord(e, t, n, r, rn) === null
      ? ((l.x = 0),
        ...
        null)
      : (l.setScalar(0),
        l.addScaledVector(s, rn.x),
        l.addScaledVector(a, rn.y),
        l.addScaledVector(o, rn.z),
        l);
  }
  static getInterpolatedAttribute(e, t, n, r, s, a) {
    return (
      ...
      Hr.fromBufferAttribute(e, r),
      a.setScalar(0),
      a.addScaledVector(Gr, s.x),
      a.addScaledVector(kr, s.y),
      a.addScaledVector(Hr, s.z),
      a
    );
  }
  static isFrontFacing(e, t, n, r) {
    return (Xt.subVectors(n, t), nn.subVectors(e, t), Xt.cross(nn).dot(r) < 0);
  }
  set(e, t, n) {
  ...
  closestPointToPoint(e, t) {
    const n = this.a,
      ...
      s = this.c;
    let a, o;
    (ei.subVectors(r, n), ti.subVectors(s, n), Br.subVectors(e, n));
    const l = ei.dot(Br),
      c = ti.dot(Br);
    ...
    const f = l * d - u * c;
    if (f <= 0 && l >= 0 && u <= 0)
      return ((a = l / (l - u)), t.copy(n).addScaledVector(ei, a));
    Vr.subVectors(e, s);
    const m = ei.dot(Vr),
      g = ti.dot(Vr);
...
class Ze {
  ...
  setHSL(e, t, n, r = We.workingColorSpace) {
    if (((e = $c(e, 1)), (t = Oe(t, 0, 1)), (n = Oe(n, 0, 1)), t === 0))
  ...
  lerpHSL(e, t) {
    (this.getHSL(Mn), e.getHSL(qi));
    const n = Ar(Mn.h, qi.h, t),
      r = Ar(Mn.s, qi.s, t),
      s = Ar(Mn.l, qi.l, t);
...
class gr extends Wn {
  ...
  toJSON(e) {
    ...
    ((n.uuid = this.uuid),
      ...
      this.side !== An && (n.side = this.side),
      this.vertexColors === !0 && (n.vertexColors = !0),
      this.opacity < 1 && (n.opacity = this.opacity),
      this.transparent === !0 && (n.transparent = !0),
      this.blendSrc !== ts && (n.blendSrc = this.blendSrc),
      this.blendDst !== ns && (n.blendDst = this.blendDst),
      ...
      this.depthFunc !== ui && (n.depthFunc = this.depthFunc),
...
class Jt {
  ...
  toJSON() {
    ...
    return (
      ...
      this.usage !== Ma && (e.usage = this.usage),
      e
    );
  }
}
...
class wn extends Wn {
  ...
  center() {
    return (
      ...
      this.boundingBox.getCenter(ni).negate(),
      this.translate(ni.x, ni.y, ni.z),
      this
    );
  }
  setFromPoints(e) {
    ...
    if (t === void 0) {
      ...
      this.setAttribute("position", new Vn(n, 3));
    } else {
      ...
      if ((Dt.setFromBufferAttribute(e), t))
        for (let s = 0, a = t.length; s < a; s++) {
          ...
          (yi.setFromBufferAttribute(o),
            this.morphTargetsRelative
              ? (mt.addVectors(Dt.min, yi.min),
                Dt.expandByPoint(mt),
                mt.addVectors(Dt.max, yi.max),
                Dt.expandByPoint(mt))
              : (Dt.expandByPoint(yi.min), Dt.expandByPoint(yi.max)));
        }
      Dt.getCenter(n);
      let r = 0;
        ...
        for (let s = 0, a = t.length; s < a; s++) {
          ...
          for (let c = 0, u = o.count; c < u; c++)
            (mt.fromBufferAttribute(o, c),
              l && (ni.fromBufferAttribute(e, c), mt.add(ni)),
              (r = Math.max(r, n.distanceToSquared(mt))));
        }
...
class vt extends Nt {
    ...
    if (s && o) {
      ...
      for (let l = 0, c = s.length; l < c; l++) {
        const u = o[l],
          d = s[l];
        u !== 0 &&
          (qr.fromBufferAttribute(d, e),
          a ? Ji.addScaledVector(qr, u) : Ji.addScaledVector(qr.sub(t), u));
      }
      t.add(Ji);
    }
    return t;
  ...
  raycast(e, t) {
    ...
    r !== void 0 &&
      ...
      !(
        Ki.containsPoint(Ln.origin) === !1 &&
        (Ln.intersectSphere(Ki, Fa) === null ||
          Ln.origin.distanceToSquared(Fa) > (e.far - e.near) ** 2)
      ) &&
        (Na.copy(s).invert(),
        Ln.copy(e.ray).applyMatrix4(Na),
...
function ml(i, e, t, n, r, s, a, o) {
  let l;
  if (
    (e.side === wt
      ? (l = n.intersectTriangle(a, s, r, !0, o))
      : (l = n.intersectTriangle(r, s, a, e.side === An, o)),
    l === null)
  )
    return null;
...
function er(i, e, t, n, r, s, a, o, l, c) {
  (i.getVertexPosition(o, ji),
    i.getVertexPosition(l, Zi),
    i.getVertexPosition(c, $i));
  const u = ml(i, e, t, n, ji, Zi, $i, Oa);
  if (u) {
    const d = new F();
    (qt.getBarycoord(Oa, ji, Zi, $i, d),
      r && (u.uv = qt.getInterpolatedAttribute(r, o, l, c, d, new Ie())),
      s && (u.uv1 = qt.getInterpolatedAttribute(s, o, l, c, d, new Ie())),
      a &&
        ((u.normal = qt.getInterpolatedAttribute(a, o, l, c, d, new F())),
        u.normal.dot(n.direction) > 0 && u.normal.multiplyScalar(-1)));
    const f = { a: o, b: l, c, normal: new F(), materialIndex: 0 };
    (qt.getNormal(ji, Zi, $i, f.normal), (u.face = f), (u.barycoord = d));
  }
  return u;
}
class Ut extends wn {
...
class pn extends gr {
  ...
  copy(e) {
    return (
      ...
      (this.uniformsGroups = xl(e.uniformsGroups)),
...
class zt extends Vo {
  ...
  getEffectiveFOV() {
    return ks * 2 * Math.atan(Math.tan(hr * 0.5 * this.fov) / this.zoom);
  }
  getFilmWidth() {
  ...
  getViewBounds(e, t, n) {
    (Sn.set(-1, -1, 0.5).applyMatrix4(this.projectionMatrixInverse),
      t.set(Sn.x, Sn.y).multiplyScalar(-e / Sn.z),
      Sn.set(1, 1, 0.5).applyMatrix4(this.projectionMatrixInverse),
      n.set(Sn.x, Sn.y).multiplyScalar(-e / Sn.z));
  }
  getViewSize(e, t) {
...
class Ml extends Nt {
  constructor(e, t, n) {
    ...
    const r = new zt(ii, ri, e, t);
    ((r.layers = this.layers), this.add(r));
    const s = new zt(ii, ri, e, t);
    ((s.layers = this.layers), this.add(s));
    const a = new zt(ii, ri, e, t);
    ((a.layers = this.layers), this.add(a));
    const o = new zt(ii, ri, e, t);
    ((o.layers = this.layers), this.add(o));
    const l = new zt(ii, ri, e, t);
    ((l.layers = this.layers), this.add(l));
    const c = new zt(ii, ri, e, t);
...
class Go extends bt {
  constructor(e = [], t = di, n, r, s, a, o, l, c, u) {
...
class Sl extends Hn {
  ...
  fromEquirectangularTexture(e, t) {
    ...
    const a = new vt(r, s),
      o = t.minFilter;
    return (
      t.minFilter === Bn && (t.minFilter = Vt),
      new Ml(1, 10, this).update(e, a),
      (t.minFilter = o),
      a.geometry.dispose(),
      a.material.dispose(),
      this
...
class yl extends bt {
  constructor(e = null, t = 1, n = 1, r, s, a, o, l, c = It, u = It, d, f) {
...
class bn {
  ...
  setFromCoplanarPoints(e, t, n) {
    const r = Kr.subVectors(n, t).cross(Tl.subVectors(e, t)).normalize();
  ...
  applyMatrix4(e, t) {
    const n = t || Al.getNormalMatrix(e),
...
class ko {
  ...
  setFromProjectionMatrix(e, t = $t, n = !1) {
    ...
    if (
      ...
      (r[4].setComponents(c - l, m - f, h - p, D - R).normalize(), t === $t)
    )
      r[5].setComponents(c + l, m + f, h + p, D + R).normalize();
    else if (t === fr) r[5].setComponents(l, f, p, R).normalize();
    else
      throw new Error(
  ...
  intersectsSprite(e) {
    Un.center.set(0, 0, 0);
    const t = wl.distanceTo(e.center);
    return (
      (Un.radius = 0.7071067811865476 + t),
  ...
  intersectsBox(e) {
    ...
    for (let n = 0; n < 6; n++) {
      const r = t[n];
      if (
        ((nr.x = r.normal.x > 0 ? e.max.x : e.min.x),
...
class Ho extends bt {
  constructor(e, t, n = Gn, r, s, a, o = It, l = It, c, u = Pi, d = 1) {
    if (u !== Pi && u !== Di)
      throw new Error(
  ...
  copy(e) {
    return (
      super.copy(e),
      (this.source = new ta(Object.assign({}, e.image))),
...
class Ul {
  ...
  intersectObject(e, t = !0, n = []) {
    return (Hs(e, this, n, t), n.sort(Ga), n);
  }
  intersectObjects(e, t = !0, n = []) {
    for (let r = 0, s = e.length; r < s; r++) Hs(e[r], this, n, t);
    return (n.sort(Ga), n);
  }
}
function Ga(i, e) {
...
function Hs(i, e, t, n) {
  ...
  if (
    ...
    const s = i.children;
    for (let a = 0, o = s.length; a < o; a++) Hs(s[a], e, t, !0);
  }
}
class ka {
...
#endif`,
  ah = `#define PI 3.141592653589793
...
#endif`,
  ch = `vec3 transformedNormal = objectNormal;
#ifdef USE_TANGENT
...
#endif`,
  Ah = `LambertMaterial material;
material.diffuseColor = diffuseColor.rgb;
material.specularStrength = specularStrength;`,
  wh = `varying vec3 vViewPosition;
...
#define RE_IndirectDiffuse		RE_IndirectDiffuse_Toon`,
  Lh = `BlinnPhongMaterial material;
material.diffuseColor = diffuseColor.rgb;
...
IncidentLight directLight;
...
#endif`,
  zh = `#if defined( USE_LOGARITHMIC_DEPTH_BUFFER )
	gl_FragDepth = vIsPerspective == 0.0 ? gl_FragCoord.z : log2( vFragDepth ) * logDepthBufFC * 0.5;
#endif`,
  Vh = `#if defined( USE_LOGARITHMIC_DEPTH_BUFFER )
	uniform float logDepthBufFC;
	varying float vFragDepth;
	varying float vIsPerspective;
#endif`,
  Gh = `#ifdef USE_LOGARITHMIC_DEPTH_BUFFER
	varying float vFragDepth;
	varying float vIsPerspective;
#endif`,
...
#endif`,
  Xh = `#if defined( USE_MAP ) || defined( USE_ALPHAMAP )
  ...
  qh = `#if defined( USE_POINTS_UV )
	...
	uniform sampler2D alphaMap;
#endif`,
  Yh = `float metalnessFactor = metalness;
#ifdef USE_METALNESSMAP
	vec4 texelMetalness = texture2D( metalnessMap, vMetalnessMapUv );
	metalnessFactor *= texelMetalness.b;
#endif`,
  Kh = `#ifdef USE_METALNESSMAP
	uniform sampler2D metalnessMap;
#endif`,
  jh = `#ifdef USE_INSTANCING_MORPH
...
#endif`,
  $h = `#ifdef USE_MORPHNORMALS
	objectNormal *= morphTargetBaseInfluence;
	for ( int i = 0; i < MORPHTARGETS_COUNT; i ++ ) {
		if ( morphTargetInfluences[ i ] != 0.0 ) objectNormal += getMorph( gl_VertexID, i, 1 ).xyz * morphTargetInfluences[ i ];
	}
#endif`,
  Jh = `#ifdef USE_MORPHTARGETS
...
gl_FragColor = vec4( outgoingLight, diffuseColor.a );`,
  uu = `vec3 packNormalToRGB( const in vec3 normal ) {
...
vec3 CustomToneMapping( vec3 color ) { return color; }`,
...
#endif`,
  Lu = `#if defined( USE_UV ) || defined( USE_ANISOTROPY )
	varying vec2 vUv;
#endif
#ifdef USE_MAP
	varying vec2 vMapUv;
  ...
  Uu = `#if defined( USE_UV ) || defined( USE_ANISOTROPY )
	...
	varying vec2 vThicknessMapUv;
#endif`,
  Iu = `#if defined( USE_UV ) || defined( USE_ANISOTROPY )
	vUv = vec3( uv, 1 ).xy;
#endif
#ifdef USE_MAP
...
#endif`,
  Nu = `#if defined( USE_ENVMAP ) || defined( DISTANCE ) || defined ( USE_SHADOWMAP ) || defined ( USE_TRANSMISSION ) || NUM_SPOT_LIGHT_COORDS > 0
...
function _d(i, e, t, n, r, s, a) {
  ...
  function p(E, R) {
    const D = g(R);
    D && (D.isCubeTexture || D.mapping === _r)
      ? (u === void 0 &&
          ((u = new vt(
            new Ut(1, 1, 1),
            new pn({
              name: "BackgroundCubeMaterial",
              uniforms: mi(Zt.backgroundCube.uniforms),
        ...
        (c === void 0 &&
          ((c = new vt(
            ...
            new pn({
              ...
              uniforms: mi(Zt.background.uniforms),
  ...
  function h(E, R) {
    (E.getRGB(ir, zo(i)), n.buffers.color.setClear(ir.r, ir.g, ir.b, R, a));
  }
  function T() {
      ...
      if (k.location >= 0) {
        ...
        if (
          ...
          const Xe = ke.buffer,
            ...
            X = Je === i.INT || Je === i.UNSIGNED_INT || te.gpuType === Ks;
...
function bd(i) {
  let e = new WeakMap();
  function t(a, o) {
    return (o === hs ? (a.mapping = di) : o === us && (a.mapping = fi), a);
  }
  function n(a) {
    if (a && a.isTexture) {
      const o = a.mapping;
...
class qa {
  ...
  _cleanup(e) {
    (this._renderer.setRenderTarget(jr, Zr, $r),
      (this._renderer.xr.enabled = Jr),
      (e.scissorTest = !1),
      si(e, 0, 0, e.width, e.height));
  }
  _fromTexture(e, t) {
    (e.mapping === di || e.mapping === fi
      ? this._setSize(
          e.image.length === 0
            ? 16
  ...
  _allocateTargets() {
    ...
    if (
      ...
      (({
        ...
        (this._blurMaterial = wd(s, e, t)));
    }
    return r;
  }
  _compileMaterial(e) {
    const t = new vt(new wn(), e);
  ...
  _textureToCubeUV(e, t) {
    ...
    (si(t, 0, 0, 3 * l, 2 * l), n.setRenderTarget(t), n.render(a, Ti));
  }
  _applyPMREM(e) {
  ...
  _applyGGXFilter(e, t, n) {
    ...
    if (this._ggxMaterial === null) {
      const T = 3 * Math.max(this._cubeSize, 16),
        E = 4 * this._cubeSize;
      this._ggxMaterial = Ad(this._lodMax, T, E);
    }
  ...
  _halfBlur(e, t, n, r, s, a, o) {
    ...
    const f = c.uniforms,
      ...
      g = isFinite(s) ? Math.PI / (2 * m) : (2 * Math.PI) / (2 * On - 1),
      M = s / g,
      p = isFinite(s) ? 1 + Math.floor(u * M) : On;
    p > On &&
      De(
        `sigmaRadians, ${s}, is too large and will clip, as it requested ${p} samples when the maximum is set to ${On}`,
      );
    const h = [];
    let T = 0;
    for (let P = 0; P < On; ++P) {
    ...
    const R = this._sizeLods[r],
      D = 3 * R * (r > E - yn ? r - E + yn : 0),
      y = 4 * (this._cubeSize - R);
    (si(t, D, y, 3 * R, 2 * R), l.setRenderTarget(t), l.render(d, Ti));
  }
}
function Td(i) {
  const e = [],
    ...
    n = [];
  let r = i;
  const s = i - yn + 1 + Wa.length;
  for (let a = 0; a < s; a++) {
    const o = Math.pow(2, r);
    e.push(o);
    let l = 1 / o;
    (a > i - yn ? (l = Wa[a - i + yn - 1]) : a === 0 && (l = 0), t.push(l));
    const c = 1 / (o - 2),
      u = -c,
      d = 1 + c,
    ...
    const D = new wn();
    (D.setAttribute("position", new Jt(T, M)),
      D.setAttribute("uv", new Jt(E, p)),
      D.setAttribute("faceIndex", new Jt(R, h)),
...
function Cd(i) {
  ...
  return {
    ...
    get: function (n) {
      const r = t(n);
      return (
        r === null && Li("WebGLRenderer: " + n + " extension not supported."),
        r
      );
    },
  };
...
function zd(i, e) {
  ...
  if (n === void 0) {
    ...
    if (ft(t, n)) return;
    (to.set(n), i.uniformMatrix2fv(this.addr, !1, to), pt(t, n));
  }
}
function Vd(i, e) {
  const t = this.cache,
  ...
  if (n === void 0) {
    ...
    if (ft(t, n)) return;
    (eo.set(n), i.uniformMatrix3fv(this.addr, !1, eo), pt(t, n));
  }
}
function Gd(i, e) {
  const t = this.cache,
  ...
  if (n === void 0) {
    ...
    if (ft(t, n)) return;
    (Qa.set(n), i.uniformMatrix4fv(this.addr, !1, Qa), pt(t, n));
  }
}
function kd(i, e) {
  const t = this.cache;
...
function vf(i, e, t) {
  const n = this.cache,
    ...
    s = Sr(t, r);
  ft(n, s) || (i.uniform1iv(this.addr, s), pt(n, s));
  for (let a = 0; a !== r; ++a) t.setTextureCube(e[a] || jo, s[a]);
}
function Mf(i, e, t) {
  const n = this.cache,
    r = e.length,
...
function Tf(i, e, t) {
  ...
  for (Qr.lastIndex = 0; ; ) {
    ...
    if ((l && (o = o | 0), c === void 0 || (c === "[" && a + 2 === r))) {
      no(t, c === void 0 ? new bf(o, i, e) : new Ef(o, i, e));
      break;
    } else {
      let d = t.map[o];
      (d === void 0 && ((d = new yf(o)), no(t, d)), (t = d));
    }
  }
}
class ur {
...
const ro = new Ue();
function Cf(i) {
  We._getMatrix(ro, We.workingColorSpace, i);
...
const rr = new F();
function Lf() {
  We.getLuminanceCoefficients(rr);
  const i = rr.x.toFixed(4),
    e = rr.y.toFixed(4),
    t = rr.z.toFixed(4);
  return [
...
`)),
      (h = [
        ...
        t.toneMapping !== Tn ? Ne.tonemapping_pars_fragment : "",
        t.toneMapping !== Tn ? Df("toneMapping", t.toneMapping) : "",
...
` +
  ...
  const E = T + p + a,
    R = T + h + o,
    D = io(r, r.VERTEX_SHADER, E),
    y = io(r, r.FRAGMENT_SHADER, R);
  (r.attachShader(M, D),
    r.attachShader(M, y),
...
` +
    ...
    (r.deleteShader(D), r.deleteShader(y), (z = new ur(r, M)), (S = Nf(r, M)));
  }
  let z;
  ...
  return (
    (this.isReady = function () {
      return (v === !1 && (v = r.getProgramParameter(M, Af)), v);
    }),
...
function Zf(i, e, t, n, r, s, a) {
  ...
  function p(S, v, C, B, G) {
    const H = B.fog,
      ...
      k = ne && ne.mapping === _r ? ne.image.height : null,
      te = g[S.type];
    S.precision !== null &&
    ...
    const tt = {
      ...
      emissiveMap: me,
      normalMapObjectSpace: Ve && S.normalMapType === Gc,
      normalMapTangentSpace: Ve && S.normalMapType === Vc,
      metalnessMap: it,
      roughnessMap: Me,
      anisotropy: Pe,
      anisotropyMap: V,
      ...
      gradientMap: ie,
      opaque:
        S.transparent === !1 && S.blending === li && S.alphaToCoverage === !1,
      alphaMap: re,
      alphaTest: J,
      alphaHash: Y,
      combine: S.combine,
...
function uo() {
  ...
  function c(d, f) {
    (t.length > 1 && t.sort(d || Jf),
      n.length > 1 && n.sort(f || ho),
      r.length > 1 && r.sort(f || ho));
  }
  function u() {
...
function cp(i, e, t) {
  ...
  this.render = function (y, P, z) {
    ...
    for (let K = 0, q = y.length; K < q; K++) {
      ...
      if (
        ...
        const Se = this.type !== an ? { minFilter: It, magFilter: It } : {};
        (k.map !== null && k.map.dispose(),
          (k.map = new Hn(r.x, r.y, Se)),
      ...
      (k.isPointLightShadow !== !0 && this.type === an && T(k, z),
        (k.needsUpdate = !1));
    }
  ...
  function T(y, P) {
    ...
    (f.defines.VSM_SAMPLES !== y.blurSamples &&
      ...
      (f.needsUpdate = !0),
      (m.needsUpdate = !0)),
      y.mapPass === null && (y.mapPass = new Hn(r.x, r.y)),
  ...
  function R(y, P, z, S, v) {
    ...
    if (
      ...
      (y.castShadow || (y.receiveShadow && v === an)) &&
...
function hp(i, e) {
  ...
  function r() {
    ...
    return {
      ...
      setFunc: function (qe, Kt, kt) {
        (ie !== qe || re !== Kt || J !== kt) &&
          (i.stencilFunc(qe, Kt, kt), (ie = qe), (re = Kt), (J = kt));
      },
      setOp: function (qe, Kt, kt) {
        (Y !== qe || fe !== Kt || Ce !== kt) &&
          (i.stencilOp(qe, Kt, kt), (Y = qe), (fe = Kt), (Ce = kt));
      },
  ...
  const xt = {
    [Fn]: i.FUNC_ADD,
    [uc]: i.FUNC_SUBTRACT,
    [dc]: i.FUNC_REVERSE_SUBTRACT,
  };
  ((xt[fc] = i.MIN), (xt[pc] = i.MAX));
  const Fe = {
    [mc]: i.ZERO,
    [xc]: i.ONE,
    [_c]: i.SRC_COLOR,
    [ts]: i.SRC_ALPHA,
    [Ec]: i.SRC_ALPHA_SATURATE,
    [Sc]: i.DST_COLOR,
    [vc]: i.DST_ALPHA,
    [gc]: i.ONE_MINUS_SRC_COLOR,
    [ns]: i.ONE_MINUS_SRC_ALPHA,
    [bc]: i.ONE_MINUS_DST_COLOR,
    [Mc]: i.ONE_MINUS_DST_ALPHA,
    [yc]: i.CONSTANT_COLOR,
    [Tc]: i.ONE_MINUS_CONSTANT_COLOR,
    [Ac]: i.CONSTANT_ALPHA,
  ...
  function nt(w, ce, ie, re, J, Y, fe, Ce, tt, qe) {
    ...
    if ((M === !1 && (Z(i.BLEND), (M = !0)), w !== hc)) {
      if (w !== p || qe !== S) {
        if (
          ((h !== Fn || R !== Fn) &&
            (i.blendEquation(i.FUNC_ADD), (h = Fn), (R = Fn)),
          qe)
        )
          switch (w) {
            case li:
  ...
  function A(w, ce) {
    w.side === on ? de(i.CULL_FACE) : Z(i.CULL_FACE);
    let ie = w.side === wt;
    (ce && (ie = !ie),
      ze(ie),
      w.blending === li && w.transparent === !1
        ? nt(hn)
        : nt(
            w.blending,
            w.blendEquation,
...
function up(i, e, t, n, r, s, a) {
  ...
  function g(b, x) {
    return m ? new OffscreenCanvas(b, x) : pr("canvas");
  }
  function M(b, x, I) {
    let W = 1;
    const j = Pe(b);
  ...
  function E(b, x, I, W, j = !1) {
    ...
    if (
      ...
      const _e = j ? dr : We.getTransfer(W);
      ...
      b
        ...
        : x === null || x === Gn || x === Ci
          ...
          : x === ln
            ...
            : x === Ri && (I = i.DEPTH_COMPONENT16),
      I
    );
  }
  function D(b, x) {
    return p(b) === !0 ||
      (b.isFramebufferTexture && b.minFilter !== It && b.minFilter !== Vt)
  ...
  const te = { [ds]: i.REPEAT, [cn]: i.CLAMP_TO_EDGE, [fs]: i.MIRRORED_REPEAT },
    se = {
      [It]: i.NEAREST,
      [Oc]: i.NEAREST_MIPMAP_NEAREST,
      [Bi]: i.NEAREST_MIPMAP_LINEAR,
      [Vt]: i.LINEAR,
  ...
  function ke(b, x) {
    if (
      ...
      if (
        x.magFilter === It ||
        (x.minFilter !== Bi && x.minFilter !== Bn) ||
        (x.type === ln && e.has("OES_texture_float_linear") === !1)
      )
        return;
  ...
  function X(b, x, I) {
    ...
    if (V.version !== _e.__version || j === !0) {
      ...
      const oe = We.getPrimaries(We.workingColorSpace),
        be = x.colorSpace === En ? null : We.getPrimaries(x.colorSpace),
        xe =
          x.colorSpace === En || oe === be ? i.NONE : i.BROWSER_DEFAULT_WEBGL;
      ...
      if (x.isDepthTexture)
        ...
        if (x.isCompressedArrayTexture) {
          ...
          for (let J = 0, Y = Re.length; J < Y; J++)
            if (((he = Re[J]), x.format !== Yt))
              if (ee !== null)
                if (w) {
                  if (ie)
                    if (x.layerUpdates.size > 0) {
                      const fe = Ha(he.width, he.height, x.format, x.type);
        ...
        if (w) {
          if (
            ...
            if (x.layerUpdates.size > 0) {
              const J = Ha($.width, $.height, x.format, x.type);
  ...
  function Z(b, x, I) {
    ...
    if (j.version !== V.__version || W === !0) {
      ...
      const _e = We.getPrimaries(We.workingColorSpace),
        oe = x.colorSpace === En ? null : We.getPrimaries(x.colorSpace),
        be =
          x.colorSpace === En || _e === oe ? i.NONE : i.BROWSER_DEFAULT_WEBGL;
      (i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL, x.flipY),
        i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL, x.premultiplyAlpha),
        i.pixelStorei(i.UNPACK_ALIGNMENT, x.unpackAlignment),
  ...
  function ge(b, x) {
    ...
    else if (x.depthTexture.format === Di)
      me(x)
        ? o.framebufferTexture2DMultisampleEXT(
            i.FRAMEBUFFER,
  ...
  function t(n, r = En) {
    ...
    if (n === ps || n === ms || n === xs || n === _s)
      if (((s = e.get("WEBGL_compressed_texture_pvrtc")), s !== null)) {
        ...
        if (n === _s) return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG;
      } else return null;
    if (n === gs || n === vs || n === Ms)
    ...
    if (n === Ns || n === Fs || n === Os)
      if (((s = e.get("EXT_texture_compression_bptc")), s !== null)) {
        ...
        if (n === Fs) return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;
        if (n === Os) return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT;
      } else return null;
    if (n === Bs || n === zs || n === Vs || n === Gs)
      if (((s = e.get("EXT_texture_compression_rgtc")), s !== null)) {
        if (n === Bs) return s.COMPRESSED_RED_RGTC1_EXT;
...
class mp {
  ...
  getMesh(e) {
    if (this.texture !== null && this.mesh === null) {
      ...
      this.mesh = new vt(new vr(20, 20), n);
    }
    return this.mesh;
  }
  reset() {
  ...
  constructor(e, t) {
    ...
    ((this.cameraAutoUpdate = !0),
      ...
      (this.getController = function (X) {
        let Z = D[X];
        return (
          Z === void 0 && ((Z = new Yr()), (D[X] = Z)),
          Z.getTargetRaySpace()
        );
      }),
      (this.getControllerGrip = function (X) {
        let Z = D[X];
        return (Z === void 0 && ((Z = new Yr()), (D[X] = Z)), Z.getGripSpace());
      }),
      (this.getHand = function (X) {
        let Z = D[X];
        return (Z === void 0 && ((Z = new Yr()), (D[X] = Z)), Z.getHandSpace());
      }));
    function K(X) {
        ...
        if (((r = X), r !== null)) {
          if (
            ...
            ((d = this.getBinding()),
              ...
              (R = new Hn(f.textureWidth, f.textureHeight, {
                format: Yt,
                type: dn,
                depthTexture: new Ho(
                  f.textureWidth,
            ...
            ((m = new XRWebGLLayer(r, t, de)),
              ...
              (R = new Hn(m.framebufferWidth, m.framebufferHeight, {
                format: Yt,
                type: dn,
                colorSpace: e.outputColorSpace,
                stencilBuffer: T.stencil,
    ...
    function ke(X, Z, de) {
      (de === null
        ...
        X.isPerspectiveCamera &&
          ((X.fov = ks * 2 * Math.atan(1 / X.projectionMatrix.elements[5])),
          (X.zoom = 1)));
    }
...
function gp(i, e) {
  ...
  function n(p, h) {
    (h.color.getRGB(p.fogColor.value, zo(i)),
      h.isFog
  ...
  function s(p, h) {
    ...
    (E &&
      ...
      E.isCubeTexture &&
        ...
        ((Nn.y *= -1), (Nn.z *= -1)),
      p.envMapRotation.value.setFromMatrix4(_p.makeRotationFromEuler(Nn)),
      (p.flipEnvMap.value =
...
class bp {
  constructor(e = {}) {
    ...
    const g = new Set([ea, Qs, $s]),
      M = new Set([dn, Gn, Ri, Ci, js, Zs]),
      p = new Uint32Array(4),
      h = new Int32Array(4);
    let T = null,
      E = null;
    ...
    try {
      ...
      if (
        ("setAttribute" in t &&
          t.setAttribute("data-engine", `three.js r${Ys}`),
    ...
    function ie() {
      ((Ve = new Cd(A)),
        ...
        (Ae = new Ud(A, et, Pe)),
        (xe = new Sd(Me)),
        (V = new Zf(y, b, x, Ve, et, w, xe)),
        (_e = new gp(y, Me)),
        (oe = new Qf()),
        (be = new sp(Ve)),
        (ee = new _d(y, b, x, me, j, m, l)),
        ($ = new cp(y, j, et)),
        (ce = new vp(A, it, et, me)),
        (ye = new vd(A, Ve, it)),
        (he = new Dd(A, Ve, it)),
    ...
    ((this.xr = re),
      ...
      (this.dispose = function () {
        (t.removeEventListener("webglcontextlost", J, !1),
          ...
          V.dispose(),
          re.dispose(),
          re.removeEventListener("sessionstart", ca),
          re.removeEventListener("sessionend", la),
          Rn.stop());
      }));
    function J(_) {
      (_.preventDefault(), Ea("WebGLRenderer: Context Lost."), (P = !0));
    }
    function Y() {
      (Ea("WebGLRenderer: Context Restored."), (P = !1));
      ...
      if (U.isBatchedMesh)
        if (U._multiDrawInstances !== null)
          ...
          const Ee = U._multiDrawStarts,
            ...
            Xn = Me.get(O).currentProgram.getUniforms();
          for (let Ct = 0; Ct < He; Ct++)
            (Xn.setValue(A, "_gl_DrawID", Ct), $e.render(Ee[Ct] / Rt, rt[Ct]));
        }
    ...
    function Kt(_, L, N) {
      _.transparent === !0 && _.side === on && _.forceSinglePass === !1
        ? ((_.side = wt),
          (_.needsUpdate = !0),
          Oi(_, L, N),
          (_.side = An),
    ...
    const Rn = new Xo();
    (Rn.setAnimationLoop(ec),
      typeof self < "u" && Rn.setContext(self),
      (this.setAnimationLoop = function (_) {
        ((kt = _), re.setAnimationLoop(_), _ === null ? Rn.stop() : Rn.start());
      }),
      re.addEventListener("sessionstart", ca),
      re.addEventListener("sessionend", la),
      (this.render = function (_, L) {
        ...
        if (
          ...
          X.setFromProjectionMatrix(Le, $t, L.reversedDepth),
          ...
          Q !== null && Er(Q, L, -1 / 0, y.sortObjects);
        }
        (Er(_, L, 0, y.sortObjects),
          T.finish(),
        ...
        if ((E.setupLights(), L.isArrayCamera)) {
          ...
          for (let le = 0, pe = Q.length; le < pe; le++) {
            const ue = Q[le];
            ha(T, _, ue, ue.viewport);
          }
        } else
          (U.length > 0 && ua(O, U, _, L), Fe && ee.render(_), ha(T, _, L));
        (v !== null &&
          S === 0 &&
    ...
    function Er(_, L, N, O) {
      ...
      const Q = _.children;
      for (let le = 0, pe = Q.length; le < pe; le++) Er(Q[le], L, N, O);
    }
    function ha(_, L, N, O) {
    ...
    function ua(_, L, N, O) {
      ...
      E.state.transmissionRenderTarget[O.id] === void 0 &&
        (E.state.transmissionRenderTarget[O.id] = new Hn(1, 1, {
          generateMipmaps: !0,
          type:
      ...
      if (
        ...
        for (let Ye = 0, at = L.length; Ye < at; Ye++) {
          ...
          if (rt.side === on && $e.layers.test(O.layers)) {
            const Rt = rt.side;
            ((rt.side = wt),
              (rt.needsUpdate = !0),
              da($e, N, O, Ee, rt, He),
    ...
    function Fi(_, L, N) {
      ...
      for (let U = 0, Q = _.length; U < Q; U++) {
        ...
        (we.allowOverride === !0 && O !== null && (we = O),
          pe.layers.test(N.layers) && da(pe, L, N, ue, we, Te));
      }
    }
    function da(_, L, N, O, U, Q) {
    ...
    function fa(_) {
      if (_.uniformsList === null) {
        ...
        _.uniformsList = ur.seqWithValue(L.seq, _.uniforms);
      }
    ...
    function tc(_, L, N, O, U) {
      ...
      const st = Rt.getUniforms(),
        Et = Ee.uniforms;
      if (
        (me.useProgram(Rt.program) && ((Xn = !0), (Ct = !0), (vi = !0)),
        O.id !== C && ((C = O.id), (Ct = !0)),
        Xn || B !== _)
      ) {
      ...
      if (
        ...
        Et.dfgLUT !== void 0 && (Et.dfgLUT.value = Sp()),
        Ct &&
          (st.setValue(A, "toneMappingExposure", y.toneMappingExposure),
          Ee.needsLights && nc(Et, vi),
          ...
          ur.upload(A, fa(Ee), Et, Pe)),
        O.isShaderMaterial &&
          O.uniformsNeedUpdate === !0 &&
          (ur.upload(A, fa(Ee), Et, Pe), (O.uniformsNeedUpdate = !1)),
        ...
        for (let yt = 0, yr = Mt.length; yt < yr; yt++) {
          const Cn = Mt[yt];
          (ce.update(Cn, Rt), ce.bind(Cn, Rt));
        }
      }
      return Rt;
    }
    ...
    ((this.copyTextureToTexture = function (
      ...
      if (N !== null)
        ...
        ((le = Math.floor(ot.width * Ft)),
          (pe = Math.floor(ot.height * Ft)),
          _.isDataArrayTexture
            ? (ue = ot.depth)
            : _.isData3DTexture
              ? (ue = Math.floor(ot.depth * Ft))
              : (ue = 1),
          (Te = 0),
          (we = 0),
          (ve = 0));
      ...
      const He = A.getParameter(A.UNPACK_ROW_LENGTH),
        ...
        Xn = A.getParameter(A.UNPACK_SKIP_PIXELS),
        Ct = A.getParameter(A.UNPACK_SKIP_ROWS),
        vi = A.getParameter(A.UNPACK_SKIP_IMAGES);
      ...
      if (_.isDepthTexture) {
        const Ft = Me.get(_),
          Mt = Me.get(L),
          yt = Me.get(Ft.__renderTarget),
          yr = Me.get(Mt.__renderTarget);
        (me.bindFramebuffer(A.READ_FRAMEBUFFER, yt.__webglFramebuffer),
          me.bindFramebuffer(A.DRAW_FRAMEBUFFER, yr.__webglFramebuffer));
        for (let Cn = 0; Cn < ue; Cn++)
          (st &&
            (A.framebufferTextureLayer(
              A.READ_FRAMEBUFFER,
              A.COLOR_ATTACHMENT0,
        ...
        const Ft = Me.get(_),
          Mt = Me.get(L);
        (me.bindFramebuffer(A.READ_FRAMEBUFFER, sc),
          me.bindFramebuffer(A.DRAW_FRAMEBUFFER, ac));
      ...
      (A.pixelStorei(A.UNPACK_ROW_LENGTH, He),
        ...
        A.pixelStorei(A.UNPACK_SKIP_PIXELS, Xn),
        A.pixelStorei(A.UNPACK_SKIP_ROWS, Ct),
        A.pixelStorei(A.UNPACK_SKIP_IMAGES, vi),
...
class yp extends Il {
  constructor(e, t = null) {
    (super(e, t),
      ...
      (this._lastQuaternion = new kn()),
      (this._lastTargetPosition = new F()),
      (this._quat = new kn().setFromUnitVectors(e.up, new F(0, 1, 0))),
      ...
      (this._onPointerMove = Ap.bind(this)),
      (this._onPointerDown = Tp.bind(this)),
      (this._onPointerUp = wp.bind(this)),
      (this._onContextMenu = Ip.bind(this)),
      (this._onMouseWheel = Pp.bind(this)),
      (this._onKeyDown = Dp.bind(this)),
      (this._onTouchStart = Lp.bind(this)),
      (this._onTouchMove = Up.bind(this)),
      (this._onMouseDown = Rp.bind(this)),
      (this._onMouseMove = Cp.bind(this)),
      (this._interceptControlDown = Np.bind(this)),
      (this._interceptControlUp = Fp.bind(this)),
  ...
  update(e = null) {
    ...
    if (
      ...
      a !== null &&
        (this.screenSpacePanning
          ...
          : (sr.origin.copy(this.object.position),
            sr.direction.set(0, 0, -1).transformDirection(this.object.matrix),
            Math.abs(this.object.up.dot(sr.direction)) < Ep
              ? this.object.lookAt(this.target)
              : (mo.setFromNormalAndCoplanarPoint(this.object.up, this.target),
                sr.intersectPlane(mo, this.target))));
    } else if (this.object.isOrthographicCamera) {
    ...
    return (
      ...
      (this._performCursorZoom = !1),
      s ||
      this._lastPosition.distanceToSquared(this.object.position) > es ||
      8 * (1 - this._lastQuaternion.dot(this.object.quaternion)) > es ||
      this._lastTargetPosition.distanceToSquared(this.target) > es
        ? (this.dispatchEvent(po),
...
async function $o() {
  const i = await zp(() => import("./ammo-B9oaJM7s.js").then((t) => t.a), []),
    e = i.default ?? i;
...
class mn {
  ...
  static addItem(e, t = 1) {
    (jt.inventory[e] || (jt.inventory[e] = { quantity: 0 }),
      (jt.inventory[e].quantity += t));
  }
  static removeItem(e, t = 1) {
    jt.inventory[e] &&
      ((jt.inventory[e].quantity -= t),
      jt.inventory[e].quantity <= 0 && delete jt.inventory[e]);
  }
  static hasItem(e, t = 1) {
    return jt.inventory[e]?.quantity >= t;
  }
}
class Vp {
  physicsWorld;
  ...
  onSaveGame;
  async init(e) {
    this.AmmoLib = await $o();
    const { physicsWorld: t } = Jo(this.AmmoLib);
    ((this.physicsWorld = t), (this.scene = e));
    const n = 50,
      r = new Ut(n, 1, n),
      s = new Gt({ color: 8947848 }),
      a = new vt(r, s);
  ...
  makeBarrier(e, t, n) {
    const r = { x: 1, y: 0.5, z: 1 },
      ...
      o = zn(this.AmmoLib, s, a, 0);
    this.physicsWorld.addRigidBody(o.body);
    const l = new Ut(r.x, r.y, r.z),
      c = new Gt({ color: 16711680 }),
      u = new vt(l, c);
  ...
  handleSceneLeave = async (e) => {
    switch (e.code) {
      case "KeyG":
        this.onSceneLeave?.(new aa());
        break;
    }
  };
  onEnter() {
    (console.log("Inventory: ", mn.getGameStateInventory()),
...
const _o = {
  ground_Material: {
    light: new Gt({ color: 16777215 }),
    dark: new Gt({ color: 1118481 }),
  },
  cube_Material: {
    light: new Gt({ color: 16729932 }),
    dark: new Gt({ color: 16711680 }),
  },
};
class xi {
...
class aa {
  ...
  async init(e) {
    ...
    const n = 50,
      r = new Ut(n, 1, n),
      s = new vt(r, xi.getAsset("ground_Material"));
  ...
  makeBarrier(e, t, n) {
    ...
    this.physicsWorld.addRigidBody(o.body);
    const l = new Ut(r.x, r.y, r.z),
      c = new vt(l, xi.getAsset("cube_Material"));
  ...
  onClick(e) {
    e.userData.type == "Key" &&
      (this.scene.remove(e), mn.addItem("Key", 1), this.onSaveGame?.());
  }
}
class wi {
  static language = "en";
...
const go = new Ul();
let vo = new Ie(),
  Gp = wi.getLocalizedString("start_button");
async function oa(i) {
  for (mr = !0; oi.children.length; ) oi.remove(oi.children[0]);
  (Lt && (Lt.onExit(), (Lt.onSceneLeave = void 0), (Lt.onSaveGame = void 0)),
    (Lt = i),
    await Lt.init(oi),
    (Lt.onSceneLeave = (e) => oa(e)),
    (Lt.onSaveGame = () => qs()),
    Lt.onEnter(),
    (mr = !1),
    qs());
}
const br = new zt(75, window.innerWidth / window.innerHeight, 0.1, 1e3),
  kp = 4;
br.position.z = kp;
const Ni = new bp();
Ni.setSize(window.innerWidth, window.innerHeight);
document.body.appendChild(Ni.domElement);
const Xs = document.getElementById("start-screen"),
  Mo = document.getElementById("start-button"),
  xr = document.getElementById("end-screen"),
  So = document.getElementById("mode-button"),
  bo = document.querySelector("#end-screen .end-gif");
Xs && Xs.classList.add("visible");
xr && xr.classList.remove("visible");
xi.subscribe((i) => {
  (document.documentElement.setAttribute("data-theme", i),
    bo && (bo.src = i === "light" ? "/endLight.gif" : "/endDark.gif"),
    xr && (xr.style.backgroundColor = i === "light" ? "#ffffff" : "#000000"),
    Ni.setClearColor(i === "light" ? 16777215 : 0, 1));
});
So &&
  So.addEventListener("click", () => {
    const e = xi.getMode() === "light" ? "dark" : "light";
    xi.setTheme(e);
  });
Mo &&
  Mo.addEventListener("click", async () => {
    mr || (Xs?.classList.remove("visible"), await oa(new aa()));
  });
const Hp = new yp(br, Ni.domElement),
  Wp = new Ll();
window.addEventListener("keydown", (i) => {
  i.code === "KeyI" && (mn.addItem("test_item", 1), qs());
});
window.addEventListener("keydown", (i) => {
  let e = !1;
  (i.code === "KeyB"
    ? (wi.setLanguage("en"), (e = !0))
    : i.code === "KeyN"
      ? (wi.setLanguage("jp"), (e = !0))
      : i.code == "KeyM" && (wi.setLanguage("ar"), (e = !0)),
    e && console.log("Language changed, new value: ", Gp()));
});
window.addEventListener("keydown", (i) => {
  i.code === "KeyL" && qp();
});
window.addEventListener("click", (i) => {
  ((vo = new Ie(
    ...
    go.setFromCamera(vo, br));
  const e = go.intersectObjects(oi.children);
...
Xp();
xi.init();
await wi.initalizeRecord();
await oa(new aa());
function Qo() {
  requestAnimationFrame(Qo);
  const i = Wp.getDelta();
  (Hp.update(), Lt && !mr && Lt.update(i), Ni.render(oi, br));
}
Qo();
function qs() {
  const i = { inventory: mn.getGameStateInventory() };
  (localStorage.setItem("gameSave", JSON.stringify(i)),
    console.log("Game saved with inventory: ", mn.getGameStateInventory()));
}
function Xp() {
  const i = localStorage.getItem("gameSave");
  if (!i) return;
  const e = JSON.parse(i);
  (mn.setGameStateInventory(e.inventory),
    console.log("Loaded game with inventory: ", mn.getGameStateInventory()));
}
function qp() {
  (localStorage.removeItem("gameSave"),
    mn.setGameStateInventory({}),
