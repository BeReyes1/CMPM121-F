    ...
    if (r !== null) {
      ...
      if (Array.isArray(r)) {
        ...
        for (let a = 0, o = r.length; a < o; a++)
          r[a].isDataTexture ? s.push(xr(r[a].image)) : s.push(xr(r[a]));
      } else s = xr(r);
      n.url = s;
    }
...
class Ai {
  ...
  intersectsTriangle(e) {
    ...
    return !gr(t, Gn, Hn, kn, Di) ||
      ((t = [1, 0, 0, 0, 1, 0, 0, 0, 1]), !gr(t, Gn, Hn, kn, Di))
      ? !1
    ...
    return e.isEmpty()
      ...
      : this.isEmpty()
        ...
        : (this.center.equals(e.center) === !0
            ...
            : (vr.subVectors(e.center, this.center).setLength(e.radius),
              this.expandByPoint(hi.copy(e.center).add(vr)),
              this.expandByPoint(hi.copy(e.center).sub(vr))),
          this);
  }
  equals(e) {
...
class fo {
  ...
  distanceSqToSegment(e, t, n, r) {
    ...
    return (
      ...
      r && r.copy(Mr).addScaledVector(Ui, h),
      m
    );
  }
  intersectSphere(e, t) {
  ...
  intersectTriangle(e, t, n, r, s) {
    (Sr.subVectors(t, e), Ii.subVectors(n, e), br.crossVectors(Sr, Ii));
    ...
    if (l < 0) return null;
    const c = o * this.direction.dot(Sr.cross(hn));
...
class ln {
  ...
  setFromQuaternion(e, t, n) {
    return (
      ua.makeRotationFromQuaternion(e),
...
class Dt extends ci {
  ...
  translateOnAxis(e, t) {
    return (
      fa.copy(e).applyQuaternion(this.quaternion),
      this.position.add(fa.multiplyScalar(t)),
      this
    );
  }
  translateX(e) {
  ...
  getWorldQuaternion(e) {
    return (
      this.updateWorldMatrix(!0, !1),
      this.matrixWorld.decompose(pi, e, Vc),
      e
    );
  }
  getWorldScale(e) {
    return (
      this.updateWorldMatrix(!0, !1),
      this.matrixWorld.decompose(pi, Gc, e),
      e
    );
  }
  getWorldDirection(e) {
...
class Ht {
  ...
  static getInterpolatedAttribute(e, t, n, r, s, a) {
    return (
      ...
      Pr.fromBufferAttribute(e, r),
      a.setScalar(0),
      a.addScaledVector(Rr, s.x),
      a.addScaledVector(Cr, s.y),
      a.addScaledVector(Pr, s.z),
      a
    );
  }
  ...
  closestPointToPoint(e, t) {
    const n = this.a,
      ...
      s = this.c;
    let a, o;
    (Yn.subVectors(r, n), Kn.subVectors(s, n), Tr.subVectors(e, n));
    const l = Yn.dot(Tr),
      c = Kn.dot(Tr);
...
class $e {
  ...
  setHSL(e, t, n, r = ke.workingColorSpace) {
    if (((e = Cc(e, 1)), (t = Ve(t, 0, 1)), (n = Ve(n, 0, 1)), t === 0))
...
class sr extends ci {
  ...
  toJSON(e) {
    ...
    ((n.uuid = this.uuid),
      ...
      this.stencilFunc !== na && (n.stencilFunc = this.stencilFunc),
    ...
    if (s && o) {
      ...
      for (let l = 0, c = s.length; l < c; l++) {
        const u = o[l],
          f = s[l];
        u !== 0 &&
          (Ur.fromBufferAttribute(f, e),
          a ? ki.addScaledVector(Ur, u) : ki.addScaledVector(Ur.sub(t), u));
      }
      t.add(ki);
    }
    return t;
  ...
  raycast(e, t) {
    ...
    r !== void 0 &&
      ...
      !(
        ...
        (An.intersectSphere(zi, va) === null ||
          An.origin.distanceToSquared(va) > (e.far - e.near) ** 2)
      ) &&
        (ga.copy(s).invert(),
        An.copy(e.ray).applyMatrix4(ga),
...
function Xi(i, e, t, n, r, s, a, o, l, c) {
  ...
  const u = qc(i, e, t, n, Vi, Gi, Hi, Ma);
  if (u) {
    const f = new z();
    (Ht.getBarycoord(Ma, Vi, Gi, Hi, f),
...
class un extends sr {
  ...
  copy(e) {
    return (
      ...
      (this.uniformsGroups = Yc(e.uniformsGroups)),
...
class Nt extends _o {
  ...
  getEffectiveFOV() {
    return Rs * 2 * Math.atan(Math.tan(fr * 0.5 * this.fov) / this.zoom);
  }
  getFilmWidth() {
  ...
  getViewSize(e, t) {
    return (this.getViewBounds(e, Sa, ba), t.subVectors(ba, Sa));
  }
  ...
  updateProjectionMatrix() {
    const e = this.near;
    let t = (e * Math.tan(fr * 0.5 * this.fov)) / this.zoom,
      n = 2 * t,
      r = this.aspect * n,
      s = -0.5 * r;
    const a = this.view;
...
class Pn {
  ...
  setFromCoplanarPoints(e, t, n) {
    const r = Nr.subVectors(n, t).cross(nl.subVectors(e, t)).normalize();
  ...
  applyMatrix4(e, t) {
    const n = t || il.getNormalMatrix(e),
      r = this.coplanarPoint(Nr).applyMatrix4(e),
...
class vo {
  ...
  intersectsSprite(e) {
    wn.center.set(0, 0, 0);
    const t = rl.distanceTo(e.center);
    return (
...
class ul {
  ...
  setFromXRController(e) {
    return (
      Ea.identity().extractRotation(e.matrixWorld),
      this.ray.origin.setFromMatrixPosition(e.matrixWorld),
      this.ray.direction.set(0, 0, -1).applyMatrix4(Ea),
      this
    );
  }
  intersectObject(e, t = !0, n = []) {
    return (Cs(e, this, n, t), n.sort(ya), n);
  }
  intersectObjects(e, t = !0, n = []) {
    for (let r = 0, s = e.length; r < s; r++) Cs(e[r], this, n, t);
    return (n.sort(ya), n);
  }
}
function ya(i, e) {
...
function Cs(i, e, t, n) {
  ...
  if (
    ...
    const s = i.children;
    for (let a = 0, o = s.length; a < o; a++) Cs(s[a], e, t, !0);
  }
}
function Ta(i, e, t, n) {
  const r = dl(n);
...
#endif`,
  El = `vec3 transformed = vec3( position );
#ifdef USE_ALPHAHASH
...
#endif`,
  Tl = `float G_BlinnPhong_Implicit( ) {
	return 0.25;
}
...
#endif`,
  Fl = `#define PI 3.141592653589793
...
#endif`,
  Bl = `vec3 transformedNormal = objectNormal;
#ifdef USE_TANGENT
...
transformedNormal = normalMatrix * transformedNormal;
  ...
  Wl = `vec4 LinearTransferOETF( in vec4 value ) {
	return value;
}
...
#define RE_IndirectDiffuse		RE_IndirectDiffuse_Toon`,
  cu = `BlinnPhongMaterial material;
material.diffuseColor = diffuseColor.rgb;
...
#endif`,
  hu = `#if defined( RE_IndirectDiffuse )
	#ifdef USE_LIGHTMAP
...
#endif`,
  Pu = `float faceDirection = gl_FrontFacing ? 1.0 : - 1.0;
#ifdef FLAT_SHADED
...
#endif`,
  ku = `vec4 mvPosition = vec4( transformed, 1.0 );
#ifdef USE_BATCHING
...
#endif`,
  qu = `float roughnessFactor = roughness;
...
#endif`,
  id = `#ifdef USE_SPECULARMAP
	uniform sampler2D specularMap;
#endif`,
  rd = `#if defined( TONE_MAPPING )
...
void main() {
  ...
  Ie = {
    ...
    displacementmap_vertex: Vl,
    emissivemap_fragment: Gl,
    emissivemap_pars_fragment: Hl,
    colorspace_fragment: kl,
...
function Yd(i, e, t, n, r, s, a) {
  ...
  function p(E, R) {
    const D = g(R);
    D && (D.isCubeTexture || D.mapping === rr)
      ? (u === void 0 &&
          ((u = new _t(
            new Ct(1, 1, 1),
            new un({
  ...
  function d(E, R) {
    (E.getRGB(Ki, xo(i)), n.buffers.color.setClear(Ki.r, Ki.g, Ki.b, R, a));
  }
  function T() {
...
function Jd(i) {
  let e = new WeakMap();
  function t(a, o) {
    return (o === Zr ? (a.mapping = ii) : o === jr && (a.mapping = ri), a);
  }
  function n(a) {
    if (a && a.isTexture) {
      const o = a.mapping;
...
const gn = 4,
  Aa = [0.125, 0.215, 0.35, 0.446, 0.526, 0.582],
  Ln = 20,
  Qd = 256,
  xi = new ol(),
  wa = new $e();
...
class Ra {
  ...
  fromScene(e, t = 0, n = 0.1, r = 100, s = {}) {
    const { size: a = 256, position: o = ef } = s;
    ((Fr = this._renderer.getRenderTarget()),
      (Or = this._renderer.getActiveCubeFace()),
      (Br = this._renderer.getActiveMipmapLevel()),
      (zr = this._renderer.xr.enabled),
  ...
  _cleanup(e) {
    (this._renderer.setRenderTarget(Fr, Or, Br),
      (this._renderer.xr.enabled = zr),
      (e.scissorTest = !1),
  ...
  _allocateTargets() {
    ...
    if (
      ...
      (this._pingPongRenderTarget !== null && this._dispose(),
        (this._pingPongRenderTarget = Ca(e, t, n)));
  ...
  _textureToCubeUV(e, t) {
    ...
    r
      ? (this._cubemapMaterial === null && (this._cubemapMaterial = Da()),
  ...
  _applyGGXFilter(e, t, n) {
    ...
    if (this._ggxMaterial === null) {
      const T = 3 * Math.max(this._cubeSize, 16),
        E = 4 * this._cubeSize;
      this._ggxMaterial = nf(this._lodMax, T, E);
    }
...
function tf(i) {
  const e = [],
    ...
    n = [];
  let r = i;
  const s = i - gn + 1 + Aa.length;
  for (let a = 0; a < s; a++) {
    const o = Math.pow(2, r);
    e.push(o);
    let l = 1 / o;
    (a > i - gn ? (l = Aa[a - i + gn - 1]) : a === 0 && (l = 0), t.push(l));
    const c = 1 / (o - 2),
      u = -c,
      f = 1 + c,
...
function xf(i, e) {
  ...
  if (n === void 0) {
    ...
    if (dt(t, n)) return;
    (Oa.set(n), i.uniformMatrix2fv(this.addr, !1, Oa), ft(t, n));
  }
}
function _f(i, e) {
  const t = this.cache,
  ...
  if (n === void 0) {
    ...
    if (dt(t, n)) return;
    (Fa.set(n), i.uniformMatrix3fv(this.addr, !1, Fa), ft(t, n));
  }
}
function gf(i, e) {
  const t = this.cache,
  ...
  if (n === void 0) {
    ...
    if (dt(t, n)) return;
    (Na.set(n), i.uniformMatrix4fv(this.addr, !1, Na), ft(t, n));
  }
}
function vf(i, e) {
  const t = this.cache;
...
function Yf(i, e, t) {
  ...
  for (let a = 0; a !== r; ++a) t.setTexture2D(e[a] || Eo, s[a]);
}
function Kf(i, e, t) {
  const n = this.cache,
    r = e.length,
    s = cr(t, r);
  dt(n, s) || (i.uniform1iv(this.addr, s), ft(n, s));
  for (let a = 0; a !== r; ++a) t.setTexture3D(e[a] || To, s[a]);
}
function $f(i, e, t) {
  const n = this.cache,
    r = e.length,
    s = cr(t, r);
  dt(n, s) || (i.uniform1iv(this.addr, s), ft(n, s));
  for (let a = 0; a !== r; ++a) t.setTextureCube(e[a] || Ao, s[a]);
}
function Zf(i, e, t) {
  const n = this.cache,
    r = e.length,
...
function th(i, e, t) {
  ...
  for (Vr.lastIndex = 0; ; ) {
    ...
    if ((l && (o = o | 0), c === void 0 || (c === "[" && a + 2 === r))) {
      Ba(t, c === void 0 ? new Jf(o, i, e) : new Qf(o, i, e));
      break;
    } else {
      let f = t.map[o];
      (f === void 0 && ((f = new eh(o)), Ba(t, f)), (t = f));
    }
  }
}
class er {
...
const Va = new Ue();
function sh(i) {
  ke._getMatrix(Va, ke.workingColorSpace, i);
...
`)),
      (d = [
        ...
        t.toneMapping !== vn ? oh("toneMapping", t.toneMapping) : "",
...
` +
      ...
      (d =
        [
          ...
          t.glslVersion === ra ? "" : "#define gl_FragColor pc_fragColor",
...
` +
  ...
  const E = T + p + a,
    R = T + d + o,
    D = za(r, r.VERTEX_SHADER, E),
    y = za(r, r.FRAGMENT_SHADER, R);
  (r.attachShader(M, D),
    r.attachShader(M, y),
...
` +
    ...
    (r.deleteShader(D), r.deleteShader(y), (B = new er(r, M)), (S = dh(r, M)));
  }
  let B;
  ...
  return (
    (this.isReady = function () {
      return (v === !1 && (v = r.getProgramParameter(M, nh)), v);
    }),
...
class Th {
  constructor(e) {
    ((this.id = Eh++), (this.code = e), (this.usedTimes = 0));
  }
}
function Ah(i, e, t, n, r, s, a) {
  const o = new Hs(),
    l = new yh(),
    c = new Set(),
    u = [],
  ...
  function p(S, v, C, O, G) {
    const k = O.fog,
      ...
      H = ne && ne.mapping === rr ? ne.image.height : null,
      te = g[S.type];
    S.precision !== null &&
    ...
    const et = {
      ...
      emissiveMap: me,
      normalMapObjectSpace: Be && S.normalMapType === vc,
      normalMapTangentSpace: Be && S.normalMapType === gc,
      metalnessMap: nt,
      roughnessMap: Me,
      anisotropy: Pe,
      anisotropyMap: V,
  ...
  function D(S, v) {
    ...
    return (C === void 0 && ((C = new bh(i, v, S, s)), u.push(C)), C);
  }
  function y(S) {
    if (--S.usedTimes === 0) {
      const v = u.indexOf(S);
...
function Vh(i, e) {
  ...
  const pt = {
    [Dn]: i.FUNC_ADD,
    [ko]: i.FUNC_SUBTRACT,
    [Wo]: i.FUNC_REVERSE_SUBTRACT,
  };
  ((pt[Xo] = i.MIN), (pt[qo] = i.MAX));
  const Ne = {
    [Yo]: i.ZERO,
    [Ko]: i.ONE,
    [$o]: i.SRC_COLOR,
    ...
    [Qo]: i.DST_COLOR,
    [jo]: i.DST_ALPHA,
    [Zo]: i.ONE_MINUS_SRC_COLOR,
    [Hr]: i.ONE_MINUS_SRC_ALPHA,
    [ec]: i.ONE_MINUS_DST_COLOR,
    [Jo]: i.ONE_MINUS_DST_ALPHA,
    [nc]: i.CONSTANT_COLOR,
    [ic]: i.ONE_MINUS_CONSTANT_COLOR,
    [rc]: i.CONSTANT_ALPHA,
...
function Gh(i, e, t, n, r, s, a) {
  ...
  const te = { [Jr]: i.REPEAT, [rn]: i.CLAMP_TO_EDGE, [Qr]: i.MIRRORED_REPEAT },
    se = {
      [Pt]: i.NEAREST,
      ...
      if (x.isDepthTexture)
                ...
                if (w) {
                  if (ie)
                    if (x.layerUpdates.size > 0) {
                      const he = Ta(ue.width, ue.height, x.format, x.type);
        ...
        if (w) {
          if (
            ...
            if (x.layerUpdates.size > 0) {
              const J = Ta(j.width, j.height, x.format, x.type);
...
function Hh(i, e) {
  function t(n, r = _n) {
    ...
    if (n === ro) return i.UNSIGNED_INT_10F_11F_11F_REV;
    if (n === to) return i.BYTE;
    if (n === no) return i.SHORT;
    ...
    if (n === Ss || n === bs || n === Es)
      if (((s = e.get("EXT_texture_compression_bptc")), s !== null)) {
        ...
        if (n === Es) return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT;
      } else return null;
    if (n === ys || n === Ts || n === As || n === ws)
      if (((s = e.get("EXT_texture_compression_rgtc")), s !== null)) {
        if (n === ys) return s.COMPRESSED_RED_RGTC1_EXT;
        if (n === Ts) return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;
        if (n === As) return s.COMPRESSED_RED_GREEN_RGTC2_EXT;
        if (n === ws) return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT;
      } else return null;
...
class Xh {
  ...
  getMesh(e) {
    if (this.texture !== null && this.mesh === null) {
      ...
      this.mesh = new _t(new ar(20, 20), n);
    }
    return this.mesh;
  }
  reset() {
  ...
  constructor(e, t) {
    ...
    ((this.cameraAutoUpdate = !0),
      ...
      (this.getController = function (X) {
        let Z = D[X];
        return (
          Z === void 0 && ((Z = new Ir()), (D[X] = Z)),
          Z.getTargetRaySpace()
        );
      }),
      (this.getControllerGrip = function (X) {
        let Z = D[X];
        return (Z === void 0 && ((Z = new Ir()), (D[X] = Z)), Z.getGripSpace());
      }),
      (this.getHand = function (X) {
        let Z = D[X];
        return (Z === void 0 && ((Z = new Ir()), (D[X] = Z)), Z.getHandSpace());
      }));
    function K(X) {
    ...
    function Ge(X, Z, fe) {
      (fe === null
        ...
        X.isPerspectiveCamera &&
          ((X.fov = Rs * 2 * Math.atan(1 / X.projectionMatrix.elements[5])),
          (X.zoom = 1)));
    }
...
function Kh(i, e) {
  ...
  function n(p, d) {
    (d.color.getRGB(p.fogColor.value, xo(i)),
      d.isFog
  ...
  function s(p, d) {
    ...
    (E &&
      ...
      E.isCubeTexture &&
        ...
        ((Cn.y *= -1), (Cn.z *= -1)),
      p.envMapRotation.value.setFromMatrix4(Yh.makeRotationFromEuler(Cn)),
      (p.flipEnvMap.value =
  ...
  constructor(e = {}) {
    ...
    function ie() {
      ((Be = new af(A)),
        ...
        (Ae = new uf(A, Qe, Pe)),
        (xe = new jd(Me)),
        (V = new Ah(y, b, x, Be, Qe, w, xe)),
        (_e = new Kh(y, Me)),
        (oe = new Ch()),
        (be = new Nh(Be)),
        (ee = new Yd(y, b, x, me, $, m, l)),
        (j = new Bh(y, $, Qe)),
        (ce = new $h(A, nt, Qe, me)),
        (ye = new $d(A, Be, nt)),
        (ue = new cf(A, Be, nt)),
    ...
    ((this.xr = re),
      ...
      (this.dispose = function () {
        (t.removeEventListener("webglcontextlost", J, !1),
          ...
          V.dispose(),
          re.dispose(),
          re.removeEventListener("sessionstart", Xs),
          re.removeEventListener("sessionend", qs),
          bn.stop());
      }));
    function J(_) {
      (_.preventDefault(), aa("WebGLRenderer: Context Lost."), (P = !0));
    }
    function Y() {
      (aa("WebGLRenderer: Context Restored."), (P = !1));
    ...
    (bn.setAnimationLoop(Lo),
      ...
      (this.render = function (_, L) {
        ...
        if (
          ...
          Q !== null && lr(Q, L, -1 / 0, y.sortObjects);
        }
        (lr(_, L, 0, y.sortObjects),
          T.finish(),
        ...
        if ((E.setupLights(), L.isArrayCamera)) {
          ...
          for (let le = 0, pe = Q.length; le < pe; le++) {
            const de = Q[le];
            Ys(T, _, de, de.viewport);
          }
        } else
          (U.length > 0 && Ks(F, U, _, L), Ne && ee.render(_), Ys(T, _, L));
        (v !== null &&
          S === 0 &&
    ...
    function lr(_, L, N, F) {
      ...
      const Q = _.children;
      for (let le = 0, pe = Q.length; le < pe; le++) lr(Q[le], L, N, F);
    }
    function Ys(_, L, N, F) {
    ...
    function wi(_, L, N) {
      ...
      for (let U = 0, Q = _.length; U < Q; U++) {
        ...
        (we.allowOverride === !0 && F !== null && (we = F),
          pe.layers.test(N.layers) && $s(pe, L, N, de, we, Te));
      }
    }
    function $s(_, L, N, F, U, Q) {
    ...
    function Uo(_, L, N, F, U) {
      ...
      if (
        ...
        At &&
          ...
          er.upload(A, Zs(Ee), St, Pe)),
        F.isShaderMaterial &&
          F.uniformsNeedUpdate === !0 &&
          (er.upload(A, Zs(Ee), St, Pe), (F.uniformsNeedUpdate = !1)),
        ...
        for (let bt = 0, ur = gt.length; bt < ur; bt++) {
          const En = gt[bt];
    ...
    ((this.copyTextureToTexture = function (
      ...
      if (_.isDepthTexture) {
        const Lt = Me.get(_),
          ...
          ur = Me.get(gt.__renderTarget);
        (me.bindFramebuffer(A.READ_FRAMEBUFFER, bt.__webglFramebuffer),
          me.bindFramebuffer(A.DRAW_FRAMEBUFFER, ur.__webglFramebuffer));
        ...
        const Lt = Me.get(_),
          gt = Me.get(L);
        (me.bindFramebuffer(A.READ_FRAMEBUFFER, Oo),
          me.bindFramebuffer(A.DRAW_FRAMEBUFFER, Bo));
...
async function wo() {
  const i = await tp(() => import("./ammo-B9oaJM7s.js").then((t) => t.a), []),
    e = i.default ?? i;
...
class np {
  ...
  onSceneLeave;
  async init(e) {
    this.AmmoLib = await wo();
    const { physicsWorld: t } = Ro(this.AmmoLib);
...
let ja = new We();
async function Po(i) {
  for (Ds = !0; Qn.children.length; ) Qn.remove(Qn.children[0]);
  (Gt && (Gt.onExit(), (Gt.onSceneLeave = void 0)),
    (Gt = i),
    await Gt.init(Qn),
    (Gt.onSceneLeave = (e) => Po(e)),
    Gt.onEnter(),
    (Ds = !1));
}
const ks = new Nt(75, window.innerWidth / window.innerHeight, 0.1, 1e3),
  ip = 4;
ks.position.z = ip;
const Ws = new Jh();
Ws.setSize(window.innerWidth, window.innerHeight);
document.body.appendChild(Ws.domElement);
const rp = new ll();
...
window.addEventListener("click", (i) => {
  ((ja = new We(
    ...
    Za.setFromCamera(ja, ks));
  const e = Za.intersectObjects(Qn.children);
...
function Do() {
  ...
  const i = rp.getDelta();
  (Gt && !Ds && Gt.update(i), Ws.render(Qn, ks));
}
Do();
