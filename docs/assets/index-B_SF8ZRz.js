...
function pc() {
  const i = {
      ...
      getTransfer: function (s) {
        return s === An ? gs : this.spaces[s].transfer;
      },
...
class zi {
  ...
  intersectsTriangle(e) {
    ...
    (this.getCenter(wi),
      Yi.subVectors(this.max, wi),
      Qn.subVectors(e.a, wi),
      ei.subVectors(e.b, wi),
      ti.subVectors(e.c, wi),
      vn.subVectors(ei, Qn),
      Mn.subVectors(ti, ei),
      In.subVectors(Qn, ti));
    let t = [
    ...
    return !Ws(t, Qn, ei, ti, Yi) ||
      ((t = [1, 0, 0, 0, 1, 0, 0, 0, 1]), !Ws(t, Qn, ei, ti, Yi))
      ? !1
      : (Zi.crossVectors(vn, Mn),
        (t = [Zi.x, Zi.y, Zi.z]),
        Ws(t, Qn, ei, ti, Yi));
  }
  clampPoint(e, t) {
      ...
      : this.isEmpty()
        ...
        : (this.center.equals(e.center) === !0
            ...
            : (Xs.subVectors(e.center, this.center).setLength(e.radius),
              this.expandByPoint(Ri.copy(e.center).add(Xs)),
              this.expandByPoint(Ri.copy(e.center).sub(Xs))),
          this);
  }
  equals(e) {
...
class ma {
  ...
  distanceSqToSegment(e, t, n, s) {
    ...
    return (
      ...
      s && s.copy(Ys).addScaledVector(qi, f),
      m
    );
  }
  intersectSphere(e, t) {
  ...
  intersectTriangle(e, t, n, s, r) {
    (Zs.subVectors(t, e), Ki.subVectors(n, e), qs.crossVectors(Zs, Ki));
    ...
    const c = o * this.direction.dot(Ki.crossVectors(Sn, Ki));
    if (c < 0) return null;
...
class ft {
  ...
  lookAt(e, t, n) {
    ...
    return (
      ...
      bn.lengthSq() === 0 &&
        (Math.abs(n.z) === 1 ? (Ut.x += 1e-4) : (Ut.z += 1e-4),
        Ut.normalize(),
        bn.crossVectors(n, Ut)),
      bn.normalize(),
      ji.crossVectors(Ut, bn),
      (s[0] = bn.x),
      (s[4] = ji.x),
      (s[8] = Ut.x),
      (s[1] = bn.y),
  ...
  invert() {
    const e = this.elements,
      ...
      R = u * M * l - g * d * l + g * o * m - a * M * m - u * o * h + a * d * h,
...
class Ot extends Kn {
  ...
  lookAt(e, t, n) {
    ...
    (this.updateWorldMatrix(!0, !1),
      ...
      this.isCamera || this.isLight
        ? rn.lookAt(Ci, $i, this.up)
        : rn.lookAt($i, Ci, this.up),
  ...
  getWorldQuaternion(e) {
    return (
      this.updateWorldMatrix(!0, !1),
      this.matrixWorld.decompose(Ci, e, Ec),
      e
    );
  }
  getWorldScale(e) {
    return (
      this.updateWorldMatrix(!0, !1),
      this.matrixWorld.decompose(Ci, Tc, e),
      e
    );
  }
  getWorldDirection(e) {
...
class $e {
  ...
  setHSL(e, t, n, s = We.workingColorSpace) {
    if (((e = dc(e, 1)), (t = Oe(t, 0, 1)), (n = Oe(n, 0, 1)), t === 0))
  ...
  lerpHSL(e, t) {
    (this.getHSL(yn), e.getHSL(Ji));
    const n = zs(yn.h, Ji.h, t),
      s = zs(yn.s, Ji.s, t),
      r = zs(yn.l, Ji.l, t);
        ...
        for (let n = 0, s = t.length; n < s; n++) {
          ...
          (It.setFromBufferAttribute(r),
            this.morphTargetsRelative
              ? (_t.addVectors(this.boundingBox.min, It.min),
                this.boundingBox.expandByPoint(_t),
                _t.addVectors(this.boundingBox.max, It.max),
                this.boundingBox.expandByPoint(_t))
    ...
    if (e) {
      ...
      if ((It.setFromBufferAttribute(e), t))
        for (let r = 0, a = t.length; r < a; r++) {
          const o = t[r];
          (Pi.setFromBufferAttribute(o),
            this.morphTargetsRelative
              ? (_t.addVectors(It.min, Pi.min),
                It.expandByPoint(_t),
                _t.addVectors(It.max, Pi.max),
                It.expandByPoint(_t))
              : (It.expandByPoint(Pi.min), It.expandByPoint(Pi.max)));
        }
      It.getCenter(n);
      let s = 0;
  ...
  computeTangents() {
    ...
    function P(z) {
      ...
      (y.copy(S),
        ...
        R.crossVectors(E, S));
      const C = R.dot(c[z]) < 0 ? -1 : 1;
      a.setXYZW(z, y.x, y.y, y.z, C);
    }
    for (let z = 0, S = T.length; z < S; ++z) {
      const v = T[z],
        C = v.start,
...
class Pt extends Ot {
    ...
    if (r && o) {
      ...
      for (let c = 0, l = r.length; c < l; c++) {
        ...
        u !== 0 &&
          ...
          a ? ss.addScaledVector(rr, u) : ss.addScaledVector(rr.sub(t), u));
      }
      t.add(ss);
    }
    return t;
  ...
  raycast(e, t) {
    ...
    s !== void 0 &&
      ...
      !(
        es.containsPoint(Fn.origin) === !1 &&
        (Fn.intersectSphere(es, qa) === null ||
    ...
    if (o !== null)
      if (Array.isArray(a))
        for (let g = 0, M = f.length; g < M; g++) {
          ...
          for (let R = T, D = y; R < D; R += 3) {
            const E = o.getX(R),
              P = o.getX(R + 1),
              z = o.getX(R + 2);
            ((s = as(this, h, e, n, l, u, d, E, P, z)),
              s &&
...
function Pc(i, e, t, n, s, r, a, o) {
  let c;
  if (
    (e.side === Ct
      ? (c = n.intersectTriangle(a, r, s, !0, o))
      : (c = n.intersectTriangle(s, r, a, e.side === Cn, o)),
    c === null)
  )
    return null;
  (rs.copy(o), rs.applyMatrix4(i.matrixWorld));
  const l = t.ray.origin.distanceTo(rs);
  return l < t.near || l > t.far
    ? null
    : { distance: l, point: rs.clone(), object: i };
}
function as(i, e, t, n, s, r, a, o, c, l) {
  (i.getVertexPosition(o, ts),
    i.getVertexPosition(c, ns),
    i.getVertexPosition(l, is));
  const u = Pc(i, e, t, n, ts, ns, is, Ka);
  if (u) {
    const d = new F();
    (Zt.getBarycoord(Ka, ts, ns, is, d),
    ...
    (Zt.getNormal(ts, ns, is, f.normal), (u.face = f), (u.barycoord = d));
  }
  return u;
}
class Kt extends Dn {
  constructor(e = 1, t = 1, n = 1, s = 1, r = 1, a = 1) {
    ...
    function g(M, p, h, T, y, R, D, E, P, z, S) {
      const v = R / P,
        C = D / z,
        B = R / 2,
        V = D / 2,
      ...
      for (let re = 0; re < z; re++)
        for (let Se = 0; Se < P; Se++) {
          const Ge = f + Se + q * re,
            ...
            Qe = f + (Se + 1) + q * (re + 1),
            et = f + (Se + 1) + q * re;
          (c.push(Ge, Ye, et), c.push(Ye, Qe, et), (G += 6));
        }
...
class _n extends Ds {
  ...
  copy(e) {
    return (
      ...
      (this.uniformsGroups = Dc(e.uniformsGroups)),
...
class Vt extends Jo {
  ...
  getEffectiveFOV() {
    return na * 2 * Math.atan(Math.tan(xs * 0.5 * this.fov) / this.zoom);
  }
  getFilmWidth() {
...
class Tn {
  ...
  setFromCoplanarPoints(e, t, n) {
    const s = or.subVectors(n, t).cross(kc.subVectors(e, t)).normalize();
  ...
  applyMatrix4(e, t) {
    const n = t || Vc.getNormalMatrix(e),
...
class el {
  ...
  setFromProjectionMatrix(e, t = Qt, n = !1) {
    ...
    if (
      ...
      (s[4].setComponents(c, f, p, R).normalize(),
        s[5].setComponents(l - c, m - f, h - p, D - R).normalize());
    else if (
      (s[4].setComponents(l - c, m - f, h - p, D - R).normalize(), t === Qt)
    )
      s[5].setComponents(l + c, m + f, h + p, D + R).normalize();
    else if (t === vs) s[5].setComponents(c, f, p, R).normalize();
    else
      throw new Error(
  ...
  intersectsSprite(e) {
    On.center.set(0, 0, 0);
    const t = Gc.distanceTo(e.center);
    return (
  ...
  intersectsBox(e) {
    ...
    for (let n = 0; n < 6; n++) {
      const s = t[n];
      if (
        ((ls.x = s.normal.x > 0 ? e.max.x : e.min.x),
        (ls.y = s.normal.y > 0 ? e.max.y : e.min.y),
        (ls.z = s.normal.z > 0 ? e.max.z : e.min.z),
        s.distanceToPoint(ls) < 0)
      )
        return !1;
    }
    return !0;
...
class tl extends yt {
  constructor(e, t, n = Wn, s, r, a, o = Ft, c = Ft, l, u = Ni, d = 1) {
    if (u !== Ni && u !== Fi)
      throw new Error(
...
class Ls extends Dn {
  constructor(e = 1, t = 1, n = 1, s = 1) {
    ...
    for (let h = 0; h < u; h++) {
      ...
      for (let y = 0; y < l; y++) {
        const R = y * d - r;
        (g.push(R, -T, 0), M.push(0, 0, 1), p.push(y / o), p.push(1 - h / c));
      }
    }
    for (let h = 0; h < c; h++)
      for (let T = 0; T < o; T++) {
...
#endif`,
  ch = `vec3 objectNormal = vec3( normal );
#ifdef USE_TANGENT
...
#endif`,
  yh = `vec3 transformedNormal = objectNormal;
#ifdef USE_TANGENT
...
transformedNormal = normalMatrix * transformedNormal;
  ...
  Ch = `vec4 LinearTransferOETF( in vec4 value ) {
	return value;
}
...
#endif`,
  eu = `#if defined( USE_LOGARITHMIC_DEPTH_BUFFER )
...
#endif`,
  nu = `#ifdef USE_LOGARITHMIC_DEPTH_BUFFER
	varying float vFragDepth;
	varying float vIsPerspective;
#endif`,
...
#endif`,
  au = `#if defined( USE_MAP ) || defined( USE_ALPHAMAP )
...
#endif`,
  cu = `#ifdef USE_METALNESSMAP
	uniform sampler2D metalnessMap;
#endif`,
  hu = `#ifdef USE_INSTANCING_MORPH
...
#endif`,
  mu = `float faceDirection = gl_FrontFacing ? 1.0 : - 1.0;
#ifdef FLAT_SHADED
...
gl_Position = projectionMatrix * mvPosition;`,
...
#endif`,
  Du = `float roughnessFactor = roughness;
#ifdef USE_ROUGHNESSMAP
	vec4 texelRoughness = texture2D( roughnessMap, vRoughnessMapUv );
	roughnessFactor *= texelRoughness.g;
#endif`,
  Lu = `#ifdef USE_ROUGHNESSMAP
  ...
  Iu = `#if NUM_SPOT_LIGHT_COORDS > 0
	...
	#endif
#endif`,
  Nu = `#if ( defined( USE_SHADOWMAP ) && ( NUM_DIR_LIGHT_SHADOWS > 0 || NUM_POINT_LIGHT_SHADOWS > 0 ) ) || ( NUM_SPOT_LIGHT_COORDS > 0 )
...
#endif`,
  Gu = `#ifdef USE_SPECULARMAP
	uniform sampler2D specularMap;
#endif`,
  Hu = `#if defined( TONE_MAPPING )
...
#endif`,
  ju = `#if defined( USE_ENVMAP ) || defined( DISTANCE ) || defined ( USE_SHADOWMAP ) || defined ( USE_TRANSMISSION ) || NUM_SPOT_LIGHT_COORDS > 0
...
void main() {
  ...
  Ne = {
    ...
    alphamap_pars_fragment: th,
    alphatest_fragment: nh,
    alphatest_pars_fragment: ih,
    aomap_fragment: sh,
    ...
    lights_fragment_maps: Jh,
    lights_fragment_end: Qh,
    ...
    specularmap_fragment: Vu,
    specularmap_pars_fragment: Gu,
    tonemapping_fragment: Hu,
    tonemapping_pars_fragment: Wu,
    transmission_fragment: Xu,
    transmission_pars_fragment: Yu,
    uv_pars_fragment: Zu,
    uv_pars_vertex: qu,
    uv_vertex: Ku,
    worldpos_vertex: ju,
  ...
  Jt = {
    ...
    depth: {
      uniforms: bt([ae.common, ae.displacementmap]),
...
function Ld(i, e, t, n, s, r, a) {
  ...
  let c = r === !0 ? 0 : 1,
    ...
    m = null;
  function g(y) {
    let R = y.isScene === !0 ? y.background : null;
    return (
      R && R.isTexture && (R = (y.backgroundBlurriness > 0 ? t : e).get(R)),
      R
    );
  }
  function M(y) {
    let R = !1;
    const D = g(y);
    D === null ? h(o, c) : D && D.isColor && (h(D, 1), (R = !0));
  ...
  function p(y, R) {
    ...
    D && (D.isCubeTexture || D.mapping === Ps)
      ...
      : D &&
        ...
        (l.material.uniforms.backgroundIntensity.value = R.backgroundIntensity),
        (l.material.toneMapped = We.getTransfer(D.colorSpace) !== Ke),
  ...
  function h(y, R) {
    (y.getRGB(cs, $o(i)), n.buffers.color.setClear(cs.r, cs.g, cs.b, R, a));
  }
  function T() {
...
function Ud(i, e) {
  ...
  function f(v) {
    const C = [],
      B = [],
      V = [];
    for (let H = 0; H < t; H++) ((C[H] = 0), (B[H] = 0), (V[H] = 0));
    return {
      geometry: null,
      program: null,
      wireframe: !1,
  ...
  function y(v, C, B, V, H, q, Y) {
    Y === !0
      ? i.vertexAttribIPointer(v, C, B, H, q)
      : i.vertexAttribPointer(v, C, B, V, H, q);
  }
  function R(v, C, B, V) {
    M();
  ...
  ((this.uniform = c),
    ...
    (this.setState = function (d, f, m) {
      ...
      if (!s || g === null || g.length === 0 || (r && !p)) r ? u(null) : l();
        ...
        ((c.value = R), (R = u(g, f, y, m)));
        for (let D = 0; D !== y; ++D) R[D] = t[D];
        ((h.clippingState = R),
...
class so {
  ...
  fromScene(e, t = 0, n = 0.1, s = 100, r = {}) {
    const { size: a = 256, position: o = zd } = r;
  ...
  _allocateTargets() {
    ...
    if (
      ...
      (({
        ...
        (this._blurMaterial = Gd(r, e, t)));
    }
    return s;
  }
  _compileMaterial(e) {
    const t = new Pt(new Dn(), e);
    this._renderer.compile(t, Di);
  }
  ...
  _textureToCubeUV(e, t) {
    ...
    (hi(t, 0, 0, 3 * c, 2 * c), n.setRenderTarget(t), n.render(a, Di));
  }
  _applyPMREM(e) {
  ...
  _applyGGXFilter(e, t, n) {
    ...
    if (this._ggxMaterial === null) {
      const T = 3 * Math.max(this._cubeSize, 16),
        y = 4 * this._cubeSize;
      this._ggxMaterial = Vd(this._lodMax, T, y);
    }
  ...
  _halfBlur(e, t, n, s, r, a, o) {
    ...
    const R = this._sizeLods[s],
      D = 3 * R * (s > y - wn ? s - y + wn : 0),
      E = 4 * (this._cubeSize - R);
    (hi(t, D, E, 3 * R, 2 * R), c.setRenderTarget(t), c.render(d, Di));
  }
}
function kd(i) {
  const e = [],
  ...
  for (let a = 0; a < r; a++) {
    ...
    (D.setAttribute("position", new en(T, M)),
      ...
      D.setAttribute("faceIndex", new en(R, h)),
      n.push(new Pt(D, null)),
      s > wn && s--);
  }
...
function Wd(i) {
  ...
  return {
    ...
    get: function (n) {
      const s = t(n);
      return (
        s === null && Oi("WebGLRenderer: " + n + " extension not supported."),
        s
      );
    },
  };
...
function Xd(i, e, t, n) {
  ...
  function l(d) {
    ...
    if (m !== null) {
      const T = m.array;
      M = m.version;
      for (let y = 0, R = T.length; y < R; y += 3) {
        const D = T[y + 0],
          E = T[y + 1],
          P = T[y + 2];
        f.push(D, E, E, P, P, D);
      ...
      const T = g.array;
      M = g.version;
      for (let y = 0, R = T.length / 3 - 1; y < R; y += 3) {
        const D = y + 0,
          E = y + 1,
          P = y + 2;
        f.push(D, E, E, P, P, D);
...
function qd(i, e, t) {
  ...
  function r(a, o, c) {
    ...
    if (f === void 0 || f.count !== d) {
      ...
      const E = new Float32Array(R * D * 4 * d),
        P = new Zo(E, R, D, d);
...
function kf(i, e, t) {
  ...
  for (dr.lastIndex = 0; ; ) {
    ...
    if ((c && (o = o | 0), l === void 0 || (l === "[" && a + 2 === s))) {
      mo(t, l === void 0 ? new Of(o, i, e) : new Bf(o, i, e));
      break;
    } else {
      let d = t.map[o];
      (d === void 0 && ((d = new zf(o)), mo(t, d)), (t = d));
    }
  }
}
class _s {
...
const hs = new F();
function Zf() {
  We.getLuminanceCoefficients(hs);
  const i = hs.x.toFixed(4),
    e = hs.y.toFixed(4),
    t = hs.z.toFixed(4);
  return [
...
`)),
      (h = [
        ...
        t.toneMapping !== Rn ? Ne.tonemapping_pars_fragment : "",
        t.toneMapping !== Rn ? Yf("toneMapping", t.toneMapping) : "",
        t.dithering ? "#define DITHERING" : "",
        t.opaque ? "#define OPAQUE" : "",
        Ne.colorspace_pars_fragment,
        Xf("linearToOutputTexel", t.outputColorSpace),
        Zf(),
...
` +
    ...
    (s.deleteShader(D), s.deleteShader(E), (z = new _s(s, M)), (S = jf(s, M)));
  }
  let z;
  ...
  return (
    (this.isReady = function () {
      return (v === !1 && (v = s.getProgramParameter(M, Vf)), v);
    }),
...
function up(i, e, t, n, s, r, a) {
  ...
  function p(S, v, C, B, V) {
    ...
    if (te) {
      const Ze = Jt[te];
      ((Ye = Ze.vertexShader), (Qe = Ze.fragmentShader));
    } else
      ((Ye = S.vertexShader),
        (Qe = S.fragmentShader),
        c.update(S),
    ...
    const nt = {
      ...
      emissiveMap: me,
      normalMapObjectSpace: ke && S.normalMapType === nc,
      normalMapTangentSpace: ke && S.normalMapType === tc,
      metalnessMap: rt,
      roughnessMap: Me,
      anisotropy: Pe,
      anisotropyMap: k,
  ...
  function D(S, v) {
    ...
    return (C === void 0 && ((C = new op(i, v, S, r)), u.push(C)), C);
  }
  function E(S) {
    if (--S.usedTimes === 0) {
      const v = u.indexOf(S);
...
function vp(i) {
  ...
  function o(l) {
    ...
    for (let S = 0, v = l.length; S < v; S++) {
      ...
      if (C.isAmbientLight) ((u += B.r * V), (d += B.g * V), (f += B.b * V));
      else if (C.isLightProbe) {
        for (let Y = 0; Y < 9; Y++)
          n.probe[Y].addScaledVector(C.sh.coefficients[Y], V);
        P++;
        ...
        const Y = e.get(C);
        (Y.skyColor.copy(C.color).multiplyScalar(V),
          Y.groundColor.copy(C.groundColor).multiplyScalar(V),
          (n.hemi[h] = Y),
          h++);
      }
    }
    ...
    (z.directionalLength !== m ||
      ...
      (n.spotLightMatrix.length = R + D - E),
  ...
  function c(l, u) {
    ...
    for (let h = 0, T = l.length; h < T; h++) {
      ...
      if (y.isDirectionalLight) {
        ...
        (R.direction.setFromMatrixPosition(y.matrixWorld),
        ...
        const R = n.spot[m];
        (R.position.setFromMatrixPosition(y.matrixWorld),
        ...
        (R.position.setFromMatrixPosition(y.matrixWorld),
          ...
          r.premultiply(p),
          a.extractRotation(r),
          R.halfWidth.set(y.width * 0.5, 0, 0),
          R.halfHeight.set(0, y.height * 0.5, 0),
...
function yp(i, e, t) {
  ...
  function R(E, P, z, S, v) {
    ...
    const B = E.children;
    for (let V = 0, H = B.length; V < H; V++) R(B[V], P, z, S, v);
  }
  function D(E) {
...
function Tp(i, e) {
  function t() {
    ...
    return {
      ...
      setClear: function (J, Z, fe, Ce, nt) {
        (nt === !0 && ((J *= Ce), (Z *= Ce), (fe *= Ce)),
          le.set(J, Z, fe, Ce),
          se.equals(le) === !1 && (i.clearColor(J, Z, fe, Ce), se.copy(le)));
      },
      reset: function () {
  ...
  function s() {
    ...
    return {
      setTest: function (Ze) {
        w || (Ze ? j(i.STENCIL_TEST) : de(i.STENCIL_TEST));
      },
      setMask: function (Ze) {
        le !== Ze && !w && (i.stencilMask(Ze), (le = Ze));
      },
      setFunc: function (Ze, jt, Ht) {
        (ie !== Ze || se !== jt || J !== Ht) &&
          (i.stencilFunc(Ze, jt, Ht), (ie = Ze), (se = jt), (J = Ht));
      },
      setOp: function (Ze, jt, Ht) {
        (Z !== Ze || fe !== jt || Ce !== Ht) &&
          (i.stencilOp(Ze, jt, Ht), (Z = Ze), (fe = jt), (Ce = Ht));
      },
      setLocked: function (Ze) {
        w = Ze;
      },
      setClear: function (Ze) {
        nt !== Ze && (i.clearStencil(Ze), (nt = Ze));
      },
      reset: function () {
        ((w = !1),
          (le = null),
  ...
  const gt = {
    [kn]: i.FUNC_ADD,
    [Al]: i.FUNC_SUBTRACT,
    [wl]: i.FUNC_REVERSE_SUBTRACT,
  };
  ((gt[Rl] = i.MIN), (gt[Cl] = i.MAX));
  const Fe = {
    [Pl]: i.ZERO,
    [Dl]: i.ONE,
    [Ll]: i.SRC_COLOR,
    [mr]: i.SRC_ALPHA,
    [Bl]: i.SRC_ALPHA_SATURATE,
    [Fl]: i.DST_COLOR,
    [Il]: i.DST_ALPHA,
    [Ul]: i.ONE_MINUS_SRC_COLOR,
    [xr]: i.ONE_MINUS_SRC_ALPHA,
    [Ol]: i.ONE_MINUS_DST_COLOR,
    [Nl]: i.ONE_MINUS_DST_ALPHA,
    [zl]: i.CONSTANT_COLOR,
    [kl]: i.ONE_MINUS_CONSTANT_COLOR,
    [Vl]: i.CONSTANT_ALPHA,
    [Gl]: i.ONE_MINUS_CONSTANT_ALPHA,
  };
  function st(w, le, ie, se, J, Z, fe, Ce, nt, Ze) {
    if (w === fn) {
      M === !0 && (de(i.BLEND), (M = !1));
      return;
    }
    if ((M === !1 && (j(i.BLEND), (M = !0)), w !== Tl)) {
      if (w !== p || Ze !== S) {
        if (
          ((h !== kn || R !== kn) &&
            (i.blendEquation(i.FUNC_ADD), (h = kn), (R = kn)),
          Ze)
        )
          switch (w) {
            case mi:
    ...
    ((J = J || le),
      ...
      (fe = fe || se),
      (le !== h || J !== R) &&
        (i.blendEquationSeparate(gt[le], gt[J]), (h = le), (R = J)),
      (ie !== T || se !== y || Z !== D || fe !== E) &&
        ...
        (E = fe)),
      (Ce.equals(P) === !1 || nt !== z) &&
        (i.blendColor(Ce.r, Ce.g, Ce.b, nt), P.copy(Ce), (z = nt)),
      (p = w),
      (S = !1));
  }
  function A(w, le) {
  ...
  function ee(w) {
    Ye.equals(w) === !1 && (i.scissor(w.x, w.y, w.z, w.w), Ye.copy(w));
  }
  function Ae(w) {
...
function Ap(i, e, t, n, s, r, a) {
  ...
  function y(b, x, I, W, K = !1) {
    ...
    if (
      ...
      const _e = K ? gs : We.getTransfer(W);
      (I === i.FLOAT && (k = i.RGBA32F),
        I === i.HALF_FLOAT && (k = i.RGBA16F),
        I === i.UNSIGNED_BYTE && (k = _e === Ke ? i.SRGB8_ALPHA8 : i.RGBA8),
    ...
    if (k.length === 0)
      ...
      for (let $ = 0, ee = k.length; $ < ee; $++) {
        ...
        (i.pixelStorei(i.UNPACK_SKIP_PIXELS, Re),
          ...
          t.texSubImage2D(i.TEXTURE_2D, 0, Re, w, le, ie, I, W, x.data));
      }
      (b.clearUpdateRanges(),
    ...
    if (k.version !== _e.__version || K === !0) {
      ...
      if (x.isDepthTexture)
        ...
        if (Re.length > 0) {
          w &&
            le &&
            t.texStorage2D(i.TEXTURE_2D, se, Ee, Re[0].width, Re[0].height);
          for (let J = 0, Z = Re.length; J < Z; J++)
            ((he = Re[J]),
              w
                ? ie &&
                  t.texSubImage2D(
  ...
  function j(b, x, I) {
    ...
    if (K.version !== k.__version || W === !0) {
      ...
      const Ae = ee[0],
        ...
        he = r.convert(x.type),
        Re = y(x.internalFormat, Ee, he, x.colorSpace),
        w = x.isVideoTexture !== !0,
      ...
      if (xe) {
        w &&
          le &&
          t.texStorage2D(i.TEXTURE_CUBE_MAP, se, Re, Ae.width, Ae.height);
        for (let Z = 0; Z < 6; Z++) {
          J = ee[Z].mipmaps;
        ...
        if (((J = x.mipmaps), w && le)) {
          J.length > 0 && se++;
          const Z = Pe(ee[0]);
          t.texStorage2D(i.TEXTURE_CUBE_MAP, se, Re, Z.width, Z.height);
        }
        for (let Z = 0; Z < 6; Z++)
          if ($) {
            w
  ...
  function t(n, s = An) {
    ...
    if (n === Rr || n === Cr || n === Pr || n === Dr)
      if (((r = e.get("WEBGL_compressed_texture_pvrtc")), r !== null)) {
        if (n === Rr) return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;
...
class Pp {
  ...
  getMesh(e) {
    if (this.texture !== null && this.mesh === null) {
      ...
      this.mesh = new Pt(new Ls(20, 20), n);
    }
    return this.mesh;
  }
  reset() {
        ...
        if (((s = X), s !== null)) {
          if (
            ...
            ((d = this.getBinding()),
              ...
              (R = new Yn(f.textureWidth, f.textureHeight, {
                format: qt,
                type: mn,
                depthTexture: new tl(
                  f.textureWidth,
            ...
            ((m = new XRWebGLLayer(s, t, de)),
              ...
              (R = new Yn(m.framebufferWidth, m.framebufferHeight, {
                format: qt,
                type: mn,
                colorSpace: e.outputColorSpace,
                stencilBuffer: T.stencil,
      ...
      : h.isMeshToonMaterial
        ...
        : h.isMeshPhongMaterial
          ...
          : h.isMeshStandardMaterial
            ? (r(p, h), f(p, h), h.isMeshPhysicalMaterial && m(p, h, R))
  ...
  function r(p, h) {
    ...
    (y &&
      ...
      y.isCubeTexture &&
        ...
        ((zn.y *= -1), (zn.z *= -1)),
      p.envMapRotation.value.setFromMatrix4(Lp.makeRotationFromEuler(zn)),
      (p.flipEnvMap.value =
    ...
    ((p.ior.value = h.ior),
      ...
      h.clearcoat > 0 &&
        ...
        h.clearcoatNormalMap &&
          ...
          h.side === Ct && p.clearcoatNormalScale.value.negate())),
...
function Ip(i, e, t, n) {
  ...
  function l(T, y) {
    let R = s[T.id];
    R === void 0 &&
      (g(T), (R = u(T)), (s[T.id] = R), T.addEventListener("dispose", p));
    const D = y.program;
  ...
  function u(T) {
    ...
    return (
      ...
      i.bindBufferBase(i.UNIFORM_BUFFER, y, R),
      R
    );
  }
  function d() {
  ...
  function f(T) {
    ...
    for (let E = 0, P = R.length; E < P; E++) {
      const z = Array.isArray(R[E]) ? R[E] : [R[E]];
      for (let S = 0, v = z.length; S < v; S++) {
        const C = z[S];
        if (m(C, E, S, D) === !0) {
          const B = C.__offset,
            V = Array.isArray(C.value) ? C.value : [C.value];
          let H = 0;
  ...
  function g(T) {
    ...
    const E = R % D;
    return (E > 0 && (R += D - E), (T.__size = R), (T.__cache = {}), this);
  }
  function M(T) {
  ...
  function p(T) {
    ...
    const R = a.indexOf(y.__bindingPointIndex);
    (a.splice(R, 1), i.deleteBuffer(s[y.id]), delete s[y.id], delete r[y.id]);
  }
  function h() {
  ...
  constructor(e = {}) {
    ...
    function ie() {
      ((ke = new Wd(A)),
        ...
        (Ae = new qd(A, tt, Pe)),
        (xe = new Fd(Me)),
        (k = new up(E, b, x, ke, tt, w, xe)),
        (_e = new Up(E, Me)),
        (oe = new pp()),
        (be = new Mp(ke)),
        (ee = new Ld(E, b, x, me, K, m, c)),
        ($ = new yp(E, K, tt)),
        (le = new Ip(A, rt, tt, me)),
        (Ee = new Id(A, ke, rt)),
        (he = new Yd(A, ke, rt)),
    ...
    ((this.xr = se),
      ...
      (this.setViewport = function (_, L, N, O) {
        (_.isVector4 ? Ye.set(_.x, _.y, _.z, _.w) : Ye.set(_, L, N, O),
          me.viewport(V.copy(Ye).multiplyScalar(re).round()));
      }),
    ...
    function Ce(_) {
      const L = _.target;
      (L.removeEventListener("dispose", Ce), nt(L));
    }
    function nt(_) {
      (Ze(_), Me.remove(_));
    }
    ...
    this.renderBufferDirect = function (_, L, N, O, U, Q) {
      ...
      (Q !== null &&
        ...
        ue !== null
          ? ((Ve = Math.max(Ve, 0)), (qe = Math.min(qe, ue.count)))
          : ve != null &&
            ((Ve = Math.max(Ve, 0)), (qe = Math.min(qe, ve.count))));
      const lt = qe - Ve;
      ...
      if (U.isBatchedMesh)
        if (U._multiDrawInstances !== null)
          ...
          const ye = U._multiDrawStarts,
            ...
            Dt = ue ? I.get(ue).bytesPerElement : 1,
            jn = Me.get(O).currentProgram.getUniforms();
          for (let Lt = 0; Lt < He; Lt++)
            (jn.setValue(A, "_gl_DrawID", Lt), Je.render(ye[Lt] / Dt, at[Lt]));
        }
    ...
    function ya(_, L, N, O) {
      ...
      if (
        ...
        let Ve = !1;
        for (let qe = 0, lt = L.length; qe < lt; qe++) {
          const ct = L[qe],
    ...
    function Ta(_) {
      if (_.uniformsList === null) {
        ...
        _.uniformsList = _s.seqWithValue(L.seq, _.uniforms);
      }
    ...
    function xl(_, L, N, O, U) {
      ...
      let Dt = ye.currentProgram;
      He === !0 && (Dt = Hi(O, L, U));
      let jn = !1,
        Lt = !1,
        Ti = !1;
      const ot = Dt.getUniforms(),
        Et = ye.uniforms;
      if (
        (me.useProgram(Dt.program) && ((jn = !0), (Lt = !0), (Ti = !0)),
        O.id !== C && ((C = O.id), (Lt = !0)),
        jn || B !== _)
      ) {
        ...
        const Tt = ot.map.cameraPosition;
        (Tt !== void 0 &&
          Tt.setValue(A, ge.setFromMatrixPosition(_.matrixWorld)),
      ...
      if (U.isSkinnedMesh) {
        ...
        St &&
          ...
          ot.setValue(A, "boneTexture", St.boneTexture, Pe));
      }
      U.isBatchedMesh &&
      ...
      if (
        ((Bt.position !== void 0 ||
          ...
          Bt.color !== void 0) &&
          Ae.update(U, N, Dt),
        (Lt || ye.receiveShadow !== U.receiveShadow) &&
        ...
        Et.dfgLUT !== void 0 && (Et.dfgLUT.value = Fp()),
        Lt &&
          (ot.setValue(A, "toneMappingExposure", E.toneMappingExposure),
          ye.needsLights && _l(Et, Ti),
          ...
          _s.upload(A, Ta(ye), Et, Pe)),
        O.isShaderMaterial &&
          O.uniformsNeedUpdate === !0 &&
          (_s.upload(A, Ta(ye), Et, Pe), (O.uniformsNeedUpdate = !1)),
        ...
        const St = O.uniformsGroups;
        for (let Tt = 0, Os = St.length; Tt < Os; Tt++) {
          const Un = St[Tt];
          (le.update(Un, Dt), le.bind(Un, Dt));
        }
      }
      return Dt;
    }
    ...
    ((this.setRenderTarget = function (_, L = 0, N = 0) {
      ...
      if (_) {
        ...
        (V.copy(Ye).multiplyScalar(re).floor(),
    ...
    ((this.copyTextureToTexture = function (
      ...
      Q === null &&
        (U !== 0
          ? (Oi(
            ...
            (U = 0))
          : (Q = 0));
      let ce, pe, ue, Te, we, ve, Ve, qe, lt;
      ...
      O !== null
        ? ((Ve = O.x), (qe = O.y), (lt = O.z))
        : ((Ve = 0), (qe = 0), (lt = 0));
      const Je = Re.convert(L.format),
        ye = Re.convert(L.type);
      let at;
      (L.isData3DTexture
      ...
      const He = A.getParameter(A.UNPACK_ROW_LENGTH),
        Dt = A.getParameter(A.UNPACK_IMAGE_HEIGHT),
        jn = A.getParameter(A.UNPACK_SKIP_PIXELS),
        Lt = A.getParameter(A.UNPACK_SKIP_ROWS),
        Ti = A.getParameter(A.UNPACK_SKIP_IMAGES);
      ...
      if (_.isDepthTexture) {
        const Bt = Me.get(_),
          St = Me.get(L),
          Tt = Me.get(Bt.__renderTarget),
          Os = Me.get(St.__renderTarget);
        (me.bindFramebuffer(A.READ_FRAMEBUFFER, Tt.__webglFramebuffer),
        ...
        const Bt = Me.get(_),
          St = Me.get(L);
        (me.bindFramebuffer(A.READ_FRAMEBUFFER, Ml),
          me.bindFramebuffer(A.DRAW_FRAMEBUFFER, Sl));
        for (let Tt = 0; Tt < ue; Tt++)
          (ot
            ...
            U !== 0
              ...
              : Et
                ? A.copyTexSubImage3D(at, Q, Ve, qe, lt + Tt, Te, we, ce, pe)
                : A.copyTexSubImage2D(at, Q, Ve, qe, Te, we, ce, pe));
        (me.bindFramebuffer(A.READ_FRAMEBUFFER, null),
          me.bindFramebuffer(A.DRAW_FRAMEBUFFER, null));
      } else
        Et
          ? _.isDataTexture || _.isData3DTexture
            ? A.texSubImage3D(at, Q, Ve, qe, lt, ce, pe, ue, Je, ye, ct.data)
            : L.isCompressedArrayTexture
              ...
              : A.texSubImage3D(at, Q, Ve, qe, lt, ce, pe, ue, Je, ye, ct)
          : _.isDataTexture
            ? A.texSubImage2D(A.TEXTURE_2D, Q, Ve, qe, ce, pe, Je, ye, ct.data)
            : _.isCompressedTexture
              ...
              : A.texSubImage2D(A.TEXTURE_2D, Q, Ve, qe, ce, pe, Je, ye, ct);
      (A.pixelStorei(A.UNPACK_ROW_LENGTH, He),
        A.pixelStorei(A.UNPACK_IMAGE_HEIGHT, Dt),
        A.pixelStorei(A.UNPACK_SKIP_PIXELS, jn),
        A.pixelStorei(A.UNPACK_SKIP_ROWS, Lt),
        A.pixelStorei(A.UNPACK_SKIP_IMAGES, Ti),
...
class zp extends Kc {
  constructor(e, t = null) {
    (super(e, t),
      ...
      (this._onPointerMove = Vp.bind(this)),
      (this._onPointerDown = kp.bind(this)),
      (this._onPointerUp = Gp.bind(this)),
      (this._onContextMenu = Kp.bind(this)),
      (this._onMouseWheel = Xp.bind(this)),
      (this._onKeyDown = Yp.bind(this)),
      (this._onTouchStart = Zp.bind(this)),
      (this._onTouchMove = qp.bind(this)),
      (this._onMouseDown = Hp.bind(this)),
      (this._onMouseMove = Wp.bind(this)),
      (this._interceptControlDown = jp.bind(this)),
      (this._interceptControlUp = $p.bind(this)),
  ...
  update(e = null) {
    ...
    (isFinite(n) &&
      isFinite(s) &&
      (n < -Math.PI ? (n += wt) : n > Math.PI && (n -= wt),
      s < -Math.PI ? (s += wt) : s > Math.PI && (s -= wt),
      n <= s
    ...
    if (
      ...
      a !== null &&
        (this.screenSpacePanning
          ...
          : (us.origin.copy(this.object.position),
            us.direction.set(0, 0, -1).transformDirection(this.object.matrix),
            Math.abs(this.object.up.dot(us.direction)) < Bp
              ? this.object.lookAt(this.target)
              : (wo.setFromNormalAndCoplanarPoint(this.object.up, this.target),
                us.intersectPlane(wo, this.target))));
    } else if (this.object.isOrthographicCamera) {
  ...
  _getAutoRotationAngle(e) {
    return e !== null
      ? (wt / 60) * this.autoRotateSpeed * e
      : (wt / 60 / 60) * this.autoRotateSpeed;
  }
  _getZoomScale(e) {
  ...
  _handleMouseMoveRotate(e) {
    ...
    (this._rotateLeft((wt * this._rotateDelta.x) / t.clientHeight),
    ...
    switch (e.code) {
      case this.keys.UP:
        (e.ctrlKey || e.metaKey || e.shiftKey
          ? this.enableRotate &&
            this._rotateUp(
              (wt * this.keyRotateSpeed) / this.domElement.clientHeight,
            )
...
async function ga() {
  const i = await em(() => import("./ammo-B9oaJM7s.js").then((t) => t.a), []),
    e = i.default ?? i;
...
class cl {
  ...
  async init(e) {
    ...
    ((this.physicsWorld = t),
      ...
      (this.uiText.textContent = Xe.getText("controls")),
      this.makeGround(),
      this.makeWalls(),
      this.makePlayer(),
      this.makeGoal(),
  ...
  handleFalseChestEvent() {
    this.falseChests.forEach((e) => {
      if (!this.win && this.isNear(this.playerMesh, e, 1)) {
        ...
        t.textContent = Xe.getText("incorrect_chest");
      }
    });
  }
  makeTrueChest() {
  ...
  handleBarrierEvent() {
    ...
    (Nt.getGameStateInventory().Collectable?.quantity ?? 0) >=
    this.collectableCount
      ? this.openBarrier()
      : (this.uiText.textContent = Xe.getText("need_more_coins"));
  }
  openBarrier() {
    ((this.barrierOpen = !0),
      (this.uiText.textContent = Xe.getText("bank_opened")));
    ...
    ((this.barrierMeshes = []),
      (this.barrierBodies = []),
      Nt.removeItem("Collectable", this.collectableCount),
      this.onSaveGame?.());
  }
  handleTrueChestEvent() {
    !this.win &&
      ...
      ((this.uiText.textContent = Xe.getText("key_acquired")),
  ...
  handleGoalKeyEvents() {
    (!this.keyPickedUp &&
      ...
      (this.uiText.textContent = Xe.getText("need_key")),
      this.key &&
  ...
  onCollect(e) {
    if (
      (e.userData.type == "Key" && this.pickupKey(e),
      e.userData.type == "Collectable")
    ) {
      const t = 0.2 + Math.random() * 0.55;
      (Nt.addItem("Collectable", t), this.scene.remove(e), this.onSaveGame?.());
    }
  }
}
class hl {
...
async function ki(i) {
  ...
  (Rt && (Rt.onExit(), (Rt.onSceneLeave = void 0), (Rt.onSaveGame = void 0)),
    (Rt = i),
    await Rt.init(fi),
    (Rt.onSceneLeave = (e) => ki(e)),
    (Rt.onSaveGame = () => Io()),
    (Rt.onGameComplete = () => {
      qn && (console.log("Win!"), qn.classList.add("visible"));
    }),
    Rt.onEnter(),
    (Zn = !1),
    Io());
...
const Pn = document.getElementById("start-screen"),
  Ss = document.getElementById("start-button"),
  bs = document.getElementById("level-button"),
  tn = document.getElementById("level-select-screen"),
  Lo = document.querySelector("#level-select-screen .level-title"),
  ys = document.getElementById("level1-button"),
  Es = document.getElementById("level2-button"),
  Ts = document.getElementById("level3-button"),
  ...
  Rs = document.getElementById("restart-button"),
  Cs = document.getElementById("language-button");
...
gn.subscribe((i) => {
  (document.documentElement.setAttribute("data-theme", i),
    ...
    Vi.setClearColor(ui.clearColor, 1));
});
function dl() {
  (Ss && (Ss.textContent = Xe.getText("start_button")),
    Cs && (Cs.textContent = Xe.getText("language_button")),
    ws && (ws.textContent = Xe.getText("end_text")),
    Rs && (Rs.textContent = Xe.getText("restart_button")),
    bs && (bs.textContent = Xe.getText("level_button")),
    Lo && (Lo.textContent = Xe.getText("level_select_title")),
    ys && (ys.textContent = Xe.getText("level1_button")),
    Es && (Es.textContent = Xe.getText("level2_button")),
    Ts && (Ts.textContent = Xe.getText("level3_button")),
    As && (As.textContent = Xe.getText("back_button")));
}
const pr = ["en", "jp", "ar"];
Cs &&
  Cs.addEventListener("click", () => {
    const i = Xe.getLanguage(),
      e = pr.indexOf(i),
      t = pr[(e + 1) % pr.length];
    Xe.setLanguage(t);
  });
Ss &&
  Ss.addEventListener("click", async () => {
    Zn || (Pn?.classList.remove("visible"), await ki(new ul()));
  });
bs &&
...
ys &&
  ys.addEventListener("click", async () => {
    Zn || (tn?.classList.remove("visible"), await ki(new ul()));
  });
Es &&
  Es.addEventListener("click", async () => {
    Zn || (tn?.classList.remove("visible"), await ki(new hl()));
  });
Ts &&
  Ts.addEventListener("click", async () => {
    Zn || (tn?.classList.remove("visible"), await ki(new cl()));
  });
As &&
...
Rs &&
  Rs.addEventListener("click", () => {
    (sm(), qn?.classList.remove("visible"), Pn?.classList.add("visible"));
  });
const fl = new zp(Ns, Vi.domElement);
fl.enabled = !1;
const nm = new Zc();
...
im();
gn.init();
await Xe.initalizeRecord();
Xe.subscribe(() => dl());
dl();
function pl() {
  requestAnimationFrame(pl);
  const i = nm.getDelta();
  (fl.update(), Rt && !Zn && Rt.update(i), Vi.render(fi, Ns));
}
pl();
function Io() {
  const i = { inventory: Nt.getGameStateInventory() };
  (localStorage.setItem("gameSave", JSON.stringify(i)),
    console.log("Game saved with inventory: ", Nt.getGameStateInventory()));
}
function im() {
  const i = localStorage.getItem("gameSave");
  if (!i) return;
  const e = JSON.parse(i);
  (Nt.setGameStateInventory(e.inventory),
    console.log("Loaded game with inventory: ", Nt.getGameStateInventory()));
}
function sm() {
  (localStorage.removeItem("gameSave"),
    Nt.setGameStateInventory({}),
    alert(Xe.getText("new_game")));
}
