...
function Dc() {
  const i = {
        ...
        return (
          this.enabled === !1 ||
            ...
            (this.spaces[s].transfer === Ke &&
              ((r.r = on(r.r)), (r.g = on(r.g)), (r.b = on(r.b))),
            ...
            this.spaces[a].transfer === Ke &&
              ((r.r = ti(r.r)), (r.g = ti(r.g)), (r.b = ti(r.b)))),
          r
        );
      },
      ...
      getTransfer: function (r) {
        return r === _n ? tr : this.spaces[r].transfer;
      },
  ...
  static sRGBToLinear(e) {
    if (
      ...
      const r = n.getImageData(0, 0, e.width, e.height),
        s = r.data;
      for (let a = 0; a < s.length; a++) s[a] = on(s[a] / 255) * 255;
      return (n.putImageData(r, 0, 0), t);
    } else if (e.data) {
      const t = e.data.slice(0);
      for (let n = 0; n < t.length; n++)
        t instanceof Uint8Array || t instanceof Uint8ClampedArray
          ? (t[n] = Math.floor(on(t[n] / 255) * 255))
          : (t[n] = on(t[n]));
    ...
    if (r !== null) {
      ...
      if (Array.isArray(r)) {
        ...
        for (let a = 0, o = r.length; a < o; a++)
          r[a].isDataTexture ? s.push(_r(r[a].image)) : s.push(_r(r[a]));
      } else s = _r(r);
      n.url = s;
    }
...
class Ai {
    ...
    if (n !== void 0) {
      ...
      if (t === !0 && s !== void 0 && e.isInstancedMesh !== !0)
        for (let a = 0, o = s.count; a < o; a++)
          (e.isMesh === !0
            ? e.getVertexPosition(a, Bt)
            : Bt.fromBufferAttribute(s, a),
  ...
  intersectsSphere(e) {
    return (
      this.clampPoint(e.center, Bt),
      Bt.distanceToSquared(e.center) <= e.radius * e.radius
    );
  }
  intersectsPlane(e) {
    let t, n;
  ...
  intersectsTriangle(e) {
    ...
    (this.getCenter(fi),
      Di.subVectors(this.max, fi),
      Gn.subVectors(e.a, fi),
      Hn.subVectors(e.b, fi),
      kn.subVectors(e.c, fi),
      dn.subVectors(Hn, Gn),
      fn.subVectors(kn, Hn),
      yn.subVectors(Gn, kn));
    let t = [
    ...
    return !vr(t, Gn, Hn, kn, Di) ||
      ((t = [1, 0, 0, 0, 1, 0, 0, 0, 1]), !vr(t, Gn, Hn, kn, Di))
      ? !1
      : (Li.crossVectors(dn, fn),
        (t = [Li.x, Li.y, Li.z]),
        vr(t, Gn, Hn, kn, Di));
  }
  clampPoint(e, t) {
    ...
    return (
      this.isEmpty()
        ...
        : (this.getCenter(e.center),
          (e.radius = this.getSize(Bt).length() * 0.5)),
      e
    );
  }
  intersect(e) {
...
class Gs {
  ...
  setFromPoints(e, t) {
    const n = this.center;
    t !== void 0 ? n.copy(t) : Oc.setFromPoints(e).getCenter(n);
    let r = 0;
      ...
      : this.isEmpty()
        ...
        : (this.center.equals(e.center) === !0
            ...
            : (Mr.subVectors(e.center, this.center).setLength(e.radius),
              this.expandByPoint(hi.copy(e.center).add(Mr)),
              this.expandByPoint(hi.copy(e.center).sub(Mr))),
          this);
  }
  equals(e) {
...
class mo {
  ...
  distanceSqToPoint(e) {
    ...
    return t < 0
      ...
      : (Zt.copy(this.origin).addScaledVector(this.direction, t),
        Zt.distanceToSquared(e));
  }
  distanceSqToSegment(e, t, n, r) {
    (Sr.copy(e).add(t).multiplyScalar(0.5),
      Ui.copy(t).sub(e).normalize(),
      hn.copy(this.origin).sub(Sr));
    const s = e.distanceTo(t) * 0.5,
      a = -this.direction.dot(Ui),
      o = hn.dot(this.direction),
      l = -hn.dot(Ui),
      c = hn.lengthSq(),
      u = Math.abs(1 - a * a);
    let f, h, m, g;
    ...
    return (
      ...
      r && r.copy(Sr).addScaledVector(Ui, h),
      m
    );
  }
  intersectSphere(e, t) {
  ...
  intersectTriangle(e, t, n, r, s) {
    (br.subVectors(t, e), Ii.subVectors(n, e), Er.crossVectors(br, Ii));
    let a = this.direction.dot(Er),
      o;
    if (a > 0) {
      if (r) return null;
      o = 1;
    ...
    const l = o * this.direction.dot(Ii.crossVectors(hn, Ii));
    if (l < 0) return null;
    const c = o * this.direction.dot(br.cross(hn));
...
class ut {
  ...
  lookAt(e, t, n) {
    ...
    return (
      ...
      wt.normalize(),
      pn.crossVectors(n, wt),
      pn.lengthSq() === 0 &&
        (Math.abs(n.z) === 1 ? (wt.x += 1e-4) : (wt.z += 1e-4),
        wt.normalize(),
        pn.crossVectors(n, wt)),
      pn.normalize(),
      Ni.crossVectors(wt, pn),
      (r[0] = pn.x),
      (r[4] = Ni.x),
      (r[8] = wt.x),
      (r[1] = pn.y),
  ...
  multiplyMatrices(e, t) {
    ...
    return (
      ...
      (s[3] = T * y + E * v + R * k + D * H),
      (s[7] = T * P + E * C + R * K + D * te),
      (s[11] = T * B + E * O + R * q + D * se),
      (s[15] = T * S + E * G + R * ne + D * Se),
      this
    );
  }
  multiplyScalar(e) {
  ...
  invert() {
    const e = this.elements,
      ...
      D = g * f * l - u * M * l - g * o * h + a * M * h + u * o * p - a * f * p,
      y = t * T + n * E + r * R + s * D;
    if (y === 0)
  ...
  makePerspective(e, t, n, r, s, a, o = Yt, l = !1) {
    ...
    else if (o === Yt) ((g = -(a + s) / (a - s)), (M = (-2 * a * s) / (a - s)));
    else if (o === nr) ((g = -a / (a - s)), (M = (-a * s) / (a - s)));
    else
      throw new Error(
  ...
  makeOrthographic(e, t, n, r, s, a, o = Yt, l = !1) {
    const c = this.elements,
      u = 2 / (t - e),
      f = 2 / (n - r),
      h = -(t + e) / (t - e),
    ...
    else if (o === Yt) ((g = -2 / (a - s)), (M = -(a + s) / (a - s)));
    else if (o === nr) ((g = -1 / (a - s)), (M = -s / (a - s)));
    else
      throw new Error(
...
class ln {
  ...
  setFromQuaternion(e, t, n) {
    return (
      fa.makeRotationFromQuaternion(e),
      this.setFromRotationMatrix(fa, t, n)
    );
  }
...
const pa = new z(),
  ...
  ga = { type: "added" },
  kc = { type: "removed" },
  qn = { type: "childadded", child: null },
  yr = { type: "childremoved", child: null };
class Dt extends ci {
  constructor() {
    (super(),
      (this.isObject3D = !0),
  ...
  translateOnAxis(e, t) {
    return (
      pa.copy(e).applyQuaternion(this.quaternion),
      this.position.add(pa.multiplyScalar(t)),
      this
    );
  }
  translateX(e) {
  ...
  lookAt(e, t, n) {
    ...
    (this.updateWorldMatrix(!0, !1),
      ...
      this.isCamera || this.isLight
        ? jt.lookAt(pi, Fi, this.up)
        : jt.lookAt(Fi, pi, this.up),
      this.quaternion.setFromRotationMatrix(jt),
      r &&
        (jt.extractRotation(r.matrixWorld),
        Xn.setFromRotationMatrix(jt),
        this.quaternion.premultiply(Xn.invert())));
  }
  add(e) {
  ...
  getWorldQuaternion(e) {
    return (
      this.updateWorldMatrix(!0, !1),
      this.matrixWorld.decompose(pi, e, Gc),
      e
    );
  }
  getWorldScale(e) {
    return (
      this.updateWorldMatrix(!0, !1),
      this.matrixWorld.decompose(pi, Hc, e),
      e
    );
  }
  getWorldDirection(e) {
...
class Ht {
  ...
  static getBarycoord(e, t, n, r, s) {
    (Vt.subVectors(r, t), Jt.subVectors(n, t), Tr.subVectors(e, t));
    const a = Vt.dot(Vt),
      o = Vt.dot(Jt),
      l = Vt.dot(Tr),
      c = Jt.dot(Jt),
  ...
  static getInterpolation(e, t, n, r, s, a, o, l) {
    return this.getBarycoord(e, t, n, r, Qt) === null
      ...
      : (l.setScalar(0),
        ...
        l.addScaledVector(a, Qt.y),
        l.addScaledVector(o, Qt.z),
        l);
  }
  static getInterpolatedAttribute(e, t, n, r, s, a) {
    return (
      ...
      Pr.setScalar(0),
      Dr.setScalar(0),
      Cr.fromBufferAttribute(e, t),
      Pr.fromBufferAttribute(e, n),
      Dr.fromBufferAttribute(e, r),
      a.setScalar(0),
      a.addScaledVector(Cr, s.x),
      a.addScaledVector(Pr, s.y),
      a.addScaledVector(Dr, s.z),
      a
    );
  }
  ...
  closestPointToPoint(e, t) {
    const n = this.a,
      ...
      s = this.c;
    let a, o;
    (Yn.subVectors(r, n), Kn.subVectors(s, n), Ar.subVectors(e, n));
    const l = Yn.dot(Ar),
      c = Kn.dot(Ar);
    ...
    const h = l * f - u * c;
    if (h <= 0 && l >= 0 && u <= 0)
      return ((a = l / (l - u)), t.copy(n).addScaledVector(Yn, a));
    Rr.subVectors(e, s);
    const m = Yn.dot(Rr),
      g = Kn.dot(Rr);
    ...
    if (p <= 0 && f - u >= 0 && m - g >= 0)
      return (
        va.subVectors(s, r),
        (o = (f - u) / (f - u + (m - g))),
        t.copy(r).addScaledVector(va, o)
      );
    const d = 1 / (p + M + h);
    return (
      (a = M * d),
      (o = h * d),
      t.copy(n).addScaledVector(Yn, a).addScaledVector(Kn, o)
    );
  }
  equals(e) {
...
class $e {
  ...
  setHSL(e, t, n, r = ke.workingColorSpace) {
    if (((e = Pc(e, 1)), (t = Ve(t, 0, 1)), (n = Ve(n, 0, 1)), t === 0))
...
class ar extends ci {
  ...
  toJSON(e) {
    ...
    ((n.uuid = this.uuid),
      ...
      this.stencilFunc !== ra && (n.stencilFunc = this.stencilFunc),
...
class Sn extends ci {
      ...
      if ((Rt.setFromBufferAttribute(e), t))
        for (let s = 0, a = t.length; s < a; s++) {
          ...
          (mi.setFromBufferAttribute(o),
            this.morphTargetsRelative
              ? (ht.addVectors(Rt.min, mi.min),
                Rt.expandByPoint(ht),
                ht.addVectors(Rt.max, mi.max),
                Rt.expandByPoint(ht))
              : (Rt.expandByPoint(mi.min), Rt.expandByPoint(mi.max)));
        }
      Rt.getCenter(n);
      let r = 0;
        ...
        for (let s = 0, a = t.length; s < a; s++) {
          ...
          for (let c = 0, u = o.count; c < u; c++)
            (ht.fromBufferAttribute(o, c),
              l && ($n.fromBufferAttribute(e, c), ht.add($n)),
              (r = Math.max(r, n.distanceToSquared(ht))));
        }
  ...
  computeTangents() {
    ...
    this.hasAttribute("tangent") === !1 &&
      this.setAttribute("tangent", new Kt(new Float32Array(4 * n.count), 4));
    ...
    const E = new z(),
      ...
      y = new z();
    function P(B) {
      (D.fromBufferAttribute(r, B), y.copy(D));
      const S = o[B];
      (E.copy(S),
        E.sub(D.multiplyScalar(D.dot(S))).normalize(),
        R.crossVectors(y, S));
...
class _t extends Dt {
    ...
    if (s && o) {
      ...
      for (let l = 0, c = s.length; l < c; l++) {
        const u = o[l],
          f = s[l];
        u !== 0 &&
          (Ir.fromBufferAttribute(f, e),
          a ? ki.addScaledVector(Ir, u) : ki.addScaledVector(Ir.sub(t), u));
      }
      t.add(ki);
    }
    return t;
  ...
  raycast(e, t) {
    ...
    r !== void 0 &&
      ...
      !(
        zi.containsPoint(An.origin) === !1 &&
        (An.intersectSphere(zi, Sa) === null ||
          An.origin.distanceToSquared(Sa) > (e.far - e.near) ** 2)
      ) &&
        (Ma.copy(s).invert(),
        An.copy(e.ray).applyMatrix4(Ma),
        !(n.boundingBox !== null && An.intersectsBox(n.boundingBox) === !1) &&
          this._computeIntersections(e, t, An)));
  }
    ...
    if (o !== null)
      if (Array.isArray(a))
        for (let g = 0, M = h.length; g < M; g++) {
          ...
          for (let R = T, D = E; R < D; R += 3) {
            const y = o.getX(R),
              P = o.getX(R + 1),
              B = o.getX(R + 2);
            ((r = Xi(this, d, e, n, c, u, f, y, P, B)),
              r &&
...
function Yc(i, e, t, n, r, s, a, o) {
  let l;
  if (
    (e.side === yt
      ? (l = n.intersectTriangle(a, s, r, !0, o))
      : (l = n.intersectTriangle(r, s, a, e.side === Mn, o)),
    l === null)
  )
    return null;
  ...
  return c < t.near || c > t.far
    ? null
    : { distance: c, point: Wi.clone(), object: i };
}
function Xi(i, e, t, n, r, s, a, o, l, c) {
  (i.getVertexPosition(o, Vi),
    i.getVertexPosition(l, Gi),
    i.getVertexPosition(c, Hi));
  const u = Yc(i, e, t, n, Vi, Gi, Hi, ba);
  if (u) {
    const f = new z();
    (Ht.getBarycoord(ba, Vi, Gi, Hi, f),
    ...
    (Ht.getNormal(Vi, Gi, Hi, h.normal), (u.face = h), (u.barycoord = f));
  }
  return u;
}
class Ct extends Sn {
  constructor(e = 1, t = 1, n = 1, r = 1, s = 1, a = 1) {
    ...
    (g("z", "y", "x", -1, -1, n, t, e, a, s, 0),
      ...
      this.setIndex(l),
      this.setAttribute("position", new Nn(c, 3)),
      this.setAttribute("normal", new Nn(u, 3)),
      this.setAttribute("uv", new Nn(f, 2)));
    function g(M, p, d, T, E, R, D, y, P, B, S) {
      const v = R / P,
        C = D / B,
        O = R / 2,
        G = D / 2,
...
class un extends ar {
  ...
  copy(e) {
    return (
      ...
      (this.uniformsGroups = Kc(e.uniformsGroups)),
...
class Nt extends Mo {
  ...
  getEffectiveFOV() {
    return Cs * 2 * Math.atan(Math.tan(hr * 0.5 * this.fov) / this.zoom);
  }
  getFilmWidth() {
  ...
  getViewSize(e, t) {
    return (this.getViewBounds(e, Ea, ya), t.subVectors(ya, Ea));
  }
...
class Jc extends Dt {
  constructor(e, t, n) {
    ...
    const r = new Nt(Zn, jn, e, t);
    ((r.layers = this.layers), this.add(r));
    const s = new Nt(Zn, jn, e, t);
    ((s.layers = this.layers), this.add(s));
    const a = new Nt(Zn, jn, e, t);
    ((a.layers = this.layers), this.add(a));
    const o = new Nt(Zn, jn, e, t);
    ((o.layers = this.layers), this.add(o));
    const l = new Nt(Zn, jn, e, t);
    ((l.layers = this.layers), this.add(l));
    const c = new Nt(Zn, jn, e, t);
...
class So extends Mt {
  constructor(e = [], t = ii, n, r, s, a, o, l, c, u) {
...
class Qc extends On {
  ...
  fromEquirectangularTexture(e, t) {
    ...
    const a = new _t(r, s),
      o = t.minFilter;
    return (
      t.minFilter === Un && (t.minFilter = Ft),
      new Jc(1, 10, this).update(e, a),
      (t.minFilter = o),
      a.geometry.dispose(),
      a.material.dispose(),
      this
...
class nl extends Mt {
  constructor(e = null, t = 1, n = 1, r, s, a, o, l, c = Pt, u = Pt, f, h) {
...
class Pn {
  ...
  setFromCoplanarPoints(e, t, n) {
    const r = Fr.subVectors(n, t).cross(il.subVectors(e, t)).normalize();
  ...
  applyMatrix4(e, t) {
    const n = t || rl.getNormalMatrix(e),
...
class bo {
  ...
  setFromProjectionMatrix(e, t = Yt, n = !1) {
    const r = this.planes,
      s = e.elements,
      a = s[0],
      o = s[1],
      ...
      D = s[15];
    if (
      (r[0].setComponents(c - a, m - u, d - g, D - T).normalize(),
      r[1].setComponents(c + a, m + u, d + g, D + T).normalize(),
      r[2].setComponents(c + o, m + f, d + M, D + E).normalize(),
      r[3].setComponents(c - o, m - f, d - M, D - E).normalize(),
      n)
    )
      (r[4].setComponents(l, h, p, R).normalize(),
        r[5].setComponents(c - l, m - h, d - p, D - R).normalize());
    else if (
      (r[4].setComponents(c - l, m - h, d - p, D - R).normalize(), t === Yt)
    )
      r[5].setComponents(c + l, m + h, d + p, D + R).normalize();
    else if (t === nr) r[5].setComponents(l, h, p, R).normalize();
    else
      throw new Error(
  ...
  intersectsSprite(e) {
    ...
    return (
      (wn.radius = 0.7071067811865476 + t),
...
class Eo extends Mt {
  constructor(e, t, n = Fn, r, s, a, o = Pt, l = Pt, c, u = Mi, f = 1) {
    if (u !== Mi && u !== Si)
      throw new Error(
    ...
    for (let d = 0; d < l; d++)
      for (let T = 0; T < o; T++) {
        const E = T + c * d,
          ...
          D = T + 1 + c * (d + 1),
          y = T + 1 + c * d;
        (m.push(E, R, y), m.push(R, D, y));
      }
    (this.setIndex(m),
      this.setAttribute("position", new Nn(g, 3)),
      this.setAttribute("normal", new Nn(M, 3)),
      this.setAttribute("uv", new Nn(p, 2)));
  }
  copy(e) {
    return (
      super.copy(e),
...
class dl {
  ...
  setFromXRController(e) {
    return (
      Ta.identity().extractRotation(e.matrixWorld),
      this.ray.origin.setFromMatrixPosition(e.matrixWorld),
      this.ray.direction.set(0, 0, -1).applyMatrix4(Ta),
      this
    );
  }
  intersectObject(e, t = !0, n = []) {
    return (Ps(e, this, n, t), n.sort(Aa), n);
  }
  intersectObjects(e, t = !0, n = []) {
    for (let r = 0, s = e.length; r < s; r++) Ps(e[r], this, n, t);
    return (n.sort(Aa), n);
  }
}
function Aa(i, e) {
...
function Ps(i, e, t, n) {
  ...
  if (
    ...
    const s = i.children;
    for (let a = 0, o = s.length; a < o; a++) Ps(s[a], e, t, !0);
  }
}
function wa(i, e, t, n) {
  const r = fl(n);
...
typeof __THREE_DEVTOOLS__ < "u" &&
  __THREE_DEVTOOLS__.dispatchEvent(
    new CustomEvent("register", { detail: { revision: Ls } }),
  );
typeof window < "u" &&
  (window.__THREE__
...
#endif`,
  Tl = `vec3 objectNormal = vec3( normal );
#ifdef USE_TANGENT
	vec3 objectTangent = vec3( tangent.xyz );
#endif`,
  Al = `float G_BlinnPhong_Implicit( ) {
	return 0.25;
}
...
#endif`,
  Ol = `#define PI 3.141592653589793
...
#endif`,
  kl = `#ifdef USE_EMISSIVEMAP
	uniform sampler2D emissiveMap;
#endif`,
  Wl = "gl_FragColor = linearToOutputTexel( gl_FragColor );",
  Xl = `vec4 LinearTransferOETF( in vec4 value ) {
	return value;
}
...
IncidentLight directLight;
  ...
  pu = `#if defined( RE_IndirectDiffuse )
	...
	#endif
#endif`,
  mu = `#if defined( RE_IndirectDiffuse )
	RE_IndirectDiffuse( irradiance, geometryPosition, geometryNormal, geometryViewDir, geometryClearcoatNormal, material, reflectedLight );
#endif
#if defined( RE_IndirectSpecular )
	RE_IndirectSpecular( radiance, iblIrradiance, clearcoatRadiance, geometryPosition, geometryNormal, geometryViewDir, geometryClearcoatNormal, material, reflectedLight );
#endif`,
  xu = `#if defined( USE_LOGARITHMIC_DEPTH_BUFFER )
	gl_FragDepth = vIsPerspective == 0.0 ? gl_FragCoord.z : log2( vFragDepth ) * logDepthBufFC * 0.5;
#endif`,
  _u = `#if defined( USE_LOGARITHMIC_DEPTH_BUFFER )
  ...
  gu = `#ifdef USE_LOGARITHMIC_DEPTH_BUFFER
	...
	varying float vIsPerspective;
#endif`,
  vu = `#ifdef USE_LOGARITHMIC_DEPTH_BUFFER
...
#endif`,
  Wu = `vec4 mvPosition = vec4( transformed, 1.0 );
#ifdef USE_BATCHING
...
gl_Position = projectionMatrix * mvPosition;`,
  ...
  Zu = `#if NUM_SPOT_LIGHT_COORDS > 0
	...
	#endif
#endif`,
  ju = `#if ( defined( USE_SHADOWMAP ) && ( NUM_DIR_LIGHT_SHADOWS > 0 || NUM_POINT_LIGHT_SHADOWS > 0 ) ) || ( NUM_SPOT_LIGHT_COORDS > 0 )
...
#endif`,
  fd = `#if defined( USE_ENVMAP ) || defined( DISTANCE ) || defined ( USE_SHADOWMAP ) || defined ( USE_TRANSMISSION ) || NUM_SPOT_LIGHT_COORDS > 0
...
void main() {
  ...
  Ie = {
    ...
    tonemapping_pars_fragment: ad,
    transmission_fragment: od,
...
function Kd(i, e, t, n, r, s, a) {
  ...
  function M(E) {
    let R = !1;
    const D = g(E);
    D === null ? d(o, l) : D && D.isColor && (d(D, 1), (R = !0));
  ...
  function p(E, R) {
    const D = g(R);
    D && (D.isCubeTexture || D.mapping === sr)
      ? (u === void 0 &&
          ((u = new _t(
            new Ct(1, 1, 1),
            new un({
              name: "BackgroundCubeMaterial",
              uniforms: ai(Xt.backgroundCube.uniforms),
        ...
        u.material.uniforms.backgroundRotation.value.setFromMatrix4(
          Yd.makeRotationFromEuler(Rn),
        ),
        (u.material.toneMapped = ke.getTransfer(D.colorSpace) !== Ke),
        (f !== D || h !== D.version || m !== i.toneMapping) &&
      ...
      : D &&
        ...
        (c === void 0 &&
          ((c = new _t(
            ...
            new un({
              ...
              uniforms: ai(Xt.background.uniforms),
        ...
        (c.material.toneMapped = ke.getTransfer(D.colorSpace) !== Ke),
  ...
  function d(E, R) {
    (E.getRGB(Ki, vo(i)), n.buffers.color.setClear(Ki.r, Ki.g, Ki.b, R, a));
  }
  function T() {
      ...
      if (H.location >= 0) {
        ...
        if (
          ...
          const Xe = Ge.buffer,
            ...
            X = je === i.INT || je === i.UNSIGNED_INT || te.gpuType === Us;
...
function jd(i, e, t, n) {
  ...
  const u = l(c);
  u !== c &&
    (Le("WebGLRenderer:", c, "not supported, using", u, "instead."), (c = u));
...
function Qd(i) {
  let e = new WeakMap();
  function t(a, o) {
    return (o === jr ? (a.mapping = ii) : o === Jr && (a.mapping = ri), a);
  }
  function n(a) {
    if (a && a.isTexture) {
      const o = a.mapping;
...
class Pa {
  ...
  fromScene(e, t = 0, n = 0.1, r = 100, s = {}) {
    const { size: a = 256, position: o = tf } = s;
    ((Or = this._renderer.getRenderTarget()),
      (Br = this._renderer.getActiveCubeFace()),
      (zr = this._renderer.getActiveMipmapLevel()),
  ...
  compileCubemapShader() {
    this._cubemapMaterial === null &&
      ((this._cubemapMaterial = Ua()),
      this._compileMaterial(this._cubemapMaterial));
  }
  compileEquirectangularShader() {
    this._equirectMaterial === null &&
      ((this._equirectMaterial = La()),
  ...
  _cleanup(e) {
    (this._renderer.setRenderTarget(Or, Br, zr),
      (this._renderer.xr.enabled = Vr),
      (e.scissorTest = !1),
      Jn(e, 0, 0, e.width, e.height));
  }
  _fromTexture(e, t) {
  ...
  _allocateTargets() {
    ...
    if (
      ...
      (({
        ...
        (this._blurMaterial = sf(s, e, t)));
    }
    return r;
  }
  _compileMaterial(e) {
    const t = new _t(new Sn(), e);
    this._renderer.compile(t, xi);
  }
  _sceneToCubeUV(e, t, n, r, s) {
    const l = new Nt(90, 1, t, n),
      c = [1, -1, 1, 1, 1, 1],
      u = [1, 1, 1, -1, -1, -1],
      f = this._renderer,
      h = f.autoClear,
  ...
  _textureToCubeUV(e, t) {
    const n = this._renderer,
      r = e.mapping === ii || e.mapping === ri;
    r
      ? (this._cubemapMaterial === null && (this._cubemapMaterial = Ua()),
    ...
    (Jn(t, 0, 0, 3 * l, 2 * l), n.setRenderTarget(t), n.render(a, xi));
  }
  _applyPMREM(e) {
  ...
  _applyGGXFilter(e, t, n) {
    ...
    if (this._ggxMaterial === null) {
      const T = 3 * Math.max(this._cubeSize, 16),
        E = 4 * this._cubeSize;
      this._ggxMaterial = rf(this._lodMax, T, E);
    }
  ...
  _halfBlur(e, t, n, r, s, a, o) {
    ...
    const h = c.uniforms,
      ...
      g = isFinite(s) ? Math.PI / (2 * m) : (2 * Math.PI) / (2 * Ln - 1),
      M = s / g,
      p = isFinite(s) ? 1 + Math.floor(u * M) : Ln;
    p > Ln &&
      Le(
        `sigmaRadians, ${s}, is too large and will clip, as it requested ${p} samples when the maximum is set to ${Ln}`,
      );
    const d = [];
    let T = 0;
    for (let P = 0; P < Ln; ++P) {
    ...
    const R = this._sizeLods[r],
      D = 3 * R * (r > E - gn ? r - E + gn : 0),
      y = 4 * (this._cubeSize - R);
    (Jn(t, D, y, 3 * R, 2 * R), l.setRenderTarget(t), l.render(f, xi));
  }
}
function nf(i) {
  const e = [],
    ...
    n = [];
  let r = i;
  const s = i - gn + 1 + Ra.length;
  for (let a = 0; a < s; a++) {
    const o = Math.pow(2, r);
    e.push(o);
    let l = 1 / o;
    (a > i - gn ? (l = Ra[a - i + gn - 1]) : a === 0 && (l = 0), t.push(l));
    const c = 1 / (o - 2),
      u = -c,
      f = 1 + c,
    ...
    const D = new Sn();
    (D.setAttribute("position", new Kt(T, M)),
      D.setAttribute("uv", new Kt(E, p)),
      D.setAttribute("faceIndex", new Kt(R, d)),
      n.push(new _t(D, null)),
      r > gn && r--);
  }
  return { lodMeshes: n, sizeLods: e, sigmas: t };
}
function Da(i, e, t) {
  const n = new On(i, e, t);
  return (
...
function of(i) {
  ...
  return {
    ...
    get: function (n) {
      const r = t(n);
      return (
        r === null && bi("WebGLRenderer: " + n + " extension not supported."),
        r
      );
    },
  };
...
function df(i, e, t) {
  ...
  function s(a, o, l) {
    ...
    if (h === void 0 || h.count !== f) {
      ...
      const y = new Float32Array(R * D * 4 * f),
        P = new po(y, R, D, f);
      ((P.type = sn), (P.needsUpdate = !0));
      const B = E * 4;
      for (let v = 0; v < f; v++) {
        const C = p[v],
          O = d[v],
      ...
      ((h = { count: f, texture: P, size: new We(R, D) }),
        n.set(o, h),
        o.addEventListener("dispose", S));
    }
...
function _f(i, e) {
  ...
  if (n === void 0) {
    ...
    if (dt(t, n)) return;
    (za.set(n), i.uniformMatrix2fv(this.addr, !1, za), ft(t, n));
  }
}
function gf(i, e) {
  const t = this.cache,
  ...
  if (n === void 0) {
    ...
    if (dt(t, n)) return;
    (Ba.set(n), i.uniformMatrix3fv(this.addr, !1, Ba), ft(t, n));
  }
}
function vf(i, e) {
  const t = this.cache,
  ...
  if (n === void 0) {
    ...
    if (dt(t, n)) return;
    (Oa.set(n), i.uniformMatrix4fv(this.addr, !1, Oa), ft(t, n));
  }
}
function Mf(i, e) {
  const t = this.cache;
...
function Cf(i, e, t) {
  const n = this.cache,
    r = t.allocateTextureUnit();
  (n[0] !== r && (i.uniform1i(this.addr, r), (n[0] = r)),
    t.setTexture3D(e || Ro, r));
}
function Pf(i, e, t) {
  const n = this.cache,
    r = t.allocateTextureUnit();
  (n[0] !== r && (i.uniform1i(this.addr, r), (n[0] = r)),
    t.setTextureCube(e || Co, r));
}
function Df(i, e, t) {
  const n = this.cache,
    r = t.allocateTextureUnit();
  (n[0] !== r && (i.uniform1i(this.addr, r), (n[0] = r)),
    t.setTexture2DArray(e || wo, r));
}
function Lf(i) {
  switch (i) {
    case 5126:
...
function Kf(i, e, t) {
  ...
  for (let a = 0; a !== r; ++a) t.setTexture2D(e[a] || Ao, s[a]);
}
function $f(i, e, t) {
  const n = this.cache,
    r = e.length,
    s = lr(t, r);
  dt(n, s) || (i.uniform1iv(this.addr, s), ft(n, s));
  for (let a = 0; a !== r; ++a) t.setTexture3D(e[a] || Ro, s[a]);
}
function Zf(i, e, t) {
  const n = this.cache,
    r = e.length,
    s = lr(t, r);
  dt(n, s) || (i.uniform1iv(this.addr, s), ft(n, s));
  for (let a = 0; a !== r; ++a) t.setTextureCube(e[a] || Co, s[a]);
}
function jf(i, e, t) {
  const n = this.cache,
    r = e.length,
    s = lr(t, r);
  dt(n, s) || (i.uniform1iv(this.addr, s), ft(n, s));
  for (let a = 0; a !== r; ++a) t.setTexture2DArray(e[a] || wo, s[a]);
}
function Jf(i) {
  switch (i) {
    case 5126:
...
function nh(i, e, t) {
  ...
  for (Gr.lastIndex = 0; ; ) {
    ...
    if ((l && (o = o | 0), c === void 0 || (c === "[" && a + 2 === r))) {
      Va(t, c === void 0 ? new Qf(o, i, e) : new eh(o, i, e));
      break;
    } else {
      let f = t.map[o];
      (f === void 0 && ((f = new th(o)), Va(t, f)), (t = f));
    }
  }
}
class er {
...
const Ha = new Ue();
function ah(i) {
  ke._getMatrix(Ha, ke.workingColorSpace, i);
...
const $i = new z();
function lh() {
  ke.getLuminanceCoefficients($i);
  const i = $i.x.toFixed(4),
    e = $i.y.toFixed(4),
    t = $i.z.toFixed(4);
  return [
  ...
  return (
    i.shadowMapType === to
      ...
      : i.shadowMapType === Ho
        ...
        : i.shadowMapType === tn && (e = "SHADOWMAP_TYPE_VSM"),
    e
  );
}
function vh(i) {
...
`)),
      (d = [
        ...
        "uniform vec3 cameraPosition;",
        "uniform bool isOrthographic;",
        t.toneMapping !== vn ? "#define TONE_MAPPING" : "",
        t.toneMapping !== vn ? Ie.tonemapping_pars_fragment : "",
        t.toneMapping !== vn ? ch("toneMapping", t.toneMapping) : "",
...
` +
  ...
  const E = T + p + a,
    R = T + d + o,
    D = Ga(r, r.VERTEX_SHADER, E),
    y = Ga(r, r.FRAGMENT_SHADER, R);
  (r.attachShader(M, D),
    r.attachShader(M, y),
    ...
    if (i.debug.checkShaderErrors) {
      ...
      if (r.getProgramParameter(M, r.LINK_STATUS) === !1)
        if (((H = !1), typeof i.debug.onShaderError == "function"))
          i.debug.onShaderError(r, M, D, y);
        else {
          const se = ka(r, D, "vertex"),
            Se = ka(r, y, "fragment");
          ot(
...
` +
    ...
    (r.deleteShader(D), r.deleteShader(y), (B = new er(r, M)), (S = fh(r, M)));
  }
  let B;
  ...
  return (
    (this.isReady = function () {
      return (v === !1 && (v = r.getProgramParameter(M, ih)), v);
    }),
...
function wh(i, e, t, n, r, s, a) {
  ...
  function p(S, v, C, O, G) {
    const k = O.fog,
      ...
      H = ne && ne.mapping === sr ? ne.image.height : null,
      te = g[S.type];
    S.precision !== null &&
    ...
    const et = {
      ...
      emissiveMap: me,
      normalMapObjectSpace: Be && S.normalMapType === Mc,
      normalMapTangentSpace: Be && S.normalMapType === vc,
      metalnessMap: nt,
      roughnessMap: Me,
      anisotropy: Pe,
      anisotropyMap: V,
  ...
  function D(S, v) {
    ...
    return (C === void 0 && ((C = new Eh(i, v, S, s)), u.push(C)), C);
  }
  function y(S) {
    if (--S.usedTimes === 0) {
      const v = u.indexOf(S);
...
function $a() {
  ...
  function c(f, h) {
    (t.length > 1 && t.sort(f || Ch),
      n.length > 1 && n.sort(h || Ka),
      r.length > 1 && r.sort(h || Ka));
  }
  function u() {
...
function Nh(i) {
  ...
  function o(c) {
    ...
    (B.directionalLength !== m ||
      ...
      (n.spotLightMatrix.length = R + D - y),
...
function zh(i, e, t) {
  ...
  this.render = function (y, P, B) {
    ...
    for (let K = 0, q = y.length; K < q; K++) {
      ...
      if (
        ...
        const Se = this.type !== tn ? { minFilter: Pt, magFilter: Pt } : {};
        (H.map !== null && H.map.dispose(),
          (H.map = new On(r.x, r.y, Se)),
      ...
      (H.isPointLightShadow !== !0 && this.type === tn && T(H, B),
        (H.needsUpdate = !1));
    }
  ...
  function T(y, P) {
    ...
    (h.defines.VSM_SAMPLES !== y.blurSamples &&
      ...
      (h.needsUpdate = !0),
      (m.needsUpdate = !0)),
      y.mapPass === null && (y.mapPass = new On(r.x, r.y)),
  ...
  function E(y, P, B, S) {
    ...
    if (C !== void 0) v = C;
      ...
      let K = k[G];
      (K === void 0 &&
        ((K = v.clone()), (k[G] = K), P.addEventListener("dispose", D)),
        (v = K));
    }
    if (
      ((v.visible = P.visible),
  ...
  function R(y, P, B, S, v) {
    ...
    if (
      ...
      (y.castShadow || (y.receiveShadow && v === tn)) &&
...
function Gh(i, e) {
  ...
  function r() {
    ...
    return {
      ...
      setFunc: function (qe, Wt, Ot) {
        (ie !== qe || re !== Wt || J !== Ot) &&
          (i.stencilFunc(qe, Wt, Ot), (ie = qe), (re = Wt), (J = Ot));
      },
      setOp: function (qe, Wt, Ot) {
        (Y !== qe || he !== Wt || Ce !== Ot) &&
          (i.stencilOp(qe, Wt, Ot), (Y = qe), (he = Wt), (Ce = Ot));
      },
  ...
  const pt = {
    [Dn]: i.FUNC_ADD,
    [Wo]: i.FUNC_SUBTRACT,
    [Xo]: i.FUNC_REVERSE_SUBTRACT,
  };
  ((pt[qo] = i.MIN), (pt[Yo] = i.MAX));
  const Ne = {
    [Ko]: i.ZERO,
    [$o]: i.ONE,
    [Zo]: i.SRC_COLOR,
  ...
  function tt(w, ce, ie, re, J, Y, he, Ce, et, qe) {
    ...
    if ((M === !1 && (Z(i.BLEND), (M = !0)), w !== ko)) {
      if (w !== p || qe !== S) {
        if (
          ((d !== Dn || R !== Dn) &&
            (i.blendEquation(i.FUNC_ADD), (d = Dn), (R = Dn)),
          qe)
        )
          switch (w) {
            case ei:
  ...
  function A(w, ce) {
    w.side === nn ? fe(i.CULL_FACE) : Z(i.CULL_FACE);
    let ie = w.side === yt;
    (ce && (ie = !ie),
      Oe(ie),
      w.blending === ei && w.transparent === !1
        ? tt(an)
        : tt(
            w.blending,
            w.blendEquation,
...
function Hh(i, e, t, n, r, s, a) {
  ...
  function g(b, x) {
    return m ? new OffscreenCanvas(b, x) : ir("canvas");
  }
  function M(b, x, I) {
    let W = 1;
    const $ = Pe(b);
      ...
      b
        ...
        : x === null || x === Fn || x === vi
          ...
          : x === sn
            ...
            : x === gi && (I = i.DEPTH_COMPONENT16),
      I
    );
  }
  function D(b, x) {
    return p(b) === !0 ||
      (b.isFramebufferTexture && b.minFilter !== Pt && b.minFilter !== Ft)
  ...
  const te = { [Qr]: i.REPEAT, [rn]: i.CLAMP_TO_EDGE, [es]: i.MIRRORED_REPEAT },
    se = {
      [Pt]: i.NEAREST,
      [xc]: i.NEAREST_MIPMAP_NEAREST,
      [Ci]: i.NEAREST_MIPMAP_LINEAR,
      [Ft]: i.LINEAR,
  ...
  function X(b, x, I) {
    ...
    if (V.version !== _e.__version || $ === !0) {
      ...
      const oe = ke.getPrimaries(ke.workingColorSpace),
        be = x.colorSpace === _n ? null : ke.getPrimaries(x.colorSpace),
        xe =
          x.colorSpace === _n || oe === be ? i.NONE : i.BROWSER_DEFAULT_WEBGL;
      ...
      if (x.isDepthTexture)
                ...
                if (w) {
                  if (ie)
                    if (x.layerUpdates.size > 0) {
                      const he = wa(ue.width, ue.height, x.format, x.type);
        ...
        if (w) {
          if (
            ...
            if (x.layerUpdates.size > 0) {
              const J = wa(j.width, j.height, x.format, x.type);
  ...
  function Z(b, x, I) {
    ...
    if ($.version !== V.__version || W === !0) {
      ...
      const _e = ke.getPrimaries(ke.workingColorSpace),
        oe = x.colorSpace === _n ? null : ke.getPrimaries(x.colorSpace),
        be =
          x.colorSpace === _n || _e === oe ? i.NONE : i.BROWSER_DEFAULT_WEBGL;
      (i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL, x.flipY),
        i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL, x.premultiplyAlpha),
        i.pixelStorei(i.UNPACK_ALIGNMENT, x.unpackAlignment),
  ...
  function ge(b, x) {
    ...
    else if (x.depthTexture.format === Si)
      me(x)
        ? o.framebufferTexture2DMultisampleEXT(
            i.FRAMEBUFFER,
...
function kh(i, e) {
  function t(n, r = _n) {
    ...
    if (n === Is) return i.UNSIGNED_SHORT_4_4_4_4;
    if (n === Ns) return i.UNSIGNED_SHORT_5_5_5_1;
    if (n === ao) return i.UNSIGNED_INT_5_9_9_9_REV;
    if (n === oo) return i.UNSIGNED_INT_10F_11F_11F_REV;
    if (n === ro) return i.BYTE;
    if (n === so) return i.SHORT;
    if (n === gi) return i.UNSIGNED_SHORT;
    if (n === Us) return i.INT;
    ...
    if (n === Fs) return i.RED_INTEGER;
    if (n === Os) return i.RG;
    if (n === Bs) return i.RG_INTEGER;
    if (n === zs) return i.RGBA_INTEGER;
    if (n === Zi || n === ji || n === Ji || n === Qi)
      if (a === Ke)
        if (((s = e.get("WEBGL_compressed_texture_s3tc_srgb")), s !== null)) {
          if (n === Zi) return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;
          if (n === ji) return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;
          if (n === Ji) return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;
          if (n === Qi) return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT;
        } else return null;
      else if (((s = e.get("WEBGL_compressed_texture_s3tc")), s !== null)) {
        if (n === Zi) return s.COMPRESSED_RGB_S3TC_DXT1_EXT;
        if (n === ji) return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;
        if (n === Ji) return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;
        if (n === Qi) return s.COMPRESSED_RGBA_S3TC_DXT5_EXT;
      } else return null;
    if (n === ts || n === ns || n === is || n === rs)
      if (((s = e.get("WEBGL_compressed_texture_pvrtc")), s !== null)) {
        if (n === ts) return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;
        if (n === ns) return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;
        if (n === is) return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;
        if (n === rs) return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG;
      } else return null;
    if (n === ss || n === as || n === os)
    ...
    if (n === bs || n === Es || n === ys)
      if (((s = e.get("EXT_texture_compression_bptc")), s !== null)) {
        ...
        if (n === Es) return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;
        if (n === ys) return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT;
      } else return null;
    if (n === Ts || n === As || n === ws || n === Rs)
      if (((s = e.get("EXT_texture_compression_rgtc")), s !== null)) {
        if (n === Ts) return s.COMPRESSED_RED_RGTC1_EXT;
        if (n === As) return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;
        if (n === ws) return s.COMPRESSED_RED_GREEN_RGTC2_EXT;
        if (n === Rs) return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT;
      } else return null;
...
class qh {
  ...
  getMesh(e) {
    if (this.texture !== null && this.mesh === null) {
      ...
      this.mesh = new _t(new or(20, 20), n);
    }
    return this.mesh;
  }
  reset() {
  ...
  constructor(e, t) {
    ...
    ((this.cameraAutoUpdate = !0),
      ...
      (this.getController = function (X) {
        let Z = D[X];
        return (
          Z === void 0 && ((Z = new Nr()), (D[X] = Z)),
          Z.getTargetRaySpace()
        );
      }),
      (this.getControllerGrip = function (X) {
        let Z = D[X];
        return (Z === void 0 && ((Z = new Nr()), (D[X] = Z)), Z.getGripSpace());
      }),
      (this.getHand = function (X) {
        let Z = D[X];
        return (Z === void 0 && ((Z = new Nr()), (D[X] = Z)), Z.getHandSpace());
      }));
    function K(X) {
    ...
    function q() {
      ...
      for (let X = 0; X < D.length; X++) {
        const Z = y[X];
        Z !== null && ((y[X] = null), D[X].disconnect(Z));
      }
        ...
        if (((r = X), r !== null)) {
          if (
            ...
            ((f = this.getBinding()),
              ...
              (R = new On(h.textureWidth, h.textureHeight, {
                format: kt,
                type: cn,
                depthTexture: new Eo(
                  h.textureWidth,
            ...
            ((m = new XRWebGLLayer(r, t, fe)),
              ...
              (R = new On(m.framebufferWidth, m.framebufferHeight, {
                format: kt,
                type: cn,
                colorSpace: e.outputColorSpace,
                stencilBuffer: T.stencil,
    ...
    function ne(X) {
      for (let Z = 0; Z < X.removed.length; Z++) {
        const fe = X.removed[Z],
          De = y.indexOf(fe);
        De >= 0 && ((y[De] = null), D[De].disconnect(fe));
      }
    ...
    function Ge(X, Z, fe) {
      (fe === null
        ...
        X.isPerspectiveCamera &&
          ((X.fov = Cs * 2 * Math.atan(1 / X.projectionMatrix.elements[5])),
          (X.zoom = 1)));
    }
    ...
    function je(X, Z) {
      if (((u = Z.getViewerPose(c || a)), (g = Z), u !== null)) {
        ...
        m !== null &&
          ...
          e.setRenderTarget(R));
        let De = !1;
        fe.length !== O.cameras.length && ((O.cameras.length = 0), (De = !0));
...
function $h(i, e) {
  ...
  function n(p, d) {
    (d.color.getRGB(p.fogColor.value, vo(i)),
      d.isFog
  ...
  function s(p, d) {
    ...
    (E &&
      ...
      E.isCubeTexture &&
        ...
        ((Cn.y *= -1), (Cn.z *= -1)),
      p.envMapRotation.value.setFromMatrix4(Kh.makeRotationFromEuler(Cn)),
      (p.flipEnvMap.value =
...
function Zh(i, e, t, n) {
  ...
  function u(T) {
    ...
    return (
      ...
      i.bufferData(i.UNIFORM_BUFFER, D, y),
  ...
  function g(T) {
    ...
    const y = R % D;
    return (y > 0 && (R += D - y), (T.__size = R), (T.__cache = {}), this);
  }
  function M(T) {
              ...
              : T.isMatrix3
                ...
                : T.isMatrix4
                  ...
                  : T.isTexture
                    ...
                    : Le("WebGLRenderer: Unsupported uniform value type.", T),
      E
    );
  }
  function p(T) {
...
class Qh {
  constructor(e = {}) {
    ...
    const g = new Set([zs, Bs, Fs]),
      M = new Set([cn, Fn, gi, vi, Is, Ns]),
      p = new Uint32Array(4),
      d = new Int32Array(4);
    let T = null,
      E = null;
    ...
    try {
      ...
      if (
        ("setAttribute" in t &&
          t.setAttribute("data-engine", `three.js r${Ls}`),
    ...
    function ie() {
      ((Be = new of(A)),
        ...
        (Ae = new df(A, Qe, Pe)),
        (xe = new Jd(Me)),
        (V = new wh(y, b, x, Be, Qe, w, xe)),
        (_e = new $h(y, Me)),
        (oe = new Ph()),
        (be = new Fh(Be)),
        (ee = new Kd(y, b, x, me, $, m, l)),
        (j = new zh(y, $, Qe)),
        (ce = new Zh(A, nt, Qe, me)),
        (ye = new Zd(A, Be, nt)),
        (ue = new lf(A, Be, nt)),
    ...
    ((this.xr = re),
      ...
      (this.setViewport = function (_, L, N, F) {
        (_.isVector4 ? Xe.set(_.x, _.y, _.z, _.w) : Xe.set(_, L, N, F),
          me.viewport(G.copy(Xe).multiplyScalar(se).round()));
      }),
      (this.getScissor = function (_) {
        return _.copy(je);
      }),
      (this.setScissor = function (_, L, N, F) {
        (_.isVector4 ? je.set(_.x, _.y, _.z, _.w) : je.set(_, L, N, F),
      ...
      (this.dispose = function () {
        (t.removeEventListener("webglcontextlost", J, !1),
          ...
          V.dispose(),
          re.dispose(),
          re.removeEventListener("sessionstart", Ys),
          re.removeEventListener("sessionend", Ks),
          bn.stop());
      }));
    function J(_) {
      (_.preventDefault(), ca("WebGLRenderer: Context Lost."), (P = !0));
    }
    function Y() {
      (ca("WebGLRenderer: Context Restored."), (P = !1));
    ...
    this.renderBufferDirect = function (_, L, N, F, U, Q) {
      L === null && (L = pt);
      ...
      if (U.isBatchedMesh)
        if (U._multiDrawInstances !== null)
          ...
          const Ee = U._multiDrawStarts,
            ...
            Bn = Me.get(F).currentProgram.getUniforms();
          for (let At = 0; At < He; At++)
            (Bn.setValue(A, "_gl_DrawID", At), Ze.render(Ee[At] / Tt, it[At]));
        }
    ...
    function Wt(_, L, N) {
      _.transparent === !0 && _.side === nn && _.forceSinglePass === !1
        ? ((_.side = yt),
          (_.needsUpdate = !0),
          Ri(_, L, N),
          (_.side = Mn),
    ...
    const bn = new To();
    (bn.setAnimationLoop(Uo),
      typeof self < "u" && bn.setContext(self),
      (this.setAnimationLoop = function (_) {
        ((Ot = _), re.setAnimationLoop(_), _ === null ? bn.stop() : bn.start());
      }),
      re.addEventListener("sessionstart", Ys),
      re.addEventListener("sessionend", Ks),
      (this.render = function (_, L) {
        ...
        if (
          ...
          re.enabled === !0 &&
            ...
            (L = re.getCamera())),
          _.isScene === !0 && _.onBeforeRender(y, _, L, v),
          (E = be.get(_, D.length)),
          E.init(L),
          D.push(E),
          De.multiplyMatrices(L.projectionMatrix, L.matrixWorldInverse),
          X.setFromProjectionMatrix(De, Yt, L.reversedDepth),
          ...
          Q !== null && ur(Q, L, -1 / 0, y.sortObjects);
        }
        (ur(_, L, 0, y.sortObjects),
          T.finish(),
        ...
        if ((E.setupLights(), L.isArrayCamera)) {
          ...
          for (let le = 0, pe = Q.length; le < pe; le++) {
            const de = Q[le];
            $s(T, _, de, de.viewport);
          }
        } else
          (U.length > 0 && Zs(F, U, _, L), Ne && ee.render(_), $s(T, _, L));
        (v !== null &&
          S === 0 &&
          (Pe.updateMultisampleRenderTarget(v), Pe.updateRenderTargetMipmap(v)),
          _.isScene === !0 && _.onAfterRender(y, _, L),
          w.resetDefaultState(),
          (C = -1),
          (O = null),
          D.pop(),
    ...
    function ur(_, L, N, F) {
      ...
      if (_.layers.test(L.layers)) {
        if (_.isGroup) N = _.renderOrder;
          ...
          if (!_.frustumCulled || X.intersectsSprite(_)) {
            F && Fe.setFromMatrixPosition(_.matrixWorld).applyMatrix4(De);
            const le = $.update(_),
              pe = _.material;
      ...
      const Q = _.children;
      for (let le = 0, pe = Q.length; le < pe; le++) ur(Q[le], L, N, F);
    }
    function $s(_, L, N, F) {
    ...
    function Zs(_, L, N, F) {
      ...
      E.state.transmissionRenderTarget[F.id] === void 0 &&
        (E.state.transmissionRenderTarget[F.id] = new On(1, 1, {
          generateMipmaps: !0,
          type:
      ...
      if (
        ...
        for (let Ye = 0, st = L.length; Ye < st; Ye++) {
          ...
          if (it.side === nn && Ze.layers.test(F.layers)) {
            const Tt = it.side;
            ((it.side = yt),
              (it.needsUpdate = !0),
              js(Ze, N, F, Ee, it, He),
    ...
    function wi(_, L, N) {
      ...
      for (let U = 0, Q = _.length; U < Q; U++) {
        ...
        (we.allowOverride === !0 && F !== null && (we = F),
          pe.layers.test(N.layers) && js(pe, L, N, de, we, Te));
      }
    }
    function js(_, L, N, F, U, Q) {
      (_.onBeforeRender(y, L, N, F, U, Q),
        _.modelViewMatrix.multiplyMatrices(N.matrixWorldInverse, _.matrixWorld),
        _.normalMatrix.getNormalMatrix(_.modelViewMatrix),
        U.onBeforeRender(y, L, N, F, _, Q),
        U.transparent === !0 && U.side === nn && U.forceSinglePass === !1
          ? ((U.side = yt),
            (U.needsUpdate = !0),
            y.renderBufferDirect(N, L, F, U, _, Q),
            (U.side = Mn),
            (U.needsUpdate = !0),
            y.renderBufferDirect(N, L, F, U, _, Q),
            (U.side = nn))
          : y.renderBufferDirect(N, L, F, U, _, Q),
        _.onAfterRender(y, L, N, F, U, Q));
    }
    function Ri(_, L, N) {
      L.isScene !== !0 && (L = pt);
      const F = Me.get(_),
        ...
        le = U.state.version,
        pe = V.getParameters(_, U.state, Q, L, N),
        de = V.getProgramCacheKey(pe);
      let Te = F.programs;
      ((F.environment = _.isMeshStandardMaterial ? L.environment : null),
        (F.fog = L.fog),
    ...
    function Js(_) {
      if (_.uniformsList === null) {
        ...
        _.uniformsList = er.seqWithValue(L.seq, _.uniforms);
      }
    ...
    function Io(_, L, N, F, U) {
      (L.isScene !== !0 && (L = pt), Pe.resetTextureUnits());
      const Q = L.fog,
        le = F.isMeshStandardMaterial ? L.environment : null,
        pe =
          v === null
            ? y.outputColorSpace
      ...
      const rt = Tt.getUniforms(),
        St = Ee.uniforms;
      if (
        (me.useProgram(Tt.program) && ((Bn = !0), (At = !0), (ui = !0)),
        F.id !== C && ((C = F.id), (At = !0)),
        Bn || O !== _)
      ) {
      ...
      if (
        ...
        St.dfgLUT !== void 0 && (St.dfgLUT.value = Jh()),
        At &&
          (rt.setValue(A, "toneMappingExposure", y.toneMappingExposure),
          Ee.needsLights && No(St, ui),
          ...
          er.upload(A, Js(Ee), St, Pe)),
        F.isShaderMaterial &&
          F.uniformsNeedUpdate === !0 &&
          (er.upload(A, Js(Ee), St, Pe), (F.uniformsNeedUpdate = !1)),
        ...
        for (let bt = 0, dr = gt.length; bt < dr; bt++) {
          const En = gt[bt];
          (ce.update(En, Tt), ce.bind(En, Tt));
        }
      }
      return Tt;
    }
    ...
    ((this.setRenderTarget = function (_, L = 0, N = 0) {
      ...
      (this.readRenderTargetPixels = function (_, L, N, F, U, Q, le, pe = 0) {
        ...
        if ((_.isWebGLCubeRenderTarget && le !== void 0 && (de = de[le]), de)) {
          ...
          try {
            ...
            L >= 0 &&
              ...
              A.readPixels(L, N, F, U, Re.convert(we), Re.convert(ve), Q));
          } finally {
      ...
      (this.readRenderTargetPixelsAsync = async function (
        ...
        let de = Me.get(_).__webglFramebuffer;
        if ((_.isWebGLCubeRenderTarget && le !== void 0 && (de = de[le]), de))
          if (L >= 0 && L <= _.width - F && N >= 0 && N <= _.height - U) {
            me.bindFramebuffer(A.FRAMEBUFFER, de);
            const Te = _.textures[pe],
              we = Te.format,
              ve = Te.type;
            ...
            (A.bindBuffer(A.PIXEL_PACK_BUFFER, ze),
              ...
              _.textures.length > 1 && A.readBuffer(A.COLOR_ATTACHMENT0 + pe),
              A.readPixels(L, N, F, U, Re.convert(we), Re.convert(ve), 0));
    ...
    const Bo = A.createFramebuffer(),
      zo = A.createFramebuffer();
    ((this.copyTextureToTexture = function (
      ...
      if (N !== null)
        ...
        ((le = Math.floor(at.width * Lt)),
          (pe = Math.floor(at.height * Lt)),
          _.isDataArrayTexture
            ? (de = at.depth)
            : _.isData3DTexture
              ? (de = Math.floor(at.depth * Lt))
              : (de = 1),
          (Te = 0),
          (we = 0),
          (ve = 0));
      ...
      let it;
      (L.isData3DTexture
        ? (Pe.setTexture3D(L, 0), (it = A.TEXTURE_3D))
        : L.isDataArrayTexture || L.isCompressedArrayTexture
          ? (Pe.setTexture2DArray(L, 0), (it = A.TEXTURE_2D_ARRAY))
          : (Pe.setTexture2D(L, 0), (it = A.TEXTURE_2D)),
      ...
      const He = A.getParameter(A.UNPACK_ROW_LENGTH),
        ...
        Bn = A.getParameter(A.UNPACK_SKIP_PIXELS),
        At = A.getParameter(A.UNPACK_SKIP_ROWS),
        ui = A.getParameter(A.UNPACK_SKIP_IMAGES);
      ...
      const rt = _.isDataArrayTexture || _.isData3DTexture,
        St = L.isDataArrayTexture || L.isData3DTexture;
      if (_.isDepthTexture) {
        const Lt = Me.get(_),
          gt = Me.get(L),
          bt = Me.get(Lt.__renderTarget),
          dr = Me.get(gt.__renderTarget);
        (me.bindFramebuffer(A.READ_FRAMEBUFFER, bt.__webglFramebuffer),
          me.bindFramebuffer(A.DRAW_FRAMEBUFFER, dr.__webglFramebuffer));
        for (let En = 0; En < de; En++)
          (rt &&
            (A.framebufferTextureLayer(
              A.READ_FRAMEBUFFER,
              A.COLOR_ATTACHMENT0,
        ...
        const Lt = Me.get(_),
          gt = Me.get(L);
        (me.bindFramebuffer(A.READ_FRAMEBUFFER, Bo),
          me.bindFramebuffer(A.DRAW_FRAMEBUFFER, zo));
      ...
      (A.pixelStorei(A.UNPACK_ROW_LENGTH, He),
        ...
        A.pixelStorei(A.UNPACK_SKIP_PIXELS, Bn),
        A.pixelStorei(A.UNPACK_SKIP_ROWS, At),
        A.pixelStorei(A.UNPACK_SKIP_IMAGES, ui),
        Q === 0 && L.generateMipmaps && A.generateMipmap(it),
        me.unbindTexture());
    }),
...
async function Po() {
  const i = await np(() => import("./ammo-B9oaJM7s.js").then((t) => t.a), []),
    e = i.default ?? i;
...
class ip {
  ...
  onSceneLeave;
  async init(e) {
    this.AmmoLib = await Po();
    const { physicsWorld: t } = Do(this.AmmoLib);
    ((this.physicsWorld = t), (this.scene = e));
    const n = 50,
      r = new Ct(n, 1, n),
      s = new qt({ color: 8947848 }),
      a = new _t(r, s);
  ...
  createPlayer() {
    const t = new Ct(0.5, 0.5, 0.5),
      n = new qt({ color: 16711680 }),
      r = new _t(t, n);
  ...
  makeBarrier(e, t, n) {
    const r = { x: 1, y: 0.5, z: 1 },
      ...
      o = In(this.AmmoLib, s, a, 0);
    this.physicsWorld.addRigidBody(o.body);
    const l = new Ct(r.x, r.y, r.z),
      c = new qt({ color: 16711680 }),
      u = new _t(l, c);
  ...
  handleSceneLeave = async (e) => {
    switch (e.code) {
      case "KeyG":
        this.onSceneLeave?.(new ks());
        break;
    }
  };
  onEnter() {
    (console.log("Inventory: ", Ei.inventory),
...
class ks {
  ...
  makeGoal(e, t, n, r) {
    const s = { x: 1, y: 0.5, z: 1 },
      ...
      l = In(this.AmmoLib, a, o, 0);
    this.physicsWorld.addRigidBody(l.body);
    const c = new Ct(s.x, s.y, s.z),
      u = new qt({ color: 65280 }),
      f = new _t(c, u);
  ...
  spawnKey() {
    const e = new Ct(0.3, 0.3, 0.3),
      t = new qt({ color: 4286945 });
    ((this.key = new _t(e, t)),
...
let Qa = new We();
async function Ws(i) {
  for (rr = !0; Qn.children.length; ) Qn.remove(Qn.children[0]);
  (Gt && (Gt.onExit(), (Gt.onSceneLeave = void 0)),
    (Gt = i),
    await Gt.init(Qn),
    (Gt.onSceneLeave = (e) => Ws(e)),
    Gt.onEnter(),
    (rr = !1));
}
const Xs = new Nt(75, window.innerWidth / window.innerHeight, 0.1, 1e3),
  rp = 4;
Xs.position.z = rp;
const qs = new Qh();
qs.setSize(window.innerWidth, window.innerHeight);
document.body.appendChild(qs.domElement);
const sp = document.getElementById("start-screen"),
  eo = document.getElementById("start-button");
eo &&
  eo.addEventListener("click", async () => {
    rr || (sp?.classList.add("hidden"), await Ws(new ks()));
  });
const ap = new ul();
window.addEventListener("keydown", (i) => {
  i.code === "KeyI" && Ei.inventory.push("Test Item");
});
window.addEventListener("click", (i) => {
  ((Qa = new We(
    ...
    Ja.setFromCamera(Qa, Xs));
  const e = Ja.intersectObjects(Qn.children);
...
function Lo() {
  ...
  const i = ap.getDelta();
  (Gt && !rr && Gt.update(i), qs.render(Qn, Xs));
}
Lo();
