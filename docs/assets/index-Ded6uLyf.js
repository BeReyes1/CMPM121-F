...
class Ft extends qn {
  ...
  getWorldQuaternion(e) {
    return (
      this.updateWorldMatrix(!0, !1),
      this.matrixWorld.decompose(yi, e, ml),
      e
    );
  }
  getWorldScale(e) {
    return (
      this.updateWorldMatrix(!0, !1),
      this.matrixWorld.decompose(yi, xl, e),
      e
    );
  }
  getWorldDirection(e) {
...
class Ze {
  ...
  setHSL(e, t, n, r = We.workingColorSpace) {
    if (((e = il(e, 1)), (t = Oe(t, 0, 1)), (n = Oe(n, 0, 1)), t === 0))
...
class mn extends yr {
  ...
  copy(e) {
    return (
      ...
      (this.uniformsGroups = bl(e.uniformsGroups)),
...
class En {
  ...
  setFromCoplanarPoints(e, t, n) {
    const r = es.subVectors(n, t).cross(Dl.subVectors(e, t)).normalize();
  ...
  applyMatrix4(e, t) {
    const n = t || Ll.getNormalMatrix(e),
...
class Yo {
  ...
  intersectsSprite(e) {
    In.center.set(0, 0, 0);
    const t = Ul.distanceTo(e.center);
    return (
...
#endif`,
  eh = `vec3 objectNormal = vec3( normal );
#ifdef USE_TANGENT
...
transformedNormal = normalMatrix * transformedNormal;
  ...
  Mh = `vec4 LinearTransferOETF( in vec4 value ) {
	return value;
}
...
#define RE_IndirectDiffuse		RE_IndirectDiffuse_Toon`,
  Bh = `BlinnPhongMaterial material;
material.diffuseColor = diffuseColor.rgb;
...
IncidentLight directLight;
  ...
  Jh = `#if defined( USE_POINTS_UV )
	...
	uniform sampler2D alphaMap;
#endif`,
  Qh = `float metalnessFactor = metalness;
#ifdef USE_METALNESSMAP
	vec4 texelMetalness = texture2D( metalnessMap, vMetalnessMapUv );
	metalnessFactor *= texelMetalness.b;
#endif`,
  eu = `#ifdef USE_METALNESSMAP
...
gl_FragColor = vec4( outgoingLight, diffuseColor.a );`,
  _u = `vec3 packNormalToRGB( const in vec3 normal ) {
...
gl_Position = projectionMatrix * mvPosition;`,
...
#endif`,
  bu = `float roughnessFactor = roughness;
  ...
  Tu = `#if NUM_SPOT_LIGHT_COORDS > 0
	...
	#endif
#endif`,
  Au = `#if ( defined( USE_SHADOWMAP ) && ( NUM_DIR_LIGHT_SHADOWS > 0 || NUM_POINT_LIGHT_SHADOWS > 0 ) ) || ( NUM_SPOT_LIGHT_COORDS > 0 )
...
#endif`,
  Gu = `#if defined( USE_ENVMAP ) || defined( DISTANCE ) || defined ( USE_SHADOWMAP ) || defined ( USE_TRANSMISSION ) || NUM_SPOT_LIGHT_COORDS > 0
...
void main() {
  ...
  Ne = {
    ...
    emissivemap_fragment: _h,
    emissivemap_pars_fragment: gh,
    colorspace_fragment: vh,
    colorspace_pars_fragment: Mh,
    envmap_fragment: Sh,
...
class Ja {
  ...
  fromScene(e, t = 0, n = 0.1, r = 100, s = {}) {
    const { size: a = 256, position: o = Pd } = s;
  ...
  _applyGGXFilter(e, t, n) {
    ...
    if (this._ggxMaterial === null) {
      const T = 3 * Math.max(this._cubeSize, 16),
        E = 4 * this._cubeSize;
      this._ggxMaterial = Ld(this._lodMax, T, E);
    }
...
function Df(i, e, t) {
  ...
  for (ss.lastIndex = 0; ; ) {
    ...
    if ((l && (o = o | 0), c === void 0 || (c === "[" && a + 2 === r))) {
      co(t, c === void 0 ? new Rf(o, i, e) : new Cf(o, i, e));
      break;
    } else {
      let d = t.map[o];
      (d === void 0 && ((d = new Pf(o)), co(t, d)), (t = d));
    }
  }
}
class fr {
...
` +
    ...
    (r.deleteShader(D), r.deleteShader(y), (z = new fr(r, M)), (S = Gf(r, M)));
  }
  let z;
  ...
  return (
    (this.isReady = function () {
      return (v === !1 && (v = r.getProgramParameter(M, Lf)), v);
    }),
...
class ep {
  ...
  _getShaderStage(e) {
    ...
    let n = t.get(e);
    return (n === void 0 && ((n = new tp(e)), t.set(e, n)), n);
  }
}
class tp {
  constructor(e) {
    ((this.id = Qf++), (this.code = e), (this.usedTimes = 0));
  }
}
function np(i, e, t, n, r, s, a) {
  ...
  function p(S, v, C, B, G) {
    ...
    const tt = {
      ...
      normalMapTangentSpace: Ve && S.normalMapType === qc,
      metalnessMap: it,
      roughnessMap: Me,
      anisotropy: Pe,
      anisotropyMap: V,
  ...
  function D(S, v) {
    ...
    return (C === void 0 && ((C = new Jf(i, v, S, s)), u.push(C)), C);
  }
  function y(S) {
    if (--S.usedTimes === 0) {
      const v = u.indexOf(S);
  ...
  function s(p, h) {
    ...
    (E &&
      ...
      E.isCubeTexture &&
        ...
        ((Fn.y *= -1), (Fn.z *= -1)),
      p.envMapRotation.value.setFromMatrix4(Ep.makeRotationFromEuler(Fn)),
      (p.flipEnvMap.value =
  ...
  constructor(e = {}) {
    ...
    function ie() {
      ((Ve = new Nd(A)),
        ...
        (Ae = new zd(A, et, Pe)),
        (xe = new wd(Me)),
        (V = new np(y, b, x, Ve, et, w, xe)),
        (_e = new yp(y, Me)),
        (oe = new sp()),
        (be = new up(Ve)),
        (ee = new Ed(y, b, x, me, j, m, l)),
        ($ = new pp(y, j, et)),
        (ce = new Tp(A, it, et, me)),
        (ye = new Td(A, Ve, it)),
        (he = new Od(A, Ve, it)),
    ...
    function oc(_, L, N, O, U) {
      ...
      if (
        ...
        Et.dfgLUT !== void 0 && (Et.dfgLUT.value = wp()),
        Ct &&
          (st.setValue(A, "toneMappingExposure", y.toneMappingExposure),
          Ee.needsLights && cc(Et, Mi),
    ...
    ((this.copyTextureToTexture = function (
      ...
      if (_.isDepthTexture) {
        ...
        const Ot = Me.get(_),
          Mt = Me.get(L);
        (me.bindFramebuffer(A.READ_FRAMEBUFFER, uc),
          me.bindFramebuffer(A.DRAW_FRAMEBUFFER, dc));
...
class Pp extends Vl {
  constructor(e, t = null) {
    (super(e, t),
      ...
      (this._onPointerMove = Lp.bind(this)),
      (this._onPointerDown = Dp.bind(this)),
      (this._onPointerUp = Up.bind(this)),
      (this._onContextMenu = Vp.bind(this)),
      (this._onMouseWheel = Fp.bind(this)),
      (this._onKeyDown = Op.bind(this)),
      (this._onTouchStart = Bp.bind(this)),
      (this._onTouchMove = zp.bind(this)),
      (this._onMouseDown = Ip.bind(this)),
      (this._onMouseMove = Np.bind(this)),
      (this._interceptControlDown = Gp.bind(this)),
      (this._interceptControlUp = kp.bind(this)),
      ...
      a !== null &&
        (this.screenSpacePanning
          ...
          : (or.origin.copy(this.object.position),
            ...
            Math.abs(this.object.up.dot(or.direction)) < Cp
              ? this.object.lookAt(this.target)
...
async function nc() {
  const i = await Xp(() => import("./ammo-B9oaJM7s.js").then((t) => t.a), []),
    e = i.default ?? i;
...
const yo = new zl();
let To = new Ie(),
  Yp = It.getLocalizedString("start_button");
async function fa(i) {
...
const jp = new Pp(Rr, Oi.domElement),
  Zp = new Bl();
...
function sc() {
  ...
  const i = Zp.getDelta();
  (jp.update(), Lt && !_r && Lt.update(i), Oi.render(li, Rr));
}
sc();
function Js() {
